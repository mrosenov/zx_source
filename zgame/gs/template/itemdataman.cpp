...
int itemdataman::get_item_sell_price(unsigned int id)
{
	...
	switch(datatype) {
		...
		CASE_GET_ITEM_PRICE(LOTTERY2_ESSENCE);
		CASE_GET_ITEM_PRICE(LOTTERY3_ESSENCE);
		CASE_GET_ITEM_PRICE(GENERAL_ARTICLE_ESSENCE);
		CASE_GET_ITEM_PRICE(CASH_MEDIC_MERGE_ITEM_ESSENCE);
		CASE_GET_ITEM_PRICE(UPGRADE_EQUIP_STONE_ESSENCE);
		CASE_GET_ITEM_PRICE(RUNE_EQUIP_ESSENCE);
		CASE_GET_ITEM_PRICE(RUNE_SLOT_ESSENCE);
		CASE_GET_ITEM_PRICE(SCROLL_DIG_COUNT_INC_ESSENCE);
		CASE_GET_ITEM_PRICE(PROP_ADD_MATERIAL_ITEM_ESSENCE);
...
int itemdataman::get_item_shop_price(unsigned int id)
{
	...
	switch(datatype) {
		...
		CASE_GET_ITEM_SHOP_PRICE(LOTTERY2_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(LOTTERY3_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(GENERAL_ARTICLE_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(CASH_MEDIC_MERGE_ITEM_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(UPGRADE_EQUIP_STONE_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(RUNE_EQUIP_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(RUNE_SLOT_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(SCROLL_DIG_COUNT_INC_ESSENCE);
		CASE_GET_ITEM_SHOP_PRICE(PROP_ADD_MATERIAL_ITEM_ESSENCE);
...
int itemdataman::get_item_pile_limit(unsigned int id)
{
	...
	switch(datatype) {
		...
		CASE_GET_ITEM_PILE_LIMIT(LOTTERY2_ESSENCE);
		CASE_GET_ITEM_PILE_LIMIT(LOTTERY3_ESSENCE);
		CASE_GET_ITEM_PILE_LIMIT(GENERAL_ARTICLE_ESSENCE);
		CASE_GET_ITEM_PILE_LIMIT(CASH_MEDIC_MERGE_ITEM_ESSENCE);
		CASE_GET_ITEM_PILE_LIMIT(UPGRADE_EQUIP_STONE_ESSENCE);
		CASE_GET_ITEM_PILE_LIMIT(RUNE_EQUIP_ESSENCE);
...
int itemdataman::get_item_proc_type(unsigned int id)
{
	...
	switch(datatype) {
		...
		CASE_GET_ITEM_PROC_TYPE(LOTTERY2_ESSENCE);
		CASE_GET_ITEM_PROC_TYPE(LOTTERY3_ESSENCE);
		CASE_GET_ITEM_PROC_TYPE(GENERAL_ARTICLE_ESSENCE);
		CASE_GET_ITEM_PROC_TYPE(CASH_MEDIC_MERGE_ITEM_ESSENCE);
		CASE_GET_ITEM_PROC_TYPE(UPGRADE_EQUIP_STONE_ESSENCE);
		CASE_GET_ITEM_PROC_TYPE(RUNE_EQUIP_ESSENCE);
