#ifndef __CPPGEN_GNET_SKILL3056
#define __CPPGEN_GNET_SKILL3056
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3056:public Skill
    {
      public:
        enum
        { SKILL_ID = 3056 };
          Skill3056 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3056Stub:public SkillStub
    {
      public:
        Skill3056Stub ():SkillStub (3056)
        {
            occupation = 168;
            name = L"ÃðÏÉ";
            nativename = "ÃðÏÉ";
