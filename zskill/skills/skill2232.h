#ifndef __CPPGEN_GNET_SKILL2232
#define __CPPGEN_GNET_SKILL2232
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2232:public Skill
    {
      public:
        enum
        { SKILL_ID = 2232 };
          Skill2232 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2232Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2232Stub ():SkillStub (2232)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               2 * skill->GetLevel (),
                               5 * skill->GetLevel (),
                               8 * skill->GetLevel (), 20 * skill->GetLevel (), 10 + skill->GetLevel (), 50 + 5 * skill->GetLevel ());
