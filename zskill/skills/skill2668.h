#ifndef __CPPGEN_GNET_SKILL2668
#define __CPPGEN_GNET_SKILL2668
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2668:public Skill
    {
      public:
        enum
        { SKILL_ID = 2668 };
          Skill2668 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2668Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
