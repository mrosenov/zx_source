#ifndef __CPPGEN_GNET_SKILL1064
#define __CPPGEN_GNET_SKILL1064
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1064:public Skill
    {
      public:
        enum
        { SKILL_ID = 1064 };
          Skill1064 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1064Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1064Stub ():SkillStub (1064)
        {
            occupation = 128;
            name = L"Boss黑心老人B";
            nativename = "Boss黑心老人B";
            icon = "";
            maxlevel = 500;
            maxlearn = 10;
            type = 2;
