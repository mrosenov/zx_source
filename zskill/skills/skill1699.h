#ifndef __CPPGEN_GNET_SKILL1699
#define __CPPGEN_GNET_SKILL1699
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1699:public Skill
    {
      public:
        enum
        { SKILL_ID = 1699 };
          Skill1699 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1699Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1699Stub ():SkillStub (1699)
        {
            occupation = 146;
            name = L"ÌìÍâ·ğ¹â£º°µ";
            nativename = "ÌìÍâ·ğ¹â£º°µ";
            icon = "ÌìÍâ·ğ¹â.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 2;
