...
namespace GNET
{
    ...
    class Skill5014Stub:public SkillStub
    {
      ...
      Skill5014Stub ():SkillStub (5014)
        ...
        {
            return _snwprintf (buffer, length, format, 25 * skill->GetLevel (), 20 * skill->GetLevel (), 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetVar1 () >
                                           skill->GetPlayer ()->GetDef ()? skill->GetPlayer ()->GetVar1 () : skill->GetPlayer ()->GetDef ());
