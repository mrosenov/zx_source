#ifndef __CPPGEN_GNET_SKILL4097
#define __CPPGEN_GNET_SKILL4097
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4097:public Skill
    {
      public:
        enum
        { SKILL_ID = 4097 };
          Skill4097 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4097Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4097Stub ():SkillStub (4097)
        {
            occupation = 130;
            name = L"Õæ¡¤Á¶ÓüÉñ»ğ";
            nativename = "Õæ¡¤Á¶ÓüÉñ»ğ";
            icon = "·ÉÉıÁ¶ÓüÉñ»ğ.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
