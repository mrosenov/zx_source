#ifndef __CPPGEN_GNET_SKILL4465
#define __CPPGEN_GNET_SKILL4465
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4465:public Skill
    {
      public:
        enum
        { SKILL_ID = 4465 };
          Skill4465 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4465Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
