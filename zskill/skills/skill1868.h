...
namespace GNET
{
    ...
    class Skill1868Stub:public SkillStub
    {
      ...
      Skill1868Stub ():SkillStub (1868)
        ...
        {
            return _snwprintf (buffer, length, format, 443 + 12 * skill->GetLevel (), 1043 + 33 * skill->GetLevel (), 35 + 5 * skill->GetLevel (), 8);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (35 + 5 * skill->GetLevel ());
