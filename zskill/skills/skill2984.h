#ifndef __CPPGEN_GNET_SKILL2984
#define __CPPGEN_GNET_SKILL2984
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2984:public Skill
    {
      public:
        enum
        { SKILL_ID = 2984 };
          Skill2984 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2984Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2984Stub ():SkillStub (2984)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (40886);
