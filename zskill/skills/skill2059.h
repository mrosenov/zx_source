#ifndef __CPPGEN_GNET_SKILL2059
#define __CPPGEN_GNET_SKILL2059
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2059:public Skill
    {
      public:
        enum
        { SKILL_ID = 2059 };
          Skill2059 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2059Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2059Stub ():SkillStub (2059)
        ...
        {
            return (float) (100 * skill->GetT0 () + 400);
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               100 * skill->GetT0 () + 400,
                               3 * skill->GetLevel (), 30 * skill->GetLevel (), 5 + skill->GetLevel (), 4 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((100 * skill->GetT0 () + 400) * 0.3 * skill->GetLevel ());
