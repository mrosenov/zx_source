#ifndef __CPPGEN_GNET_SKILL3569
#define __CPPGEN_GNET_SKILL3569
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3569:public Skill
    {
      public:
        enum
        { SKILL_ID = 3569 };
          Skill3569 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3569Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetSkillaccu ((zrand (100) < (1 + 2 * int (skill->GetLevel () / 2)) ? 300 : 0));
        ...
        class State5:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetMaxatk ());
                skill->SetSkillaccu ((zrand (100) < (1 + 3 * int (skill->GetLevel () / 2)) ? 300 : 0));
                skill->SetRatio (1 + 0.01 * (4 * skill->GetLevel () + int (skill->GetLevel () / 15) * 8 * (skill->GetLevel () - 15)) +0.04 *
                                 skill->GetT0 ());
                skill->SetPlus (375 + 21 * skill->GetLevel () + 3 * skill->GetLevel () * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (0);
        ...
        class State8:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetMaxatk ());
                skill->SetSkillaccu ((zrand (100) < (1 + 5 * int (skill->GetLevel () / 2)) ? 300 : 0));
                skill->SetRatio (1 + 0.01 * (4 * skill->GetLevel () + int (skill->GetLevel () / 15) * 8 * (skill->GetLevel () - 15)) +0.04 *
                                 skill->GetT0 ());
                skill->SetPlus (375 + 21 * skill->GetLevel () + 3 * skill->GetLevel () * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (0);
...
#endif
      Skill3569Stub ():SkillStub (3569)
        {
            occupation = 167;
            name = L"ÄÏÎ×Ìì»ğ<Ğş>";
            nativename = "ÄÏÎ×Ìì»ğ<Ğş>";
            icon = "ÏÉ¡¤ÄÏÎ×Ìì»ğ.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
            eventflag = 0;
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               15, 1 + 2 * INT (skill->GetLevel () / 2), 1 + 3 * INT (skill->GetLevel () / 2), 1 + 5 * INT (skill->GetLevel () / 2));
