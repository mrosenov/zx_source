#ifndef __CPPGEN_GNET_SKILL3094
#define __CPPGEN_GNET_SKILL3094
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3094:public Skill
    {
      public:
        enum
        { SKILL_ID = 3094 };
          Skill3094 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3094Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (244 + 10 * skill->GetLevel () + skill->GetPlayer ()->GetHp () * 0.05 * skill->GetT0 () +
                                skill->GetPlayer ()->GetRes4 () * (2 + skill->GetLevel ()));
                skill->GetPlayer ()->SetHp (skill->GetPlayer ()->GetHp () * (1 - 0.05 * skill->GetT0 ()));
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill3094Stub ():SkillStub (3094)
        {
            occupation = 168;
            name = L"ÌìÖï<É·>";
            nativename = "ÌìÖï<É·>";
