#ifndef __CPPGEN_GNET_SKILL1705
#define __CPPGEN_GNET_SKILL1705
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1705:public Skill
    {
      public:
        enum
        { SKILL_ID = 1705 };
          Skill1705 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1705Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1705Stub ():SkillStub (1705)
        {
            occupation = 146;
            name = L"Ôø¼Ç·ñ£º°µ";
            nativename = "Ôø¼Ç·ñ£º°µ";
            icon = "Ôø¼Ç·ñ.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 1;
