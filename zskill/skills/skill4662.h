#ifndef __CPPGEN_GNET_SKILL4662
#define __CPPGEN_GNET_SKILL4662
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4662:public Skill
    {
      public:
        enum
        { SKILL_ID = 4662 };
          Skill4662 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4662Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4662Stub ():SkillStub (4662)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.005 * skill->GetLevel () * 4);
