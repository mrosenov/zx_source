...
namespace GNET
{
    ...
    class Skill3922Stub:public SkillStub
    {
      ...
      Skill3922Stub ():SkillStub (3922)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetVar1 () > skill->GetPlayer ()->GetMaxatk ()? 120 : 30));
            skill->GetVictim ()->SetTime (5000 + 200 * skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMaxatk () * (skill->GetLevel () + 5) * 0.01);
