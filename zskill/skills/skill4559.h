#ifndef __CPPGEN_GNET_SKILL4559
#define __CPPGEN_GNET_SKILL4559
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4559:public Skill
    {
      public:
        enum
        { SKILL_ID = 4559 };
          Skill4559 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4559Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
