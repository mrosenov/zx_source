#ifndef __CPPGEN_GNET_SKILL1504
#define __CPPGEN_GNET_SKILL1504
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1504:public Skill
    {
      public:
        enum
        { SKILL_ID = 1504 };
          Skill1504 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1504Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
