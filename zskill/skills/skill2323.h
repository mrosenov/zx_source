#ifndef __CPPGEN_GNET_SKILL2323
#define __CPPGEN_GNET_SKILL2323
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2323:public Skill
    {
      public:
        enum
        { SKILL_ID = 2323 };
          Skill2323 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2323Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
