#ifndef __CPPGEN_GNET_SKILL4595
#define __CPPGEN_GNET_SKILL4595
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4595:public Skill
    {
      public:
        enum
        { SKILL_ID = 4595 };
          Skill4595 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4595Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4595Stub ():SkillStub (4595)
        {
            occupation = 169;
            name = L"Äù¡¤»ÊÌì·¨»êÊõ<ìø>";
            nativename = "Äù¡¤»ÊÌì·¨»êÊõ<ìø>";
            icon = "·¨»êÊõ(ìø).dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               5 * skill->GetLevel (), 10 * skill->GetLevel ());
