#ifndef __CPPGEN_GNET_SKILL4606
#define __CPPGEN_GNET_SKILL4606
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4606:public Skill
    {
      public:
        enum
        { SKILL_ID = 4606 };
          Skill4606 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4606Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4606Stub ():SkillStub (4606)
        {
            occupation = 146;
            name = L"Áù¾õÉí£º»Ê";
            nativename = "Áù¾õÉí£º»Ê";
            icon = "Áù¾õÉí.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
