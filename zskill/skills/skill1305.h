#ifndef __CPPGEN_GNET_SKILL1305
#define __CPPGEN_GNET_SKILL1305
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1305:public Skill
    {
      public:
        enum
        { SKILL_ID = 1305 };
          Skill1305 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1305Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
