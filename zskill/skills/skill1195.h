#ifndef __CPPGEN_GNET_SKILL1195
#define __CPPGEN_GNET_SKILL1195
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1195:public Skill
    {
      public:
        enum
        { SKILL_ID = 1195 };
          Skill1195 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1195Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
