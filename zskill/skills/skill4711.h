#ifndef __CPPGEN_GNET_SKILL4711
#define __CPPGEN_GNET_SKILL4711
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4711:public Skill
    {
      public:
        enum
        { SKILL_ID = 4711 };
          Skill4711 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4711Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4711Stub ():SkillStub (4711)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetTmplid () == 55107 ? 100 : 0));
