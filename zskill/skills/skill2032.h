#ifndef __CPPGEN_GNET_SKILL2032
#define __CPPGEN_GNET_SKILL2032
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2032:public Skill
    {
      public:
        enum
        { SKILL_ID = 2032 };
          Skill2032 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2032Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2032Stub ():SkillStub (2032)
        {
            occupation = 128;
            name = L"街头霸王-Bison";
            nativename = "街头霸王-Bison";
            icon = "";
            maxlevel = 100;
            maxlearn = 100;
            type = 1;
