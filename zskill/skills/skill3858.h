#ifndef __CPPGEN_GNET_SKILL3858
#define __CPPGEN_GNET_SKILL3858
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3858:public Skill
    {
      public:
        enum
        { SKILL_ID = 3858 };
          Skill3858 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3858Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3858Stub ():SkillStub (3858)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (zrand (5 + skill->GetLevel () / 5));
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetVar1 () * (norm (zrand (100) / (99 - 3 * skill->GetLevel ())) == 0 ? 0 : 3467));
