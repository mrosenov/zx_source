#ifndef __CPPGEN_GNET_SKILL1834
#define __CPPGEN_GNET_SKILL1834
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1834:public Skill
    {
      public:
        enum
        { SKILL_ID = 1834 };
          Skill1834 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1834Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
