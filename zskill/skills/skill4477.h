#ifndef __CPPGEN_GNET_SKILL4477
#define __CPPGEN_GNET_SKILL4477
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4477:public Skill
    {
      public:
        enum
        { SKILL_ID = 4477 };
          Skill4477 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4477Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
