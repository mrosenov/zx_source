#ifndef __CPPGEN_GNET_SKILL4104
#define __CPPGEN_GNET_SKILL4104
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4104:public Skill
    {
      public:
        enum
        { SKILL_ID = 4104 };
          Skill4104 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4104Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4104Stub ():SkillStub (4104)
        {
            ...
            action[13] = "灵夙_法宝_五龙轮";
            action[14] = "英招_法宝_五龙轮";
            action[15] = "鬼道_骑乘_法宝_五龙轮";
            action[16] = "青云门_骑乘_法宝_五龙轮";
            action[17] = "鬼王宗_骑乘_法宝_五龙轮";
            action[18] = "合欢派_骑乘_法宝_五龙轮";
            action[19] = "天音寺_骑乘_法宝_五龙轮";
            action[20] = "鬼道_骑乘_法宝_五龙轮";
            action[21] = "焚香谷_骑乘_法宝_五龙轮";
            action[22] = "兽神_骑乘_法宝_五龙轮";
            action[23] = "狐妖_骑乘_法宝_五龙轮";
            action[24] = "轩辕_骑乘_法宝_五龙轮";
            action[25] = "怀光_骑乘_法宝_五龙轮";
            action[26] = "太昊_骑乘_法宝_五龙轮";
            action[27] = "天华_骑乘_法宝_五龙轮";
            action[28] = "灵夙_骑乘_法宝_五龙轮";
            action[29] = "英招_骑乘_法宝_五龙轮";
            action[30] = "0";
            rangetype = 0;
            doenchant = true;
            dobless = true;
