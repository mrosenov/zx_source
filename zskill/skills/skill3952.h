...
namespace GNET
{
    ...
    class Skill3952Stub:public SkillStub
    {
      ...
      Skill3952Stub ():SkillStub (3952)
        {
            occupation = 128;
            name = L"ÅÀËþ-ÖÜÆÚÑ£ÔÎ";
            nativename = "ÅÀËþ-ÖÜÆÚÑ£ÔÎ";
            icon = "";
            maxlevel = 99;
            maxlearn = 99;
            type = 1;
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetVar1 () > skill->GetPlayer ()->GetRes1 ()? 80 : 30));
            skill->GetVictim ()->SetTime (5000 + 100 * skill->GetLevel ());
            skill->GetVictim ()->SetAmount (3);
            skill->GetVictim ()->SetValue (1);
            skill->GetVictim ()->SetDizzytimer (1);
            return true;
        }
#endif
    };
