#ifndef __CPPGEN_GNET_SKILL4996
#define __CPPGEN_GNET_SKILL4996
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4996:public Skill
    {
      public:
        enum
        { SKILL_ID = 4996 };
          Skill4996 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4996Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
                ...
                skill->
                    SetPlus ((skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () + skill->GetPlayer ()->GetRes3 () +
                              skill->GetPlayer ()->GetRes4 () + skill->GetPlayer ()->GetRes5 ()) * (skill->GetPlayer ()->GetRes6 () +
                                                                                                    skill->GetPlayer ()->GetMp ()));
                skill->GetPlayer ()->SetDie (1);
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4996Stub ():SkillStub (4996)
        {
            occupation = 128;
            name = L"Ç£»ú-ÕÙ»½1";
            nativename = "Ç£»ú-ÕÙ»½1";
