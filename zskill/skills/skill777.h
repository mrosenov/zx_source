#ifndef __CPPGEN_GNET_SKILL777
#define __CPPGEN_GNET_SKILL777
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill777:public Skill
    {
      public:
        enum
        { SKILL_ID = 777 };
          Skill777 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill777Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill777Stub ():SkillStub (777)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               INT (950 + 15 * skill->GetLevel ()), 25, 10, 100 * skill->GetLevel (), 33, 120 * skill->GetLevel ());
