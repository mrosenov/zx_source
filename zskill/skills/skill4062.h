#ifndef __CPPGEN_GNET_SKILL4062
#define __CPPGEN_GNET_SKILL4062
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4062:public Skill
    {
      public:
        enum
        { SKILL_ID = 4062 };
          Skill4062 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4062Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4062Stub ():SkillStub (4062)
        {
            occupation = 130;
            name = L"Õæ¡¤ÌìµØĞş¼«";
            nativename = "Õæ¡¤ÌìµØĞş¼«";
            icon = "·ÉÉıÌìµØĞş¼«.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
