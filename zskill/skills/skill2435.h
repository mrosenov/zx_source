    ...
    class Skill2435Stub:public SkillStub
    {
      ...
      Skill2435Stub ():SkillStub (2435)
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (3000 + 1000 * skill->GetT0 ());
            skill->GetVictim ()->SetRatio (0.1 * skill->GetLevel ());
            skill->GetVictim ()->SetNingjin (1);
            skill->GetVictim ()->SetTime (skill->GetT2 () > 0 ? (1000 * skill->GetT2 ()) : 0);
            ...
            skill->GetVictim ()->SetProbability (1.0 * (120 * norm (skill->GetT2 ())));
            skill->GetVictim ()->SetTime (2500 * skill->GetT2 ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (0.4 * skill->GetT2 ());
