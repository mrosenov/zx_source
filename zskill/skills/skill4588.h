#ifndef __CPPGEN_GNET_SKILL4588
#define __CPPGEN_GNET_SKILL4588
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4588:public Skill
    {
      public:
        enum
        { SKILL_ID = 4588 };
          Skill4588 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4588Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4588Stub ():SkillStub (4588)
        ...
        {
            return 60000 - 1000 * (skill->GetT2 () + skill->GetT3 () + skill->GetT4 ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               1.5 * skill->GetLevel (),
                               2 * skill->GetLevel (),
                               2.5 * skill->GetLevel (), 3 * skill->GetLevel (), 3.5 * skill->GetLevel (), 0.5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.005 * skill->GetLevel ());
