#ifndef __CPPGEN_GNET_SKILL4067
#define __CPPGEN_GNET_SKILL4067
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4067:public Skill
    {
      public:
        enum
        { SKILL_ID = 4067 };
          Skill4067 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4067Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4067Stub ():SkillStub (4067)
        {
            occupation = 130;
            name = L"Õæ¡¤éäÂäÁ÷»ª";
            nativename = "Õæ¡¤éäÂäÁ÷»ª";
            icon = "·ÉÉýéäÂäÁ÷»ª.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
