#ifndef __CPPGEN_GNET_SKILL3076
#define __CPPGEN_GNET_SKILL3076
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3076:public Skill
    {
      public:
        enum
        { SKILL_ID = 3076 };
          Skill3076 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3076Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetVar2 ((skill->GetPlayer ()->GetMp () - skill->GetPlayer ()->GetMaxmp () * 0.025 * skill->GetLevel ()) >
                                              0 ? 1 : 0);
      ...
      Skill3076Stub ():SkillStub (3076)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               60, 30, 20 + 3 * skill->GetLevel (), 20 + 4 * skill->GetLevel (), 20 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (5231);
            skill->GetVictim ()->SetDelaycast (1);
            skill->GetVictim ()->SetProbability (1.0 * (120 * skill->GetPlayer ()->GetVar2 ()));
            skill->GetVictim ()->SetTime (300000);
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.05 * skill->GetLevel ());
