#ifndef __CPPGEN_GNET_SKILL1070
#define __CPPGEN_GNET_SKILL1070
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1070:public Skill
    {
      public:
        enum
        { SKILL_ID = 1070 };
          Skill1070 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1070Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
