#ifndef __CPPGEN_GNET_SKILL3247
#define __CPPGEN_GNET_SKILL3247
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3247:public Skill
    {
      public:
        enum
        { SKILL_ID = 3247 };
          Skill3247 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3247Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
