#ifndef __CPPGEN_GNET_SKILL1532
#define __CPPGEN_GNET_SKILL1532
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1532:public Skill
    {
      public:
        enum
        { SKILL_ID = 1532 };
          Skill1532 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1532Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1532Stub ():SkillStub (1532)
        ...
        {
            return (float) (500 + 25 * skill->GetLevel ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               500 + 25 * skill->GetLevel (),
                               3 * skill->GetLevel (), 2 * skill->GetLevel (), 600 * skill->GetLevel (), 20, 50 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (20 * skill->GetPlayer ()->GetLevel ());
            skill->GetVictim ()->SetValue (600 * skill->GetLevel () + 0.01 * skill->GetLevel () * skill->GetPlayer ()->GetHp ());
