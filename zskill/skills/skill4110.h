#ifndef __CPPGEN_GNET_SKILL4110
#define __CPPGEN_GNET_SKILL4110
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4110:public Skill
    {
      public:
        enum
        { SKILL_ID = 4110 };
          Skill4110 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4110Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4110Stub ():SkillStub (4110)
        {
            occupation = 130;
            name = L"Õæ¡¤ÊÉÑªĞ°Áé";
            nativename = "Õæ¡¤ÊÉÑªĞ°Áé";
            icon = "·ÉÉıÊÉÑªĞ°Áé.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               250 * skill->GetLevel (),
                               9 - skill->GetLevel (),
                               555 - 35 * skill->GetLevel () - skill->GetLevel () * skill->GetLevel (), 6.3 - 0.3 * skill->GetLevel ());
