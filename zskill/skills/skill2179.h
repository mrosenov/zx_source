#ifndef __CPPGEN_GNET_SKILL2179
#define __CPPGEN_GNET_SKILL2179
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2179:public Skill
    {
      public:
        enum
        { SKILL_ID = 2179 };
          Skill2179 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2179Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2179Stub ():SkillStub (2179)
        {
            occupation = 128;
            name = L"竞技场-Buff-3";
            nativename = "竞技场-Buff-3";
            icon = "";
            maxlevel = 99;
            maxlearn = 99;
            type = 1;
