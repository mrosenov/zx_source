#ifndef __CPPGEN_GNET_SKILL1598
#define __CPPGEN_GNET_SKILL1598
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1598:public Skill
    {
      public:
        enum
        { SKILL_ID = 1598 };
          Skill1598 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1598Stub:public SkillStub
    {
      public:
        Skill1598Stub ():SkillStub (1598)
        {
            occupation = 148;
            name = L"道之法谕";
            nativename = "道之法谕";
