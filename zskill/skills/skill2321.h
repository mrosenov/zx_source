#ifndef __CPPGEN_GNET_SKILL2321
#define __CPPGEN_GNET_SKILL2321
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2321:public Skill
    {
      public:
        enum
        { SKILL_ID = 2321 };
          Skill2321 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2321Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
