#ifndef __CPPGEN_GNET_SKILL563
#define __CPPGEN_GNET_SKILL563
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill563:public Skill
    {
      public:
        enum
        { SKILL_ID = 563 };
          Skill563 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill563Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
