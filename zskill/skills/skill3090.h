#ifndef __CPPGEN_GNET_SKILL3090
#define __CPPGEN_GNET_SKILL3090
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3090:public Skill
    {
      public:
        enum
        { SKILL_ID = 3090 };
          Skill3090 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3090Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (7000 + 1000 * skill->GetLevel ());
            skill->GetVictim ()->SetRatio (0.02 * skill->GetLevel () + 0.00001);
            ...
            skill->GetVictim ()->SetTime (7000 + 1000 * skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetRes2 () * 0.01 * skill->GetLevel ());
