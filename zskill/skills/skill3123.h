#ifndef __CPPGEN_GNET_SKILL3123
#define __CPPGEN_GNET_SKILL3123
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3123:public Skill
    {
      public:
        enum
        { SKILL_ID = 3123 };
          Skill3123 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3123Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               180, 20, 2, 3 * skill->GetLevel (), 2 * skill->GetLevel (), 10 * skill->GetLevel ());
