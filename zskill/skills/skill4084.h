#ifndef __CPPGEN_GNET_SKILL4084
#define __CPPGEN_GNET_SKILL4084
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4084:public Skill
    {
      public:
        enum
        { SKILL_ID = 4084 };
          Skill4084 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4084Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
