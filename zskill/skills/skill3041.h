#ifndef __CPPGEN_GNET_SKILL3041
#define __CPPGEN_GNET_SKILL3041
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3041:public Skill
    {
      public:
        enum
        { SKILL_ID = 3041 };
          Skill3041 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3041Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               515 + 9 * skill->GetLevel (), 50 + 5 * skill->GetLevel (), 2 * skill->GetLevel (), 2 + 0.3 * skill->GetLevel (), 5);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetVar2 () + 2 * skill->GetLevel ()));
