#ifndef __CPPGEN_GNET_SKILL1068
#define __CPPGEN_GNET_SKILL1068
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1068:public Skill
    {
      public:
        enum
        { SKILL_ID = 1068 };
          Skill1068 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1068Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
