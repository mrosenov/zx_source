#ifndef __CPPGEN_GNET_SKILL1615
#define __CPPGEN_GNET_SKILL1615
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1615:public Skill
    {
      public:
        enum
        { SKILL_ID = 1615 };
          Skill1615 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1615Stub:public SkillStub
    {
      public:
        Skill1615Stub ():SkillStub (1615)
        {
            occupation = 150;
            name = L"佛之真法";
            nativename = "佛之真法";
 ...
 80000 };
        ...
        {
            skill->GetPlayer ()->SetPasdecfatalhurt (0.03 * skill->GetLevel ());
