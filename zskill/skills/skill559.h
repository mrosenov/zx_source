#ifndef __CPPGEN_GNET_SKILL559
#define __CPPGEN_GNET_SKILL559
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill559:public Skill
    {
      public:
        enum
        { SKILL_ID = 559 };
          Skill559 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill559Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
