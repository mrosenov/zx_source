...
namespace GNET
{
    ...
    class Skill1277Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1.05 + 0.1 * norm (skill->GetLevel () / 60));
                skill->SetPlus (8 * skill->GetLevel () * norm (skill->GetLevel () / 30));
      ...
      Skill1277Stub ():SkillStub (1277)
        ...
        {
            return (float) (17 + 2 * skill->GetLevel ());
        }
        ...
        {
            return _snwprintf (buffer, length, format, 17 + 2 * skill->GetLevel (), 5, 15, 50 * skill->GetLevel (), 12, 8 * skill->GetLevel (), 10);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount ((0.5 * skill->GetLevel () * skill->GetPlayer ()->GetLevel ()) *
                                            norm (0.15 * skill->GetPlayer ()->GetMaxhp () / (skill->GetPlayer ()->GetHp () + 1)));
