#ifndef __CPPGEN_GNET_SKILL434
#define __CPPGEN_GNET_SKILL434
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill434:public Skill
    {
      public:
        enum
        { SKILL_ID = 434 };
          Skill434 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill434Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
