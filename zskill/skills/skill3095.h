#ifndef __CPPGEN_GNET_SKILL3095
#define __CPPGEN_GNET_SKILL3095
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3095:public Skill
    {
      public:
        enum
        { SKILL_ID = 3095 };
          Skill3095 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3095Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetRes4 () * skill->GetLevel () * 0.005);
