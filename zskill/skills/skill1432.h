#ifndef __CPPGEN_GNET_SKILL1432
#define __CPPGEN_GNET_SKILL1432
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1432:public Skill
    {
      public:
        enum
        { SKILL_ID = 1432 };
          Skill1432 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1432Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (7 * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill1432Stub ():SkillStub (1432)
        {
            occupation = 145;
            name = L"×ÆÈÈ<»ðê×>";
            nativename = "×ÆÈÈ<»ðê×>";
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               10 + 5 * skill->GetLevel (), 12, 7 * skill->GetLevel (), 2 * skill->GetLevel (), 6, 8, 15, 30, 15, 5);
