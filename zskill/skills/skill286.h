#ifndef __CPPGEN_GNET_SKILL286
#define __CPPGEN_GNET_SKILL286
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill286:public Skill
    {
      public:
        enum
        { SKILL_ID = 286 };
          Skill286 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill286Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
