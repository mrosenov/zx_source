#ifndef __CPPGEN_GNET_SKILL2320
#define __CPPGEN_GNET_SKILL2320
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2320:public Skill
    {
      public:
        enum
        { SKILL_ID = 2320 };
          Skill2320 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2320Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
