#ifndef __CPPGEN_GNET_SKILL5266
#define __CPPGEN_GNET_SKILL5266
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5266:public Skill
    {
      public:
        enum
        { SKILL_ID = 5266 };
          Skill5266 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5266Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
