#ifndef __CPPGEN_GNET_SKILL3704
#define __CPPGEN_GNET_SKILL3704
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3704:public Skill
    {
      public:
        enum
        { SKILL_ID = 3704 };
          Skill3704 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3704Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3704Stub ():SkillStub (3704)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               320 + skill->GetLevel () * skill->GetLevel () * 6, 2 * skill->GetLevel (), skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetLevel () * 10 + skill->GetT0 ());
            skill->GetVictim ()->SetValue (3609);
            ...
            skill->GetVictim ()->SetProbability (1.0 * (0));
            skill->GetVictim ()->SetTime (skill->GetT3 () * 1000);
            skill->GetVictim ()->SetRatio (4098);
            skill->GetVictim ()->SetBuffid (7);
            skill->GetVictim ()->SetAmount (skill->GetT3 ());
            skill->GetVictim ()->SetValue (3815);
            skill->GetVictim ()->SetActiveonfilteradd (1);
            return true;
        }
        bool BlessMe (Skill * skill) const
        {
            skill->GetVictim ()->SetRatio (norm (zrand (100) / (70 - 5 * skill->GetT2 ())) == 0 ? 0 : skill->GetPlayer ()->GetVar2 () * 3466);
