...
namespace GNET
{
    ...
    class Skill788Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.06 * skill->GetT0 () + 0.1 * skill->GetLevel () + 0.05 * skill->GetT1 () +
                                 0.04 * (skill->GetT3 () >=
      ...
      Skill788Stub ():SkillStub (788)
        ...
        {
            return (float) (1.2 * skill->GetLevel () * skill->GetLevel () + 60 * skill->GetLevel () + 500);
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               INT (1.2 * skill->GetLevel () * skill->GetLevel () + 60 * skill->GetLevel () + 500),
                               35,
                               15,
                               10,
                               ...
                               3,
                               40 + 10 * skill->GetLevel (),
                               10,
                               skill->GetT3 () > 0 || skill->GetPlayer ()->GetSkilllevel (4530) > 0
                               || skill->GetPlayer ()->GetSkilllevel (4112) > 0 ? table.Find (7883) : table.Find (7884));
                                          ...
                                          600 * (skill->GetT3 () >=
                                                 skill->GetT4 ()? (skill->GetT3 () >=
                                                                   skill->GetT5 ()? skill->GetT3 () : skill->GetT5 ()) : (skill->GetT4 () >=
                                                                                                                          ...
                                                                                                                          GetT5 ())));
            skill->GetVictim ()->
                SetRatio ((0.42 + 0.1 * skill->GetLevel () -
                           ((skill->GetPlayer ()->GetSaint () * 0.002 - skill->GetPlayer ()->GetVar2 () * 0.0015) >
                            0 ? (skill->GetPlayer ()->GetSaint () * 0.002 - skill->GetPlayer ()->GetVar2 () * 0.0015) : 0)) >
                          0.35 ? (0.42 + 0.1 * skill->GetLevel () -
                                  ((skill->GetPlayer ()->GetSaint () * 0.002 - skill->GetPlayer ()->GetVar2 () * 0.0015) >
                                   0 ? (skill->GetPlayer ()->GetSaint () * 0.002 - skill->GetPlayer ()->GetVar2 () * 0.0015) : 0)) : 0.35);
