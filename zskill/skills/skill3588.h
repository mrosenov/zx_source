#ifndef __CPPGEN_GNET_SKILL3588
#define __CPPGEN_GNET_SKILL3588
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3588:public Skill
    {
      public:
        enum
        { SKILL_ID = 3588 };
          Skill3588 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3588Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
