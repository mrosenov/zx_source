#ifndef __CPPGEN_GNET_SKILL5032
#define __CPPGEN_GNET_SKILL5032
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5032:public Skill
    {
      public:
        enum
        { SKILL_ID = 5032 };
          Skill5032 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5032Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5032Stub ():SkillStub (5032)
        ...
        {
            return (float) (skill->GetPlayer ()->GetRange () + 21);
        }
            ...
            skill->GetVictim ()->SetTime (1000 *
                                          (5 +
                                           5 * (norm (skill->GetLevel () / 30) + norm (skill->GetLevel () / 60) + norm (skill->GetLevel () / 90) +
                                                norm (skill->GetLevel () / 100))));
            skill->GetVictim ()->SetRatio (0.01 * skill->GetPlayer ()->GetVar1 () + 0.001);
