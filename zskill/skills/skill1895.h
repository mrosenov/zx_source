#ifndef __CPPGEN_GNET_SKILL1895
#define __CPPGEN_GNET_SKILL1895
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1895:public Skill
    {
      public:
        enum
        { SKILL_ID = 1895 };
          Skill1895 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1895Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
