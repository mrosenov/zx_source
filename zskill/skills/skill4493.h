#ifndef __CPPGEN_GNET_SKILL4493
#define __CPPGEN_GNET_SKILL4493
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4493:public Skill
    {
      public:
        enum
        { SKILL_ID = 4493 };
          Skill4493 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4493Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
