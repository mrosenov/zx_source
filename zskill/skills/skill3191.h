#ifndef __CPPGEN_GNET_SKILL3191
#define __CPPGEN_GNET_SKILL3191
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3191:public Skill
    {
      public:
        enum
        { SKILL_ID = 3191 };
          Skill3191 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3191Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3191Stub ():SkillStub (3191)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (200 + zrand (100));
