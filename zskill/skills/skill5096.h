...
namespace GNET
{
    ...
    class Skill5096Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetPlus (2000 + skill->GetPlayer ()->GetMaxmp () * 0.02 * 6);
                skill->SetCrithurt (0.05 * 2);
      ...
      Skill5096Stub ():SkillStub (5096)
        ...
        {
            return _snwprintf (buffer, length, format, 2 * 6, 3 * 6, 4 * 6, 5 * 6, 6 * 6, 7 * 6);
