#ifndef __CPPGEN_GNET_SKILL1646
#define __CPPGEN_GNET_SKILL1646
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1646:public Skill
    {
      public:
        enum
        { SKILL_ID = 1646 };
          Skill1646 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1646Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
