#ifndef __CPPGEN_GNET_SKILL1401
#define __CPPGEN_GNET_SKILL1401
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1401:public Skill
    {
      public:
        enum
        { SKILL_ID = 1401 };
          Skill1401 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1401Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1401Stub ():SkillStub (1401)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (12000 * norm (skill->GetLevel () / 90) * norm ((zrand (100) / 85)) + 100);
