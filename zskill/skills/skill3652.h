#ifndef __CPPGEN_GNET_SKILL3652
#define __CPPGEN_GNET_SKILL3652
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3652:public Skill
    {
      public:
        enum
        { SKILL_ID = 3652 };
          Skill3652 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3652Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
