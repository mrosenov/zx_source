#ifndef __CPPGEN_GNET_SKILL4081
#define __CPPGEN_GNET_SKILL4081
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4081:public Skill
    {
      public:
        enum
        { SKILL_ID = 4081 };
          Skill4081 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4081Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4081Stub ():SkillStub (4081)
        {
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "天音寺_骑乘_法宝_轮回盘";
            action[16] = "天音寺_骑乘_法宝_轮回盘";
            action[17] = "天音寺_骑乘_法宝_轮回盘";
            action[18] = "天音寺_骑乘_法宝_轮回盘";
            action[19] = "天音寺_骑乘_法宝_轮回盘";
            action[20] = "天音寺_骑乘_法宝_轮回盘";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
