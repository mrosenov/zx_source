#ifndef __CPPGEN_GNET_SKILL3794
#define __CPPGEN_GNET_SKILL3794
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3794:public Skill
    {
      public:
        enum
        { SKILL_ID = 3794 };
          Skill3794 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3794Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
