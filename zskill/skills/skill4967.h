#ifndef __CPPGEN_GNET_SKILL4967
#define __CPPGEN_GNET_SKILL4967
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4967:public Skill
    {
      public:
        enum
        { SKILL_ID = 4967 };
          Skill4967 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4967Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (300 * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4967Stub ():SkillStub (4967)
        {
            occupation = 130;
            name = L"Õæ¡¤Ê¥ÊÞ¿ñÀÞ";
