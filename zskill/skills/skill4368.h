#ifndef __CPPGEN_GNET_SKILL4368
#define __CPPGEN_GNET_SKILL4368
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4368:public Skill
    {
      public:
        enum
        { SKILL_ID = 4368 };
          Skill4368 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4368Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4368Stub ():SkillStub (4368)
        {
            occupation = 130;
            name = L"Õæ¡¤Ç¬À¤Ò»ÖÀ";
            nativename = "Õæ¡¤Ç¬À¤Ò»ÖÀ";
            icon = "Ð°Ä§ÍËÉ¢.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
