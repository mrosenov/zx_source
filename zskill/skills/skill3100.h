#ifndef __CPPGEN_GNET_SKILL3100
#define __CPPGEN_GNET_SKILL3100
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3100:public Skill
    {
      public:
        enum
        { SKILL_ID = 3100 };
          Skill3100 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3100Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3100Stub ():SkillStub (3100)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               2 * skill->GetLevel (), 10 + 3 * skill->GetLevel (), 20 + 2 * skill->GetLevel (), 14 + 3 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (14 + 2 * skill->GetLevel () + skill->GetT2 ()));
            ...
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetRes4 () * skill->GetLevel () * 2);
