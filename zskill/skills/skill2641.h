#ifndef __CPPGEN_GNET_SKILL2641
#define __CPPGEN_GNET_SKILL2641
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2641:public Skill
    {
      public:
        enum
        { SKILL_ID = 2641 };
          Skill2641 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2641Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2641Stub ():SkillStub (2641)
        {
            occupation = 146;
            name = L"Áù¾õÉí£ºÎä";
            nativename = "Áù¾õÉí£ºÎä";
            icon = "Áù¾õÉí.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->
                SetRatio ((zrand (1000) < skill->GetPlayer ()->GetVar1 ())? (skill->GetPlayer ()->GetVar2 () >
                                                                             100 ? (skill->GetPlayer ()->GetVar2 () * 1.2 - 100) * 0.01 : 0.2) : 0.2);
