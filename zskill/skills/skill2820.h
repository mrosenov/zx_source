#ifndef __CPPGEN_GNET_SKILL2820
#define __CPPGEN_GNET_SKILL2820
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2820:public Skill
    {
      public:
        enum
        { SKILL_ID = 2820 };
          Skill2820 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2820Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
