#ifndef __CPPGEN_GNET_SKILL3114
#define __CPPGEN_GNET_SKILL3114
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3114:public Skill
    {
      public:
        enum
        { SKILL_ID = 3114 };
          Skill3114 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3114Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               120, 20, skill->GetLevel (), skill->GetLevel () + 1, 4 + skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (0.002 *
                                           (skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () + skill->GetPlayer ()->GetRes3 () +
                                            skill->GetPlayer ()->GetRes4 () + skill->GetPlayer ()->GetRes5 ()) * skill->GetLevel ());
