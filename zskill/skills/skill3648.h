#ifndef __CPPGEN_GNET_SKILL3648
#define __CPPGEN_GNET_SKILL3648
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3648:public Skill
    {
      public:
        enum
        { SKILL_ID = 3648 };
          Skill3648 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3648Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
