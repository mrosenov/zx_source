#ifndef __CPPGEN_GNET_SKILL3490
#define __CPPGEN_GNET_SKILL3490
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3490:public Skill
    {
      public:
        enum
        { SKILL_ID = 3490 };
          Skill3490 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3490Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (475 + 5 * skill->GetLevel () * skill->GetLevel () + 10 * skill->GetLevel ());
      ...
      Skill3490Stub ():SkillStub (3490)
        ...
        {
            return (float) (200 + 10 * skill->GetLevel () + 2 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        {
            static int array[8] = { 120, 122, 124, 126, 128, 130, 132, 136 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               200 + 10 * skill->GetLevel () + 2 * skill->GetLevel () * skill->GetLevel (),
                               475 + 5 * skill->GetLevel () * skill->GetLevel () + 10 * skill->GetLevel (),
                               2 * skill->GetLevel (), 8 * skill->GetLevel (), 5 * skill->GetLevel (), 2 * skill->GetLevel (), 20);
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () ==
                                                  1 ? int (skill->GetPlayer ()->GetVar2 () * 0.002) + skill->GetT2 () : 0));
        ...
        bool BlessMe (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () ==
                                                  1 ? 20 + 3 * skill->GetT0 () + skill->GetT1 () + skill->GetT2 () + skill->GetT3 () +
                                                  skill->GetPlayer ()->GetSkilllevel (3584) / 2 +
                                                  norm (skill->GetPlayer ()->GetSkilllevel (3584) / 19.99) * 5 +
                                                  skill->GetPlayer ()->GetSkilllevel (3810) : 0));
