#ifndef __CPPGEN_GNET_SKILL4963
#define __CPPGEN_GNET_SKILL4963
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4963:public Skill
    {
      public:
        enum
        { SKILL_ID = 4963 };
          Skill4963 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4963Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
