#ifndef __CPPGEN_GNET_SKILL1690
#define __CPPGEN_GNET_SKILL1690
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1690:public Skill
    {
      public:
        enum
        { SKILL_ID = 1690 };
          Skill1690 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1690Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1690Stub ():SkillStub (1690)
        {
            occupation = 146;
            name = L"°Ë»ÄÕæ»ð£º°µ";
            nativename = "°Ë»ÄÕæ»ð£º°µ";
            icon = "°Ë»ÄÕæ»ð¾÷.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
