#ifndef __CPPGEN_GNET_SKILL2176
#define __CPPGEN_GNET_SKILL2176
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2176:public Skill
    {
      public:
        enum
        { SKILL_ID = 2176 };
          Skill2176 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2176Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2176Stub ():SkillStub (2176)
        {
            occupation = 129;
            name = L"²âÊÔÕÕÑý¾µ";
            nativename = "²âÊÔÕÕÑý¾µ";
            icon = "Ð°½£ÐÇÓð.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
