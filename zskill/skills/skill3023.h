#ifndef __CPPGEN_GNET_SKILL3023
#define __CPPGEN_GNET_SKILL3023
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3023:public Skill
    {
      public:
        enum
        { SKILL_ID = 3023 };
          Skill3023 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3023Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               13,
                               100 * skill->GetLevel (),
                               33, 120 * skill->GetLevel (), 10 + 3 * skill->GetLevel (), skill->GetLevel (), 10 + skill->GetLevel ());
