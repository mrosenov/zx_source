#ifndef __CPPGEN_GNET_SKILL5070
#define __CPPGEN_GNET_SKILL5070
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5070:public Skill
    {
      public:
        enum
        { SKILL_ID = 5070 };
          Skill5070 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5070Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
