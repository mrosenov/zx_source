#ifndef __CPPGEN_GNET_SKILL3141
#define __CPPGEN_GNET_SKILL3141
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3141:public Skill
    {
      public:
        enum
        { SKILL_ID = 3141 };
          Skill3141 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3141Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               2 * skill->GetLevel (), 3, 600 + 10 * skill->GetLevel (), 2 * skill->GetLevel (), 5 + 0.3 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (5050 + 300 * skill->GetLevel () + norm (skill->GetLevel () / 19.9) * 2000);
            skill->GetVictim ()->SetRatio (3);
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetAmount (1);
            skill->GetVictim ()->SetValue (34670);
            skill->GetVictim ()->SetSummonclone (1);
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetVar2 () > 0 ? 2419 + INT (zrand (100 + 2 * skill->GetLevel ()) / 100) * 27 : 2419);
            skill->GetVictim ()->SetAmount (2419);
            skill->GetVictim ()->SetValue (2419);
