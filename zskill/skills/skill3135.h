#ifndef __CPPGEN_GNET_SKILL3135
#define __CPPGEN_GNET_SKILL3135
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3135:public Skill
    {
      public:
        enum
        { SKILL_ID = 3135 };
          Skill3135 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3135Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               180,
                               10 + 2 * skill->GetLevel (),
                               5 + skill->GetLevel (), 5 + skill->GetLevel (), 2 + skill->GetLevel (), 5 * skill->GetLevel (), skill->GetLevel ());
