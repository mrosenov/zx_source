#ifndef __CPPGEN_GNET_SKILL2488
#define __CPPGEN_GNET_SKILL2488
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2488:public Skill
    {
      public:
        enum
        { SKILL_ID = 2488 };
          Skill2488 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2488Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2488Stub ():SkillStub (2488)
        {
            ...
            action[10] = "0";
            action[11] = "0";
            action[12] = "天华_领域_苏武牧羊";
            action[13] = "";
            action[14] = "";
            action[15] = "天华_领域_苏武牧羊";
            action[16] = "0";
            action[17] = "0";
            action[18] = "0";
            action[19] = "0";
        ...
        {
            return _snwprintf (buffer, length, format, 5 * skill->GetLevel (), INT (skill->GetLevel () / 3) + 3);
