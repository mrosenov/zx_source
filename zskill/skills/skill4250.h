#ifndef __CPPGEN_GNET_SKILL4250
#define __CPPGEN_GNET_SKILL4250
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4250:public Skill
    {
      public:
        enum
        { SKILL_ID = 4250 };
          Skill4250 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4250Stub:public SkillStub
    {
      public:
        Skill4250Stub ():SkillStub (4250)
        {
            occupation = 130;
            name = L"子午心魂1";
            nativename = "子午心魂1";
