#ifndef __CPPGEN_GNET_SKILL3021
#define __CPPGEN_GNET_SKILL3021
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3021:public Skill
    {
      public:
        enum
        { SKILL_ID = 3021 };
          Skill3021 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3021Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State5:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetRes4 ());
                skill->SetRatio (1.1 + zrand (40 + 4 * skill->GetLevel ()) * norm (zrand (100 + skill->GetLevel ()) / 100.0) * 0.02 +
                                 0.05 * skill->GetLevel () + norm (skill->GetLevel () / 14.9) * 0.03 * (skill->GetLevel () - 15) +
                                 0.04 * skill->GetT3 ());
                skill->SetPlus ((9.9 * skill->GetLevel () * skill->GetLevel () - 8.6 * skill->GetLevel () + 858) * (1 + 0.07 * skill->GetT2 ()));
                skill->GetPlayer ()->SetPerform (0);
            }
...
#endif
      Skill3021Stub ():SkillStub (3021)
        {
            occupation = 167;
            name = L"Ä§»êÌìÖä<Ğş>";
            nativename = "Ä§»êÌìÖä<Ğş>";
            icon = "ÏÉ¡¤Ä§»êÌìÖä.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               3 * skill->GetLevel (), 160 + 40 * skill->GetLevel (), skill->GetLevel (), 80 + 8 * skill->GetLevel ());
