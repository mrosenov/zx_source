#ifndef __CPPGEN_GNET_SKILL3080
#define __CPPGEN_GNET_SKILL3080
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3080:public Skill
    {
      public:
        enum
        { SKILL_ID = 3080 };
          Skill3080 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3080Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3080Stub ():SkillStub (3080)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               120, 2, skill->GetLevel (), 4, 60 + 2 * skill->GetLevel (), 12, 33, 25, 25, 5, 0.5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (650));
            skill->GetVictim ()->SetTime (skill->GetPlayer ()->GetHp () < 0.6 * skill->GetPlayer ()->GetMaxhp ()? 500 * skill->GetLevel () : 0);
