#ifndef __CPPGEN_GNET_SKILL3031
#define __CPPGEN_GNET_SKILL3031
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3031:public Skill
    {
      public:
        enum
        { SKILL_ID = 3031 };
          Skill3031 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3031Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               25,
                               75,
                               12, INT (60 * skill->GetLevel () + 5 * skill->GetLevel () * skill->GetLevel () + 55), 33, 4, 5 * skill->GetLevel ());
