#ifndef __CPPGEN_GNET_SKILL5081
#define __CPPGEN_GNET_SKILL5081
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5081:public Skill
    {
      public:
        enum
        { SKILL_ID = 5081 };
          Skill5081 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5081Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
