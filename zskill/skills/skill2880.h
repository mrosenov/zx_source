#ifndef __CPPGEN_GNET_SKILL2880
#define __CPPGEN_GNET_SKILL2880
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2880:public Skill
    {
      public:
        enum
        { SKILL_ID = 2880 };
          Skill2880 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2880Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
