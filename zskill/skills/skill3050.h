#ifndef __CPPGEN_GNET_SKILL3050
#define __CPPGEN_GNET_SKILL3050
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3050:public Skill
    {
      public:
        enum
        { SKILL_ID = 3050 };
          Skill3050 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3050Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               20 + 2 * skill->GetLevel (),
                               30 + 3 * skill->GetLevel (),
                               20 + 3 * skill->GetLevel (), 5 * skill->GetLevel (), 0.1 * skill->GetLevel (), 20 + 2 * skill->GetLevel ());
