#ifndef __CPPGEN_GNET_SKILL468
#define __CPPGEN_GNET_SKILL468
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill468:public Skill
    {
      public:
        enum
        { SKILL_ID = 468 };
          Skill468 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill468Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill468Stub ():SkillStub (468)
        {
            occupation = 128;
            name = L"²âÊÔÖĞ¼¼ÄÜ1";
            nativename = "²âÊÔÖĞ¼¼ÄÜ1";
            icon = "·èÄ§Õ¶.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 1;
