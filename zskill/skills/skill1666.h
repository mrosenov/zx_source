#ifndef __CPPGEN_GNET_SKILL1666
#define __CPPGEN_GNET_SKILL1666
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1666:public Skill
    {
      public:
        enum
        { SKILL_ID = 1666 };
          Skill1666 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1666Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
