#ifndef __CPPGEN_GNET_SKILL1060
#define __CPPGEN_GNET_SKILL1060
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1060:public Skill
    {
      public:
        enum
        { SKILL_ID = 1060 };
          Skill1060 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1060Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1060Stub ():SkillStub (1060)
        {
            occupation = 128;
            name = L"Boss金铃夫人B";
            nativename = "Boss金铃夫人B";
            icon = "";
            maxlevel = 500;
            maxlearn = 10;
            type = 2;
