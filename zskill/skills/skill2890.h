#ifndef __CPPGEN_GNET_SKILL2890
#define __CPPGEN_GNET_SKILL2890
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2890:public Skill
    {
      public:
        enum
        { SKILL_ID = 2890 };
          Skill2890 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2890Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
