#ifndef __CPPGEN_GNET_SKILL4645
#define __CPPGEN_GNET_SKILL4645
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4645:public Skill
    {
      public:
        enum
        { SKILL_ID = 4645 };
          Skill4645 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4645Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
