#ifndef __CPPGEN_GNET_SKILL5022
#define __CPPGEN_GNET_SKILL5022
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5022:public Skill
    {
      public:
        enum
        { SKILL_ID = 5022 };
          Skill5022 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5022Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5022Stub ():SkillStub (5022)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (16000);
            skill->GetVictim ()->SetRatio (0.01 * (2 + skill->GetPlayer ()->GetVar1 () / 1000));
            skill->GetVictim ()->SetBuffid (5);
            skill->GetVictim ()->SetAmount (1);
            skill->GetVictim ()->SetValue (5121);
