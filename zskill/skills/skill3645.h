    ...
    class Skill3645Stub:public SkillStub
    {
      public:
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime ((skill->GetLevel () - int (skill->GetLevel () / 100) * 100) *1000);
            skill->GetVictim ()->SetRatio (12);
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetAmount (int (skill->GetLevel () / 100) == 3 ? 50637 : (int (skill->GetLevel () / 100) == 2 ? 50636 : 45508));
