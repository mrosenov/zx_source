#ifndef __CPPGEN_GNET_SKILL5066
#define __CPPGEN_GNET_SKILL5066
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5066:public Skill
    {
      public:
        enum
        { SKILL_ID = 5066 };
          Skill5066 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5066Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5066Stub ():SkillStub (5066)
        ...
        {
            return _snwprintf (buffer, length, format, 1000, 30, 60 + 5 * 4, 60);
