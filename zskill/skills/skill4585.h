#ifndef __CPPGEN_GNET_SKILL4585
#define __CPPGEN_GNET_SKILL4585
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4585:public Skill
    {
      public:
        enum
        { SKILL_ID = 4585 };
          Skill4585 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4585Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1237600 };
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (54859);
