#ifndef __CPPGEN_GNET_SKILL1414
#define __CPPGEN_GNET_SKILL1414
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1414:public Skill
    {
      public:
        enum
        { SKILL_ID = 1414 };
          Skill1414 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1414Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1414Stub ():SkillStub (1414)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 6 * skill->GetLevel (), 50, 6, 8, 15, 30, 15, 200);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (9);
            skill->GetVictim ()->SetAmount (2 * skill->GetLevel () * (1 + 2 * norm (skill->GetLevel () / 90)));
