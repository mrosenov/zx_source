#ifndef __CPPGEN_GNET_SKILL4255
#define __CPPGEN_GNET_SKILL4255
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4255:public Skill
    {
      public:
        enum
        { SKILL_ID = 4255 };
          Skill4255 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4255Stub:public SkillStub
    {
      public:
        Skill4255Stub ():SkillStub (4255)
        {
            occupation = 130;
            name = L"³¾¹âÌ¾Ãî3";
            nativename = "³¾¹âÌ¾Ãî3";
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (5000 + 2000 * skill->GetLevel () + 100);
