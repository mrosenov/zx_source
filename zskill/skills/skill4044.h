#ifndef __CPPGEN_GNET_SKILL4044
#define __CPPGEN_GNET_SKILL4044
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4044:public Skill
    {
      public:
        enum
        { SKILL_ID = 4044 };
          Skill4044 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4044Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4044Stub ():SkillStub (4044)
        {
            occupation = 130;
            name = L"Õæ¡¤°ËØÔÉñÕÆ";
            nativename = "Õæ¡¤°ËØÔÉñÕÆ";
            icon = "·ÉÉı°ËØÔÉñÕÆ.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
