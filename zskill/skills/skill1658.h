#ifndef __CPPGEN_GNET_SKILL1658
#define __CPPGEN_GNET_SKILL1658
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1658:public Skill
    {
      public:
        enum
        { SKILL_ID = 1658 };
          Skill1658 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1658Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
