#ifndef __CPPGEN_GNET_SKILL1662
#define __CPPGEN_GNET_SKILL1662
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1662:public Skill
    {
      public:
        enum
        { SKILL_ID = 1662 };
          Skill1662 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1662Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
