#ifndef __CPPGEN_GNET_SKILL4518
#define __CPPGEN_GNET_SKILL4518
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4518:public Skill
    {
      public:
        enum
        { SKILL_ID = 4518 };
          Skill4518 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4518Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4518Stub ():SkillStub (4518)
        {
            occupation = 130;
            name = L"³Ð¡¤»ªÕÃÐÇÔÉ";
            nativename = "³Ð¡¤»ªÕÃÐÇÔÉ";
            icon = "»ªÕÃÐÇÔÉ.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
