#ifndef __CPPGEN_GNET_SKILL3594
#define __CPPGEN_GNET_SKILL3594
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3594:public Skill
    {
      public:
        enum
        { SKILL_ID = 3594 };
          Skill3594 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3594Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        {
            return (float) (500 + 10 * skill->GetLevel () + 4 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        {
            return 120000 - 10000 * skill->GetT0 ();
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               500 + 10 * skill->GetLevel () + 4 * skill->GetLevel () * skill->GetLevel (),
                               ...
                               4 * skill->GetLevel (),
                               5 + skill->GetLevel (),
                               1 + INT (skill->GetLevel () / 10), skill->GetLevel () + 10, skill->GetLevel (), 3 + INT (skill->GetLevel () / 2));
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (10000 + 1000 * skill->GetLevel () + 3000 * skill->GetT0 ());
            ...
            skill->GetVictim ()->SetValue (0.04 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (2);
            skill->GetVictim ()->SetAmount (skill->GetLevel ());
            skill->GetVictim ()->SetValue (3640);
            skill->GetVictim ()->SetActiveonfilteradd (1);
            skill->GetVictim ()->SetProbability (1.0 * (1));
            skill->GetVictim ()->SetTime (10000 + 1000 * skill->GetLevel () + 3000 * skill->GetT0 ());
            skill->GetVictim ()->SetRatio (4097);
            skill->GetVictim ()->SetBuffid (3);
            skill->GetVictim ()->SetAmount (skill->GetLevel ());
            skill->GetVictim ()->SetValue (3641);
            skill->GetVictim ()->SetActiveonfilteradd (1);
            skill->GetVictim ()->SetProbability (1.0 * (120));
            skill->GetVictim ()->SetTime (10000 + 1000 * skill->GetLevel () + 3000 * skill->GetT0 ());
            skill->GetVictim ()->SetRatio (skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (3642);
