#ifndef __CPPGEN_GNET_SKILL5267
#define __CPPGEN_GNET_SKILL5267
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5267:public Skill
    {
      public:
        enum
        { SKILL_ID = 5267 };
          Skill5267 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5267Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
