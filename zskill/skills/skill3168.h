#ifndef __CPPGEN_GNET_SKILL3168
#define __CPPGEN_GNET_SKILL3168
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3168:public Skill
    {
      public:
        enum
        { SKILL_ID = 3168 };
          Skill3168 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3168Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
