#ifndef __CPPGEN_GNET_SKILL2990
#define __CPPGEN_GNET_SKILL2990
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2990:public Skill
    {
      public:
        enum
        { SKILL_ID = 2990 };
          Skill2990 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2990Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2990Stub ():SkillStub (2990)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetTmplid () == 41110 ? 100 : 0));
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMaxhp () * 0.51);
