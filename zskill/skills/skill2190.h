#ifndef __CPPGEN_GNET_SKILL2190
#define __CPPGEN_GNET_SKILL2190
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2190:public Skill
    {
      public:
        enum
        { SKILL_ID = 2190 };
          Skill2190 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2190Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
