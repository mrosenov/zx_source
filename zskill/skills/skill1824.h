#ifndef __CPPGEN_GNET_SKILL1824
#define __CPPGEN_GNET_SKILL1824
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1824:public Skill
    {
      public:
        enum
        { SKILL_ID = 1824 };
          Skill1824 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1824Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
