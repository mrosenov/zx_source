#ifndef __CPPGEN_GNET_SKILL3790
#define __CPPGEN_GNET_SKILL3790
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3790:public Skill
    {
      public:
        enum
        { SKILL_ID = 3790 };
          Skill3790 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3790Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
