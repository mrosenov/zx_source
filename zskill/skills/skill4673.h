#ifndef __CPPGEN_GNET_SKILL4673
#define __CPPGEN_GNET_SKILL4673
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4673:public Skill
    {
      public:
        enum
        { SKILL_ID = 4673 };
          Skill4673 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4673Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (2000);
                skill->SetPlus2 (skill->GetPlayer ()->GetMaxmp () * 0.03 * skill->GetLevel ());
                skill->SetCrithurt (0.25 * skill->GetT1 ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4673Stub ():SkillStub (4673)
        {
            occupation = 169;
            name = L"界・天演式・六道<禅>";
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetVar1 () + 5 * skill->GetLevel () + 10 * 4));
