#ifndef __CPPGEN_GNET_SKILL3785
#define __CPPGEN_GNET_SKILL3785
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3785:public Skill
    {
      public:
        enum
        { SKILL_ID = 3785 };
          Skill3785 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3785Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3785Stub ():SkillStub (3785)
        {
            occupation = 146;
            name = L"°Ë»ÄÕæ»ð£º·Ù";
            nativename = "°Ë»ÄÕæ»ð£º·Ù";
            icon = "°Ë»ÄÕæ»ð¾÷.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
