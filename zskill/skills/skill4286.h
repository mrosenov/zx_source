#ifndef __CPPGEN_GNET_SKILL4286
#define __CPPGEN_GNET_SKILL4286
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4286:public Skill
    {
      public:
        enum
        { SKILL_ID = 4286 };
          Skill4286 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4286Stub:public SkillStub
    {
      public:
        Skill4286Stub ():SkillStub (4286)
        {
            occupation = 130;
            name = L"ÌìÄ§½µ·ü3";
            nativename = "ÌìÄ§½µ·ü3";
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               5 + 0.1 * skill->GetLevel () * skill->GetLevel () * skill->GetLevel (),
                                                 ...
                                                 (skill->GetPlayer ()->GetVar11 () ==
                                                  55 ? (10 +
                                                        ...
                                                        50 ? 50 : (skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () +
                                                                   skill->GetPlayer ()->GetRes3 () + skill->GetPlayer ()->GetRes4 () +
                                                                   skill->GetPlayer ()->GetRes5 ()) / 240) : (7 + (skill->GetPlayer ()->GetRes1 () +
                                                                                                              ...
                                                                                                              8 ? 8 : (skill->GetPlayer ()->
                                                                                                                       ...
                                                                                                                       skill->GetPlayer ()->
                                                                                                                       GetRes5 ()) / 1000)));
            skill->GetVictim ()->SetTime (5000 + skill->GetLevel () * skill->GetLevel () * skill->GetLevel () * 100);
