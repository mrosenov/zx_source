#ifndef __CPPGEN_GNET_SKILL4091
#define __CPPGEN_GNET_SKILL4091
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4091:public Skill
    {
      public:
        enum
        { SKILL_ID = 4091 };
          Skill4091 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4091Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4091Stub ():SkillStub (4091)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               10, skill->GetLevel () + skill->GetLevel () * skill->GetLevel (), 9 - skill->GetLevel (), 25, 200, 12, 125, 25, 300);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (300 + 3 * skill->GetPlayer ()->GetLevel ());
