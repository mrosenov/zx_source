...
namespace GNET
{
    ...
    class Skill1319Stub:public SkillStub
    {
      ...
      Skill1319Stub ():SkillStub (1319)
        ...
        {
            return _snwprintf (buffer, length, format, 17 + 3 * skill->GetLevel (), skill->GetLevel (), skill->GetLevel (), 300, 6, 100, 100);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (300000);
            skill->GetVictim ()->SetBuffid (7);
            skill->GetVictim ()->SetValue (skill->GetLevel () * (1 + norm (skill->GetLevel () / 60)));
