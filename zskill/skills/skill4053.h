#ifndef __CPPGEN_GNET_SKILL4053
#define __CPPGEN_GNET_SKILL4053
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4053:public Skill
    {
      public:
        enum
        { SKILL_ID = 4053 };
          Skill4053 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4053Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4053Stub ():SkillStub (4053)
        {
            occupation = 130;
            name = L"Õæ¡¤ÔÂÓ°µ¤Öì";
            nativename = "Õæ¡¤ÔÂÓ°µ¤Öì";
            icon = "·ÉÉýÔÂÓ°µ¤Öì.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
