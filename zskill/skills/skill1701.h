#ifndef __CPPGEN_GNET_SKILL1701
#define __CPPGEN_GNET_SKILL1701
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1701:public Skill
    {
      public:
        enum
        { SKILL_ID = 1701 };
          Skill1701 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1701Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
