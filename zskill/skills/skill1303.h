#ifndef __CPPGEN_GNET_SKILL1303
#define __CPPGEN_GNET_SKILL1303
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1303:public Skill
    {
      public:
        enum
        { SKILL_ID = 1303 };
          Skill1303 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1303Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
