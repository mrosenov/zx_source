#ifndef __CPPGEN_GNET_SKILL1635
#define __CPPGEN_GNET_SKILL1635
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1635:public Skill
    {
      public:
        enum
        { SKILL_ID = 1635 };
          Skill1635 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1635Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1635Stub ():SkillStub (1635)
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetValue (1 + zrand (999));
