#ifndef __CPPGEN_GNET_SKILL3780
#define __CPPGEN_GNET_SKILL3780
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3780:public Skill
    {
      public:
        enum
        { SKILL_ID = 3780 };
          Skill3780 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3780Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
