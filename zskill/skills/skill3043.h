#ifndef __CPPGEN_GNET_SKILL3043
#define __CPPGEN_GNET_SKILL3043
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3043:public Skill
    {
      public:
        enum
        { SKILL_ID = 3043 };
          Skill3043 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3043Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               834, 20 + 4 * skill->GetLevel (), 50 + 10 * skill->GetLevel (), 2 + skill->GetLevel (), 20 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetCycdecattack (1);
            return true;
        }
#endif
    };
