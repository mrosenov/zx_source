#ifndef __CPPGEN_GNET_SKILL2823
#define __CPPGEN_GNET_SKILL2823
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2823:public Skill
    {
      public:
        enum
        { SKILL_ID = 2823 };
          Skill2823 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2823Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
