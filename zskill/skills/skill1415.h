#ifndef __CPPGEN_GNET_SKILL1415
#define __CPPGEN_GNET_SKILL1415
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1415:public Skill
    {
      public:
        enum
        { SKILL_ID = 1415 };
          Skill1415 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1415Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1415Stub ():SkillStub (1415)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 6 * skill->GetLevel (), 50, 6, 8, 15, 30, 15, 4);
