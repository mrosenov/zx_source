#ifndef __CPPGEN_GNET_SKILL4185
#define __CPPGEN_GNET_SKILL4185
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4185:public Skill
    {
      public:
        enum
        { SKILL_ID = 4185 };
          Skill4185 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4185Stub:public SkillStub
    {
      public:
        Skill4185Stub ():SkillStub (4185)
        {
            occupation = 130;
            name = L"月影丹朱2";
            nativename = "月影丹朱2";
