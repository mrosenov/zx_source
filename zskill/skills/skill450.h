#ifndef __CPPGEN_GNET_SKILL450
#define __CPPGEN_GNET_SKILL450
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill450:public Skill
    {
      public:
        enum
        { SKILL_ID = 450 };
          Skill450 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill450Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
