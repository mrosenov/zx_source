#ifndef __CPPGEN_GNET_SKILL4054
#define __CPPGEN_GNET_SKILL4054
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4054:public Skill
    {
      public:
        enum
        { SKILL_ID = 4054 };
          Skill4054 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4054Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4054Stub ():SkillStub (4054)
        {
            occupation = 130;
            name = L"Õæ¡¤ÑªÉ±Ç§Àï";
            nativename = "Õæ¡¤ÑªÉ±Ç§Àï";
            icon = "·ÉÉýÑªÉ±Ç§Àï.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
