#ifndef __CPPGEN_GNET_SKILL2893
#define __CPPGEN_GNET_SKILL2893
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2893:public Skill
    {
      public:
        enum
        { SKILL_ID = 2893 };
          Skill2893 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2893Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
