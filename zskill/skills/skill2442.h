      ...
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1 + 0.08 + 0.02 * skill->GetLevel ());
                skill->SetCrit (0.01 * skill->GetT1 ());
                skill->SetPlus (260 + 30 * skill->GetLevel () +
                                (skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () + skill->GetPlayer ()->GetRes3 () +
                                 skill->GetPlayer ()->GetRes4 () + skill->GetPlayer ()->GetRes5 ()) * 0.05 * (skill->GetLevel () + skill->GetT0 ()));
      ...
      Skill2442Stub ():SkillStub (2442)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               8 + 2 * skill->GetLevel (), 260 + 30 * skill->GetLevel (), 5 * skill->GetLevel (), 5 * skill->GetLevel ());
