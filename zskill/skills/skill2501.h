#ifndef __CPPGEN_GNET_SKILL2501
#define __CPPGEN_GNET_SKILL2501
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2501:public Skill
    {
      public:
        enum
        { SKILL_ID = 2501 };
          Skill2501 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2501Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2501Stub ():SkillStub (2501)
        ...
        {
            static int array[5] = { 136, 138, 139, 140, 141 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               5000 + 1000 * skill->GetLevel (), 30 + 5 * skill->GetLevel (), 14 + 6 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (30 + 5 * skill->GetLevel () + 5 * skill->GetT0 ()));
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (14 + 6 * skill->GetLevel () + skill->GetT2 ()));
