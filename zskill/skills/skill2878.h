#ifndef __CPPGEN_GNET_SKILL2878
#define __CPPGEN_GNET_SKILL2878
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2878:public Skill
    {
      public:
        enum
        { SKILL_ID = 2878 };
          Skill2878 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2878Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
