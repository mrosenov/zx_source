#ifndef __CPPGEN_GNET_SKILL3776
#define __CPPGEN_GNET_SKILL3776
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3776:public Skill
    {
      public:
        enum
        { SKILL_ID = 3776 };
          Skill3776 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3776Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3776Stub ():SkillStub (3776)
        ...
        {
            skill->GetVictim ()->SetRatio (3443);
            skill->GetVictim ()->SetAmount (3447);
            skill->GetVictim ()->SetValue (3441);
