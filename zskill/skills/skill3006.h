#ifndef __CPPGEN_GNET_SKILL3006
#define __CPPGEN_GNET_SKILL3006
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3006:public Skill
    {
      public:
        enum
        { SKILL_ID = 3006 };
          Skill3006 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3006Stub:public SkillStub
    {
      public:
        Skill3006Stub ():SkillStub (3006)
        {
            occupation = 167;
            name = L"ÖïÄ§";
            nativename = "ÖïÄ§";
