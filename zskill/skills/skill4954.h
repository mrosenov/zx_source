...
namespace GNET
{
    ...
    class Skill4954Stub:public SkillStub
    {
      public:
        ...
        {
            return _snwprintf (buffer, length, format, 20 + 8 * skill->GetLevel (), 15, 280 + 50 * skill->GetLevel (), 5 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (280 + 50 * skill->GetLevel ());
