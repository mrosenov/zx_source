#ifndef __CPPGEN_GNET_SKILL2243
#define __CPPGEN_GNET_SKILL2243
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2243:public Skill
    {
      public:
        enum
        { SKILL_ID = 2243 };
          Skill2243 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2243Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2243Stub ():SkillStub (2243)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               2 * skill->GetLevel (),
                               8 * skill->GetLevel (),
                               0.5 * skill->GetLevel (), 5 * skill->GetLevel (), 2 * skill->GetLevel (), 50 + 5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar2 () * 0.05 * skill->GetLevel () * skill->GetLevel ());
