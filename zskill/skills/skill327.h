#ifndef __CPPGEN_GNET_SKILL327
#define __CPPGEN_GNET_SKILL327
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill327:public Skill
    {
      public:
        enum
        { SKILL_ID = 327 };
          Skill327 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill327Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
