#ifndef __CPPGEN_GNET_SKILL4369
#define __CPPGEN_GNET_SKILL4369
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4369:public Skill
    {
      public:
        enum
        { SKILL_ID = 4369 };
          Skill4369 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4369Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
