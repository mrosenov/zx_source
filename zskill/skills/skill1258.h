#ifndef __CPPGEN_GNET_SKILL1258
#define __CPPGEN_GNET_SKILL1258
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1258:public Skill
    {
      public:
        enum
        { SKILL_ID = 1258 };
          Skill1258 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1258Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1258Stub ():SkillStub (1258)
        ...
        {
            return _snwprintf (buffer, length, format, 25 * skill->GetLevel (), 5 * skill->GetLevel ());
