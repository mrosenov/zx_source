#ifndef __CPPGEN_GNET_SKILL1425
#define __CPPGEN_GNET_SKILL1425
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1425:public Skill
    {
      public:
        enum
        { SKILL_ID = 1425 };
          Skill1425 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1425Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1425Stub ():SkillStub (1425)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (8 * norm (skill->GetLevel () / 90)));
