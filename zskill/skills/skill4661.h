#ifndef __CPPGEN_GNET_SKILL4661
#define __CPPGEN_GNET_SKILL4661
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4661:public Skill
    {
      public:
        enum
        { SKILL_ID = 4661 };
          Skill4661 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4661Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4661Stub ():SkillStub (4661)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.005 * skill->GetLevel () * 3);
