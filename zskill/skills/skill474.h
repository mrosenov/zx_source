#ifndef __CPPGEN_GNET_SKILL474
#define __CPPGEN_GNET_SKILL474
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill474:public Skill
    {
      public:
        enum
        { SKILL_ID = 474 };
          Skill474 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill474Stub:public SkillStub
    {
      public:
        Skill474Stub ():SkillStub (474)
        {
            occupation = 129;
            name = L"三碗不过岗";
            nativename = "三碗不过岗";
