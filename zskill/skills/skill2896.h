#ifndef __CPPGEN_GNET_SKILL2896
#define __CPPGEN_GNET_SKILL2896
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2896:public Skill
    {
      public:
        enum
        { SKILL_ID = 2896 };
          Skill2896 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2896Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
