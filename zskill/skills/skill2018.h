#ifndef __CPPGEN_GNET_SKILL2018
#define __CPPGEN_GNET_SKILL2018
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2018:public Skill
    {
      public:
        enum
        { SKILL_ID = 2018 };
          Skill2018 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2018Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2018Stub ():SkillStub (2018)
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (60000 + 40000 * skill->GetLevel ());
