#ifndef __CPPGEN_GNET_SKILL1713
#define __CPPGEN_GNET_SKILL1713
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1713:public Skill
    {
      public:
        enum
        { SKILL_ID = 1713 };
          Skill1713 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1713Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
