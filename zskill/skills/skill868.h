#ifndef __CPPGEN_GNET_SKILL868
#define __CPPGEN_GNET_SKILL868
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill868:public Skill
    {
      public:
        enum
        { SKILL_ID = 868 };
          Skill868 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill868Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
