#ifndef __CPPGEN_GNET_SKILL1196
#define __CPPGEN_GNET_SKILL1196
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1196:public Skill
    {
      public:
        enum
        { SKILL_ID = 1196 };
          Skill1196 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1196Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
