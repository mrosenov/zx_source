#ifndef __CPPGEN_GNET_SKILL4664
#define __CPPGEN_GNET_SKILL4664
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4664:public Skill
    {
      public:
        enum
        { SKILL_ID = 4664 };
          Skill4664 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4664Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4664Stub ():SkillStub (4664)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.005 * skill->GetLevel () * 6);
