#ifndef __CPPGEN_GNET_SKILL3081
#define __CPPGEN_GNET_SKILL3081
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3081:public Skill
    {
      public:
        enum
        { SKILL_ID = 3081 };
          Skill3081 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3081Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3081Stub ():SkillStub (3081)
        {
            occupation = 168;
            name = L"Ãð»ê¿ñì­<É·>";
            nativename = "Ãð»ê¿ñì­<É·>";
            icon = "Ä§¡¤Ãð»ê¿ñì­.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
