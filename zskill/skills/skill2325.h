#ifndef __CPPGEN_GNET_SKILL2325
#define __CPPGEN_GNET_SKILL2325
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2325:public Skill
    {
      public:
        enum
        { SKILL_ID = 2325 };
          Skill2325 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2325Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
