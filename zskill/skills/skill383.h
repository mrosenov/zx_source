#ifndef __CPPGEN_GNET_SKILL383
#define __CPPGEN_GNET_SKILL383
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill383:public Skill
    {
      public:
        enum
        { SKILL_ID = 383 };
          Skill383 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill383Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill383Stub ():SkillStub (383)
        {
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "天音寺_骑乘_四大皆空风";
            action[16] = "天音寺_骑乘_四大皆空风";
            action[17] = "天音寺_骑乘_四大皆空风";
            action[18] = "天音寺_骑乘_四大皆空风";
            action[19] = "天音寺_骑乘_四大皆空风";
            action[20] = "天音寺_骑乘_四大皆空风";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
        ...
        {
            return (float) (180 + 111 * skill->GetLevel () - 2.21 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        {
            static int array[8] = { 65, 68, 71, 74, 77, 79, 81, 84 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               INT (180 + 111 * skill->GetLevel () - 2.21 * skill->GetLevel () * skill->GetLevel ()), 30, 8 * skill->GetLevel () + 8);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((180 + 111 * skill->GetLevel () - 2.21 * skill->GetLevel () * skill->GetLevel ()) * 0.3 * skill->GetT0 ());
