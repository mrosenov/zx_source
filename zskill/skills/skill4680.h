#ifndef __CPPGEN_GNET_SKILL4680
#define __CPPGEN_GNET_SKILL4680
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4680:public Skill
    {
      public:
        enum
        { SKILL_ID = 4680 };
          Skill4680 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4680Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
