#ifndef __CPPGEN_GNET_SKILL2800
#define __CPPGEN_GNET_SKILL2800
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2800:public Skill
    {
      public:
        enum
        { SKILL_ID = 2800 };
          Skill2800 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2800Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
