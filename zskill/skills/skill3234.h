#ifndef __CPPGEN_GNET_SKILL3234
#define __CPPGEN_GNET_SKILL3234
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3234:public Skill
    {
      public:
        enum
        { SKILL_ID = 3234 };
          Skill3234 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3234Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
