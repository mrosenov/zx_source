#ifndef __CPPGEN_GNET_SKILL5037
#define __CPPGEN_GNET_SKILL5037
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5037:public Skill
    {
      public:
        enum
        { SKILL_ID = 5037 };
          Skill5037 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5037Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5037Stub ():SkillStub (5037)
        ...
        {
            skill->GetVictim ()->SetTime (skill->GetPlayer ()->GetHasbuff (4111) == 1 ? 3000 : 0);
