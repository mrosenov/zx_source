...
namespace GNET
{
    ...
    class Skill3253Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetVar1 (zrand (4));
      ...
      Skill3253Stub ():SkillStub (3253)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetVar1 () == 0 ? (skill->GetPlayer ()->GetRes4 () + 100) : 0));
            ...
            skill->GetVictim ()->SetAmount (1 + zrand (3));
