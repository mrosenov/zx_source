...
namespace GNET
{
    ...
    class Skill5086Stub:public SkillStub
    {
      ...
      Skill5086Stub ():SkillStub (5086)
        ...
        {
            return _snwprintf (buffer, length, format, 80);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (3000 + 1000 * 2);
            skill->GetVictim ()->SetRatio (0.1 * 8);
            skill->GetVictim ()->SetNingjin (1);
            skill->GetVictim ()->SetTime (2 > 0 ? (1000 * 2) : 0);
            skill->GetVictim ()->SetMakecrit (1);
            skill->GetVictim ()->SetProbability (1.0 * (2 > 0 ? 10 * 2 : 0));
            skill->GetVictim ()->SetTime (10000);
            skill->GetVictim ()->SetRatio (0);
            skill->GetVictim ()->SetAmount (5);
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetShadowhide (1);
            skill->GetVictim ()->SetProbability (1.0 * (120 * norm (2)));
            skill->GetVictim ()->SetTime (2500 * skill->GetT2 ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (0.4 * 2);
