#ifndef __CPPGEN_GNET_SKILL1311
#define __CPPGEN_GNET_SKILL1311
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1311:public Skill
    {
      public:
        enum
        { SKILL_ID = 1311 };
          Skill1311 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1311Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
