#ifndef __CPPGEN_GNET_SKILL3044
#define __CPPGEN_GNET_SKILL3044
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3044:public Skill
    {
      public:
        enum
        { SKILL_ID = 3044 };
          Skill3044 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3044Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3044Stub ():SkillStub (3044)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               10 + 4 * skill->GetLevel (), 180, skill->GetLevel (), 1.5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (10000 + 4000 * skill->GetLevel () + 2000 * skill->GetT0 ());
            skill->GetVictim ()->SetRatio (1);
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetAmount (2 + norm (zrand (100 + 2 * skill->GetLevel ()) / 100));
