#ifndef __CPPGEN_GNET_SKILL3034
#define __CPPGEN_GNET_SKILL3034
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3034:public Skill
    {
      public:
        enum
        { SKILL_ID = 3034 };
          Skill3034 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3034Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               12,
                               10 + skill->GetLevel (),
                               10 + skill->GetLevel (), 10 + skill->GetLevel (), 10 + skill->GetLevel (), skill->GetLevel ());
