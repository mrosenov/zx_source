#ifndef __CPPGEN_GNET_SKILL4836
#define __CPPGEN_GNET_SKILL4836
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4836:public Skill
    {
      public:
        enum
        { SKILL_ID = 4836 };
          Skill4836 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4836Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
