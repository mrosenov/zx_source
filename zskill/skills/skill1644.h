#ifndef __CPPGEN_GNET_SKILL1644
#define __CPPGEN_GNET_SKILL1644
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1644:public Skill
    {
      public:
        enum
        { SKILL_ID = 1644 };
          Skill1644 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1644Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
