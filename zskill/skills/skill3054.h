#ifndef __CPPGEN_GNET_SKILL3054
#define __CPPGEN_GNET_SKILL3054
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3054:public Skill
    {
      public:
        enum
        { SKILL_ID = 3054 };
          Skill3054 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3054Stub:public SkillStub
    {
      public:
        Skill3054Stub ():SkillStub (3054)
        {
            occupation = 168;
            name = L"ÃðÄ§";
            nativename = "ÃðÄ§";
