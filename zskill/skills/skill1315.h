    ...
    class Skill1315Stub:public SkillStub
    {
      ...
      Skill1315Stub ():SkillStub (1315)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (1314);
            skill->GetVictim ()->SetAmount (1316);
            skill->GetVictim ()->SetValue (1317);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMp ());
