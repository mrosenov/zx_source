#ifndef __CPPGEN_GNET_SKILL842
#define __CPPGEN_GNET_SKILL842
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill842:public Skill
    {
      public:
        enum
        { SKILL_ID = 842 };
          Skill842 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill842Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
