      ...
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetSkilldodge () / 10);
      ...
      Skill5029Stub ():SkillStub (5029)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (1000 *
                                          (4 +
                                           int (skill->GetPlayer ()->GetVar1 () /
                                                (40.001 -
                                                 5 * (norm (skill->GetLevel () / 30) + norm (skill->GetLevel () / 60) +
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetRes4 () + 100));
            skill->GetVictim ()->SetTime (1000 *
                                          (4 +
                                           int (skill->GetPlayer ()->GetVar1 () /
                                                (40.001 -
