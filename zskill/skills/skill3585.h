#ifndef __CPPGEN_GNET_SKILL3585
#define __CPPGEN_GNET_SKILL3585
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3585:public Skill
    {
      public:
        enum
        { SKILL_ID = 3585 };
          Skill3585 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3585Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               5 + skill->GetLevel (),
                               5 * skill->GetLevel (),
                               skill->GetLevel (), 3 + skill->GetLevel () / 4, INT (skill->GetLevel () / 2) + 1, 5 + skill->GetLevel (), 20);
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () - skill->GetPlayer ()->GetRes4 () >
                                                  0 ? skill->GetPlayer ()->GetVar1 () - skill->GetPlayer ()->GetRes4 () +
