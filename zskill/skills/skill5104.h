...
namespace GNET
{
    ...
    class Skill5104Stub:public SkillStub
    {
      ...
      Skill5104Stub ():SkillStub (5104)
        ...
        {
            return _snwprintf (buffer, length, format, 5 + 5);
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (2 * 25));
            skill->GetVictim ()->SetTime (2 > 0 ? (5000 + 1000 * 5) : 0);
            skill->GetVictim ()->SetRejectdebuff (1);
            skill->GetVictim ()->SetProbability (1.0 * (120));
            skill->GetVictim ()->SetTime (5000 + 1000 * 5);
