#ifndef __CPPGEN_GNET_SKILL2711
#define __CPPGEN_GNET_SKILL2711
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2711:public Skill
    {
      public:
        enum
        { SKILL_ID = 2711 };
          Skill2711 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2711Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetRes2 () + 8 * skill->GetLevel ());
      ...
      Skill2711Stub ():SkillStub (2711)
        ...
        {
            return _snwprintf (buffer, length, format, 2 * skill->GetLevel (), 5 * skill->GetLevel (), 8 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetValue (10 * skill->GetT1 ());
            skill->GetVictim ()->SetSubanti (1);
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetT2 () > 0 ? -1 : 0));
            skill->GetVictim ()->SetTime (20000 + 5000 * skill->GetT3 ());
            skill->GetVictim ()->SetRatio (0.0001 + 0.1 * skill->GetT2 ());
            skill->GetVictim ()->SetBuffid (0);
