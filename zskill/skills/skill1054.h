#ifndef __CPPGEN_GNET_SKILL1054
#define __CPPGEN_GNET_SKILL1054
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1054:public Skill
    {
      public:
        enum
        { SKILL_ID = 1054 };
          Skill1054 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1054Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
