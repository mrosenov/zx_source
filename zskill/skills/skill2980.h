#ifndef __CPPGEN_GNET_SKILL2980
#define __CPPGEN_GNET_SKILL2980
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2980:public Skill
    {
      public:
        enum
        { SKILL_ID = 2980 };
          Skill2980 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2980Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2980Stub ():SkillStub (2980)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (40882);
