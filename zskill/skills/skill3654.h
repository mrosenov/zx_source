#ifndef __CPPGEN_GNET_SKILL3654
#define __CPPGEN_GNET_SKILL3654
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3654:public Skill
    {
      public:
        enum
        { SKILL_ID = 3654 };
          Skill3654 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3654Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
