#ifndef __CPPGEN_GNET_SKILL4089
#define __CPPGEN_GNET_SKILL4089
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4089:public Skill
    {
      public:
        enum
        { SKILL_ID = 4089 };
          Skill4089 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4089Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
