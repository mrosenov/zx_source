#ifndef __CPPGEN_GNET_SKILL2649
#define __CPPGEN_GNET_SKILL2649
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2649:public Skill
    {
      public:
        enum
        { SKILL_ID = 2649 };
          Skill2649 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2649Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2649Stub ():SkillStub (2649)
        {
            occupation = 146;
            name = L"Áù¾õÉí£ºÁÒ";
            nativename = "Áù¾õÉí£ºÁÒ";
            icon = "Áù¾õÉí.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
