...
namespace GNET
{
    ...
    class Skill4370Stub:public SkillStub
    {
      public:
        ...
        {
            return _snwprintf (buffer, length, format, 6 * skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar2 () * 0.01 * skill->GetLevel () * 3);
