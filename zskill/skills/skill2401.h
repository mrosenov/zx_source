#ifndef __CPPGEN_GNET_SKILL2401
#define __CPPGEN_GNET_SKILL2401
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2401:public Skill
    {
      public:
        enum
        { SKILL_ID = 2401 };
          Skill2401 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2401Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
