#ifndef __CPPGEN_GNET_SKILL3098
#define __CPPGEN_GNET_SKILL3098
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3098:public Skill
    {
      public:
        enum
        { SKILL_ID = 3098 };
          Skill3098 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3098Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               20 + 2 * skill->GetLevel (),
                               30 + 3 * skill->GetLevel (),
                               20 + 3 * skill->GetLevel (), 5 * skill->GetLevel (), skill->GetLevel (), 20 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (0.01 * skill->GetLevel () * skill->GetPlayer ()->GetMaxmp ());
