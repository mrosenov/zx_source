#ifndef __CPPGEN_GNET_SKILL1613
#define __CPPGEN_GNET_SKILL1613
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1613:public Skill
    {
      public:
        enum
        { SKILL_ID = 1613 };
          Skill1613 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1613Stub:public SkillStub
    {
      public:
        Skill1613Stub ():SkillStub (1613)
        {
            occupation = 150;
            name = L"·ðÖ®ìøÄî";
            nativename = "·ðÖ®ìøÄî";
 ...
 80000 };
        ...
        {
            skill->GetPlayer ()->SetPasdechurt2 (0.01005 * skill->GetLevel ());
            return true;
        }
#endif
    };
