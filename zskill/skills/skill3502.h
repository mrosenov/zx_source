...
namespace GNET
{
    ...
    class Skill3502Stub:public SkillStub
    {
      ...
      Skill3502Stub ():SkillStub (3502)
        ...
        {
            return (float) (445 + 10 * skill->GetLevel () + 4 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               445 + 10 * skill->GetLevel () + 4 * skill->GetLevel () * skill->GetLevel (),
                               10 * skill->GetLevel (),
                               3 * skill->GetLevel (),
                               8 * skill->GetLevel (),
                               8 * skill->GetLevel (),
                               ...
                               2 * skill->GetLevel (),
                               10 * skill->GetLevel (),
                               8 * skill->GetLevel (), 8, 20 * skill->GetLevel (), 1 + 0.8 * skill->GetLevel (), 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (3000 * skill->GetLevel () + 3000 * skill->GetT0 ());
