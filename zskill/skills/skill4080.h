#ifndef __CPPGEN_GNET_SKILL4080
#define __CPPGEN_GNET_SKILL4080
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4080:public Skill
    {
      public:
        enum
        { SKILL_ID = 4080 };
          Skill4080 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4080Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4080Stub ():SkillStub (4080)
        {
            occupation = 130;
            name = L"Õæ¡¤¹íÓòÓÄ¸è";
            nativename = "Õæ¡¤¹íÓòÓÄ¸è";
            icon = "·ÉÉı¹íÓòÓÄ¸è.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
