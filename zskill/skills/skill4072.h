#ifndef __CPPGEN_GNET_SKILL4072
#define __CPPGEN_GNET_SKILL4072
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4072:public Skill
    {
      public:
        enum
        { SKILL_ID = 4072 };
          Skill4072 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4072Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4072Stub ():SkillStub (4072)
        {
            occupation = 130;
            name = L"Õæ¡¤ËÀÍö²¨ÎÆ";
            nativename = "Õæ¡¤ËÀÍö²¨ÎÆ";
            icon = "·ÉÉý¹íòâÚ¤Ú¤.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
