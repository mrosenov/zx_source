#ifndef __CPPGEN_GNET_SKILL3577
#define __CPPGEN_GNET_SKILL3577
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3577:public Skill
    {
      public:
        enum
        { SKILL_ID = 3577 };
          Skill3577 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3577Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               5 + 3 * int (skill->GetLevel () / 5), (1 + int (skill->GetLevel () / 5)), 4 + int (skill->GetLevel () / 5));
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (4 + int (skill->GetLevel () / 5) +
                                            ((2 +
                                              int (skill->GetLevel () /
                                                   4)) >skill->GetPlayer ()->GetDebuffcnt ()? skill->GetPlayer ()->GetDebuffcnt () : (2 +
                                                                                                                                      int (skill->
                                                                                                                                           ...
                                                                                                                                           / 4))) *
                                            1);
              skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMaxatk () *
                                             (0.01 + 0.01 * int (skill->GetLevel () / 5) +
                                              ((2 +
                                                int (skill->GetLevel () /
                                                     4))>skill->GetPlayer ()->GetDebuffcnt ()? skill->GetPlayer ()->GetDebuffcnt () : (2 +
                                                                                                                                       int (skill->
