#ifndef __CPPGEN_GNET_SKILL4449
#define __CPPGEN_GNET_SKILL4449
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4449:public Skill
    {
      public:
        enum
        { SKILL_ID = 4449 };
          Skill4449 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4449Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4449Stub ():SkillStub (4449)
        {
            occupation = 151;
            name = L"ÖÁ×ğÎŞÉÏ£¨Ìì£©";
            nativename = "ÖÁ×ğÎŞÉÏ£¨Ìì£©";
            icon = "±ÌÂäÑª.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetCultivation () ==
                                           1 ? 3005 : (skill->GetPlayer ()->GetCultivation () == 2 ? 3053 : 3101));
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetCultivation () ==
                                            1 ? 3005 : (skill->GetPlayer ()->GetCultivation () == 2 ? 3053 : 3101));
