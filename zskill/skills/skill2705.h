#ifndef __CPPGEN_GNET_SKILL2705
#define __CPPGEN_GNET_SKILL2705
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2705:public Skill
    {
      public:
        enum
        { SKILL_ID = 2705 };
          Skill2705 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2705Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
