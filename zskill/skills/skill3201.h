    ...
    class Skill3201Stub:public SkillStub
    {
      ...
      Skill3201Stub ():SkillStub (3201)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid ((skill->GetPlayer ()->GetVar1 () == 0 ? 1 : 0) * (191) +
                                            (skill->GetPlayer ()->GetVar1 () == 1 ? 1 : 0) * (20) + (skill->GetPlayer ()->GetVar1 () ==
                                                                                                     2 ? 1 : 0) * (300));
            skill->GetVictim ()->SetAmount ((skill->GetPlayer ()->GetVar1 () == 0 ? 1 : 0) * (373) +
                                            (skill->GetPlayer ()->GetVar1 () == 1 ? 1 : 0) * (440) + (skill->GetPlayer ()->GetVar1 () ==
                                                                                                      2 ? 1 : 0) * (327));
            skill->GetVictim ()->SetValue ((skill->GetPlayer ()->GetVar1 () == 0 ? 1 : 0) * (-151) +
                                           (skill->GetPlayer ()->GetVar1 () == 1 ? 1 : 0) * (70) + (skill->GetPlayer ()->GetVar1 () ==
                                                                                                    2 ? 1 : 0) * (-10));
