#ifndef __CPPGEN_GNET_SKILL2070
#define __CPPGEN_GNET_SKILL2070
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2070:public Skill
    {
      public:
        enum
        { SKILL_ID = 2070 };
          Skill2070 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2070Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2070Stub ():SkillStub (2070)
        {
            ...
            action[21] = "ÌìÒôËÂ_Æï³Ë_´Èº½ÆÕ¶È";
            action[22] = "0";
            action[23] = "0";
            action[24] = "0";
            action[25] = "0";
        ...
        {
            return _snwprintf (buffer, length, format, 1200, 10 + 2 * skill->GetLevel (), 18, 15 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.1501 * skill->GetLevel ());
