#ifndef __CPPGEN_GNET_SKILL385
#define __CPPGEN_GNET_SKILL385
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill385:public Skill
    {
      public:
        enum
        { SKILL_ID = 385 };
          Skill385 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill385Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill385Stub ():SkillStub (385)
        {
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "天音寺_骑乘_四大皆空地";
            action[16] = "天音寺_骑乘_四大皆空地";
            action[17] = "天音寺_骑乘_四大皆空地";
            action[18] = "天音寺_骑乘_四大皆空地";
            action[19] = "天音寺_骑乘_四大皆空地";
            action[20] = "天音寺_骑乘_四大皆空地";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
        ...
        {
            return (float) (252 + 135 * skill->GetLevel () - 3.6 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        {
            static int array[8] = { 95, 98, 101, 103, 107, 109, 111, 114 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               INT (252 + 135 * skill->GetLevel () - 3.6 * skill->GetLevel () * skill->GetLevel ()), 30, 8 * skill->GetLevel () + 8);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((252 + 135 * skill->GetLevel () - 3.6 * skill->GetLevel () * skill->GetLevel ()) * 0.3 * skill->GetT0 ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetPlayer ()->GetHasbuff (4521) ==
                                          1 ? 1 : (1800000 +
                                                   900000 * skill->GetT0 ()) * norm (skill->GetT1 ()) *
                                          norm (skill->GetPlayer ()->GetSkilllevel (384)));
            skill->GetVictim ()->SetBuffid (skill->GetPlayer ()->GetHasbuff (4521) == 1 ? 0 : 1);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetHasbuff (4521) ==
                                           1 ? 0.00001 : (8 * skill->GetPlayer ()->GetSkilllevel (384) + 8) * (1 + 0.4 * skill->GetT1 ()));
