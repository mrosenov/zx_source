#ifndef __CPPGEN_GNET_SKILL2723
#define __CPPGEN_GNET_SKILL2723
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2723:public Skill
    {
      public:
        enum
        { SKILL_ID = 2723 };
          Skill2723 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2723Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
