#ifndef __CPPGEN_GNET_SKILL4326
#define __CPPGEN_GNET_SKILL4326
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4326:public Skill
    {
      public:
        enum
        { SKILL_ID = 4326 };
          Skill4326 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4326Stub:public SkillStub
    {
      public:
        Skill4326Stub ():SkillStub (4326)
        {
            occupation = 130;
            name = L"寒月镇潭3";
            nativename = "寒月镇潭3";
