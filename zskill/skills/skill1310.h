#ifndef __CPPGEN_GNET_SKILL1310
#define __CPPGEN_GNET_SKILL1310
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1310:public Skill
    {
      public:
        enum
        { SKILL_ID = 1310 };
          Skill1310 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1310Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
