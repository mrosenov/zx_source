#ifndef __CPPGEN_GNET_SKILL1408
#define __CPPGEN_GNET_SKILL1408
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1408:public Skill
    {
      public:
        enum
        { SKILL_ID = 1408 };
          Skill1408 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1408Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1408Stub ():SkillStub (1408)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 6 * skill->GetLevel (), 10, 6, 8, 15, 30, 15, 1);
