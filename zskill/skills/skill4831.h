#ifndef __CPPGEN_GNET_SKILL4831
#define __CPPGEN_GNET_SKILL4831
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4831:public Skill
    {
      public:
        enum
        { SKILL_ID = 4831 };
          Skill4831 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4831Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4831Stub ():SkillStub (4831)
        {
            ...
            action[11] = "0";
            action[12] = "0";
            action[13] = "ÁéÙí_·¨±¦_ÂÞºîÓñ";
            action[14] = "";
            action[15] = "»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü";
            action[16] = "0";
            action[17] = "0";
            action[18] = "0";
            action[19] = "0";
