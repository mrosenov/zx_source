#ifndef __CPPGEN_GNET_SKILL4574
#define __CPPGEN_GNET_SKILL4574
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4574:public Skill
    {
      public:
        enum
        { SKILL_ID = 4574 };
          Skill4574 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4574Stub:public SkillStub
    {
      public:
        Skill4574Stub ():SkillStub (4574)
        {
            occupation = 148;
            name = L"ËéÄù¡¤î¸¡¤Ê¢·çII";
