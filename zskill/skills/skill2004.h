#ifndef __CPPGEN_GNET_SKILL2004
#define __CPPGEN_GNET_SKILL2004
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2004:public Skill
    {
      public:
        enum
        { SKILL_ID = 2004 };
          Skill2004 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2004Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2004Stub ():SkillStub (2004)
        {
            occupation = 128;
            name = L"³þººÕ½³¡-Áõ°î";
            nativename = "³þººÕ½³¡-Áõ°î";
            icon = "";
            maxlevel = 99;
            maxlearn = 99;
            type = 1;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (300000);
