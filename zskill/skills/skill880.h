#ifndef __CPPGEN_GNET_SKILL880
#define __CPPGEN_GNET_SKILL880
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill880:public Skill
    {
      public:
        enum
        { SKILL_ID = 880 };
          Skill880 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill880Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
