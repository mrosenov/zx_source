#ifndef __CPPGEN_GNET_SKILL3765
#define __CPPGEN_GNET_SKILL3765
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3765:public Skill
    {
      public:
        enum
        { SKILL_ID = 3765 };
          Skill3765 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3765Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
