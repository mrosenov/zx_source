#ifndef __CPPGEN_GNET_SKILL2497
#define __CPPGEN_GNET_SKILL2497
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2497:public Skill
    {
      public:
        enum
        { SKILL_ID = 2497 };
          Skill2497 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2497Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2497Stub ():SkillStub (2497)
        ...
        {
            return (float) (450 * (1 - 0.04 * skill->GetT1 ()));
        }
        ...
        {
            return _snwprintf (buffer, length, format, 10 + skill->GetLevel (), INT (skill->GetLevel () / 3) + 3);
