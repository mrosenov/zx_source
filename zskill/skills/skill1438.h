#ifndef __CPPGEN_GNET_SKILL1438
#define __CPPGEN_GNET_SKILL1438
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1438:public Skill
    {
      public:
        enum
        { SKILL_ID = 1438 };
          Skill1438 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1438Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1438Stub ():SkillStub (1438)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 6 * skill->GetLevel (), 5, 6, 8, 15, 30, 15, 5);
