#ifndef __CPPGEN_GNET_SKILL4830
#define __CPPGEN_GNET_SKILL4830
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4830:public Skill
    {
      public:
        enum
        { SKILL_ID = 4830 };
          Skill4830 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4830Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
