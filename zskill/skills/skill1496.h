#ifndef __CPPGEN_GNET_SKILL1496
#define __CPPGEN_GNET_SKILL1496
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1496:public Skill
    {
      public:
        enum
        { SKILL_ID = 1496 };
          Skill1496 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1496Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
