#ifndef __CPPGEN_GNET_SKILL2324
#define __CPPGEN_GNET_SKILL2324
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2324:public Skill
    {
      public:
        enum
        { SKILL_ID = 2324 };
          Skill2324 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2324Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
