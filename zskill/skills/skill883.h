#ifndef __CPPGEN_GNET_SKILL883
#define __CPPGEN_GNET_SKILL883
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill883:public Skill
    {
      public:
        enum
        { SKILL_ID = 883 };
          Skill883 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill883Stub:public SkillStub
    {
      public:
        Skill883Stub ():SkillStub (883)
        {
            occupation = 129;
            name = L"¾Ã¾ÃÔÂ±ý";
            nativename = "¾Ã¾ÃÔÂ±ý";
