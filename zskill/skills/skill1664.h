#ifndef __CPPGEN_GNET_SKILL1664
#define __CPPGEN_GNET_SKILL1664
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1664:public Skill
    {
      public:
        enum
        { SKILL_ID = 1664 };
          Skill1664 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1664Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
