...
namespace GNET
{
    ...
    class Skill3501Stub:public SkillStub
    {
      ...
      Skill3501Stub ():SkillStub (3501)
        ...
        {
            return (float) (1050 + 70 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               1050 + 70 * skill->GetLevel () * skill->GetLevel (),
                               5 * skill->GetLevel (), 30 * skill->GetLevel (), 5 * skill->GetLevel (), 90);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (5000 * skill->GetLevel () + 3000 * skill->GetT1 ());
            skill->GetVictim ()->SetRatio (1);
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetAmount (0);
            skill->GetVictim ()->SetValue (0.3 * skill->GetLevel ());
            skill->GetVictim ()->SetGuishen2debuff (1);
            skill->GetVictim ()->SetProbability (1.0 * (120));
            skill->GetVictim ()->SetTime (5000 * skill->GetLevel () + 3000 * skill->GetT1 ());
