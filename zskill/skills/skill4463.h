#ifndef __CPPGEN_GNET_SKILL4463
#define __CPPGEN_GNET_SKILL4463
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4463:public Skill
    {
      public:
        enum
        { SKILL_ID = 4463 };
          Skill4463 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4463Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
