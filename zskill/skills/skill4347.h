#ifndef __CPPGEN_GNET_SKILL4347
#define __CPPGEN_GNET_SKILL4347
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4347:public Skill
    {
      public:
        enum
        { SKILL_ID = 4347 };
          Skill4347 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4347Stub:public SkillStub
    {
      public:
        Skill4347Stub ():SkillStub (4347)
        {
            occupation = 130;
            name = L"天琊绝世1";
            nativename = "天琊绝世1";
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel () * 20,
                               2 * (skill->GetLevel () + 1) * (skill->GetLevel () + 1), skill->GetLevel () * 10, 10 + 4 * skill->GetLevel ());
