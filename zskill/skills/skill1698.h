#ifndef __CPPGEN_GNET_SKILL1698
#define __CPPGEN_GNET_SKILL1698
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1698:public Skill
    {
      public:
        enum
        { SKILL_ID = 1698 };
          Skill1698 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1698Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1698Stub ():SkillStub (1698)
        {
            occupation = 146;
            name = L"ÆÆÄ§åÈÀ¶£º°µ";
            nativename = "ÆÆÄ§åÈÀ¶£º°µ";
            icon = "ÆÆÄ§åÈÀ¶.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
