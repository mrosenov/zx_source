#ifndef __CPPGEN_GNET_SKILL1413
#define __CPPGEN_GNET_SKILL1413
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1413:public Skill
    {
      public:
        enum
        { SKILL_ID = 1413 };
          Skill1413 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1413Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1413Stub ():SkillStub (1413)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 10 * skill->GetLevel (), 4, 15, 30, 15);
