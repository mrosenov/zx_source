#ifndef __CPPGEN_GNET_SKILL3022
#define __CPPGEN_GNET_SKILL3022
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3022:public Skill
    {
      public:
        enum
        { SKILL_ID = 3022 };
          Skill3022 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3022Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3022Stub ():SkillStub (3022)
        {
            occupation = 167;
            name = L"¿ñÁé·´ÊÉ<Ğş>";
            nativename = "¿ñÁé·´ÊÉ<Ğş>";
            icon = "ÏÉ¡¤¿ñÁé·´ÊÉ.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 2;
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               180, 20, 4 * skill->GetLevel (), 5 * skill->GetLevel (), 10, skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.04 * skill->GetLevel () + norm (skill->GetLevel () / 19.9) * 0.3);
        ...
        {
            skill->GetVictim ()->SetTime (1050 + 1000 * skill->GetLevel ());
