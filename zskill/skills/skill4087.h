#ifndef __CPPGEN_GNET_SKILL4087
#define __CPPGEN_GNET_SKILL4087
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4087:public Skill
    {
      public:
        enum
        { SKILL_ID = 4087 };
          Skill4087 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4087Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
