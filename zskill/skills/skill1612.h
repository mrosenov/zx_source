#ifndef __CPPGEN_GNET_SKILL1612
#define __CPPGEN_GNET_SKILL1612
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1612:public Skill
    {
      public:
        enum
        { SKILL_ID = 1612 };
          Skill1612 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1612Stub:public SkillStub
    {
      public:
        Skill1612Stub ():SkillStub (1612)
        {
            occupation = 150;
            name = L"佛之无畏";
            nativename = "佛之无畏";
 ...
 40000 };
        ...
        {
            skill->GetPlayer ()->SetPasincskilldodge (10 * skill->GetLevel () + 20 * int (skill->GetLevel () / 20));
              return true;
        }
#endif
    };
