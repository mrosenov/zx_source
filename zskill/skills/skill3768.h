#ifndef __CPPGEN_GNET_SKILL3768
#define __CPPGEN_GNET_SKILL3768
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3768:public Skill
    {
      public:
        enum
        { SKILL_ID = 3768 };
          Skill3768 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3768Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3768Stub ():SkillStub (3768)
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.25001);
