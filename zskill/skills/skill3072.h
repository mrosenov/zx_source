#ifndef __CPPGEN_GNET_SKILL3072
#define __CPPGEN_GNET_SKILL3072
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3072:public Skill
    {
      public:
        enum
        { SKILL_ID = 3072 };
          Skill3072 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3072Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3072Stub ():SkillStub (3072)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               33,
                               30,
                               30, 6, 2 * skill->GetLevel (), 33, 10 * skill->GetLevel (), 15, 2 + 0.5 * skill->GetLevel (), 2 * skill->GetLevel ());
