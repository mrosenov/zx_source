#ifndef __CPPGEN_GNET_SKILL4074
#define __CPPGEN_GNET_SKILL4074
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4074:public Skill
    {
      public:
        enum
        { SKILL_ID = 4074 };
          Skill4074 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4074Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4074Stub ():SkillStub (4074)
        {
            occupation = 130;
            name = L"Õæ¡¤¿ñÀ½ÃðÉ±";
            nativename = "Õæ¡¤¿ñÀ½ÃðÉ±";
            icon = "·ÉÉý¿ñÀ½ÃðÉ±.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
