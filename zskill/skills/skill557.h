#ifndef __CPPGEN_GNET_SKILL557
#define __CPPGEN_GNET_SKILL557
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill557:public Skill
    {
      public:
        enum
        { SKILL_ID = 557 };
          Skill557 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill557Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
