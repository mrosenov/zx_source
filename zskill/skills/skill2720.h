#ifndef __CPPGEN_GNET_SKILL2720
#define __CPPGEN_GNET_SKILL2720
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2720:public Skill
    {
      public:
        enum
        { SKILL_ID = 2720 };
          Skill2720 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2720Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2720Stub ():SkillStub (2720)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (34179);
