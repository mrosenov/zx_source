#ifndef __CPPGEN_GNET_SKILL2886
#define __CPPGEN_GNET_SKILL2886
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2886:public Skill
    {
      public:
        enum
        { SKILL_ID = 2886 };
          Skill2886 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2886Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
