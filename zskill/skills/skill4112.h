#ifndef __CPPGEN_GNET_SKILL4112
#define __CPPGEN_GNET_SKILL4112
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4112:public Skill
    {
      public:
        enum
        { SKILL_ID = 4112 };
          Skill4112 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4112Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.01 * skill->GetT0 () + 0.12 * skill->GetLevel () +
                                 0.01 * INT (skill->GetPlayer ()->GetLevel () / (8 - skill->GetLevel ())));
                skill->SetPlus (800 * skill->GetLevel () + 0.01 * skill->GetT1 () * skill->GetPlayer ()->GetDef ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4112Stub ():SkillStub (4112)
        {
            occupation = 130;
            name = L"真・天琊绝世";
            nativename = "真・天琊绝世";
