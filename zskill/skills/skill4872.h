#ifndef __CPPGEN_GNET_SKILL4872
#define __CPPGEN_GNET_SKILL4872
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4872:public Skill
    {
      public:
        enum
        { SKILL_ID = 4872 };
          Skill4872 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4872Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                int dam =
                  ...
                  skill->SetPlus (480 + 80 * skill->GetLevel () + dam * cul);
                  skill->SetPlus2 (dam * (1 - cul));
                  skill->SetRatio (1 + (skill->GetPlayer ()->GetCultivation () == 1 ? skill->GetPlayer ()->GetSkilllevel (5255) * 0.05 : 0));
                  ...
                  skill->GetPlayer ()->SetVar2 ((skill->GetPlayer ()->GetCultivation () == 1 ? skill->GetPlayer ()->GetSkilllevel (5255) : 0));
                  skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4872Stub ():SkillStub (4872)
        {
            occupation = 111;
            name = L"½¹ÍÁ";
            nativename = "½¹ÍÁ";
        ...
        {
            return _snwprintf (buffer, length, format, 480 + 80 * skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.01 * skill->GetLevel () * 2 +
                                            0.01 * skill->GetPlayer ()->GetVar2 () * skill->GetPlayer ()->GetMaxhp () * 2);
