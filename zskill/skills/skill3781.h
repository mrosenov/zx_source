#ifndef __CPPGEN_GNET_SKILL3781
#define __CPPGEN_GNET_SKILL3781
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3781:public Skill
    {
      public:
        enum
        { SKILL_ID = 3781 };
          Skill3781 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3781Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3781Stub ():SkillStub (3781)
        {
            occupation = 146;
            name = L"ºì³¾ºÞ£º°µ";
            nativename = "ºì³¾ºÞ£º°µ";
            icon = "ºì³¾ºÞ·Ù.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
