#ifndef __CPPGEN_GNET_SKILL3711
#define __CPPGEN_GNET_SKILL3711
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3711:public Skill
    {
      public:
        enum
        { SKILL_ID = 3711 };
          Skill3711 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3711Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3711Stub ():SkillStub (3711)
        ...
        {
            return _snwprintf (buffer, length, format, 2011);
