#ifndef __CPPGEN_GNET_SKILL3176
#define __CPPGEN_GNET_SKILL3176
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3176:public Skill
    {
      public:
        enum
        { SKILL_ID = 3176 };
          Skill3176 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3176Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3176Stub ():SkillStub (3176)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetTmplid () == 41999 ? 100 : 0));
