#ifndef __CPPGEN_GNET_SKILL2681
#define __CPPGEN_GNET_SKILL2681
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2681:public Skill
    {
      public:
        enum
        { SKILL_ID = 2681 };
          Skill2681 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2681Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
