...
namespace GNET
{
    ...
    class Skill4379Stub:public SkillStub
    {
      public:
        ...
        {
            return _snwprintf (buffer, length, format, 4 * skill->GetLevel (), 2 + 2 * skill->GetLevel (), 3 + skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetTime (zrand (100) < 4 * skill->GetLevel ()? 1000 * (2 + 2 * skill->GetLevel ()) : 0);
