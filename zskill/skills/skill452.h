#ifndef __CPPGEN_GNET_SKILL452
#define __CPPGEN_GNET_SKILL452
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill452:public Skill
    {
      public:
        enum
        { SKILL_ID = 452 };
          Skill452 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill452Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
