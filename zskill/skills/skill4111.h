#ifndef __CPPGEN_GNET_SKILL4111
#define __CPPGEN_GNET_SKILL4111
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4111:public Skill
    {
      public:
        enum
        { SKILL_ID = 4111 };
          Skill4111 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4111Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.03 * skill->GetT0 () + 0.12 * skill->GetLevel () +
                                 0.01 * INT (skill->GetPlayer ()->GetLevel () / (8 - skill->GetLevel ())));
                skill->SetPlus (800 * skill->GetLevel () + 0.03 * skill->GetT1 () * skill->GetPlayer ()->GetDef ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4111Stub ():SkillStub (4111)
        {
            occupation = 130;
            name = L"Õæ¡¤ÊÉ»êÎŞË«";
            nativename = "Õæ¡¤ÊÉ»êÎŞË«";
            icon = "·ÉÉıÊÉ»êÎŞË«.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               800 * skill->GetLevel (),
                               8 - skill->GetLevel (),
                               705 - 55 * skill->GetLevel () - skill->GetLevel () * skill->GetLevel (), 6.3 - 0.3 * skill->GetLevel ());
