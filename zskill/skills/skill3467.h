...
namespace GNET
{
    ...
    class Skill3467Stub:public SkillStub
    {
      ...
      Skill3467Stub ():SkillStub (3467)
        ...
        {
            return _snwprintf (buffer, length, format, 1 + 0.4 * skill->GetLevel (), 3 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (3000 * skill->GetLevel () + 2000 * skill->GetT0 ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (1 + 0.4 * skill->GetLevel () + 0.2 * skill->GetT0 ());
