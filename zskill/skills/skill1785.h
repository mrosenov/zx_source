#ifndef __CPPGEN_GNET_SKILL1785
#define __CPPGEN_GNET_SKILL1785
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1785:public Skill
    {
      public:
        enum
        { SKILL_ID = 1785 };
          Skill1785 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1785Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
