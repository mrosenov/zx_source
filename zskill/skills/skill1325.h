#ifndef __CPPGEN_GNET_SKILL1325
#define __CPPGEN_GNET_SKILL1325
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1325:public Skill
    {
      public:
        enum
        { SKILL_ID = 1325 };
          Skill1325 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1325Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
