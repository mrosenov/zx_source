#ifndef __CPPGEN_GNET_SKILL3582
#define __CPPGEN_GNET_SKILL3582
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3582:public Skill
    {
      public:
        enum
        { SKILL_ID = 3582 };
          Skill3582 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3582Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3582Stub ():SkillStub (3582)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               180, (10 + skill->GetLevel ()), 5 + int (skill->GetLevel () / 4), 10);
