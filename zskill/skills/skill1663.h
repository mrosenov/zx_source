#ifndef __CPPGEN_GNET_SKILL1663
#define __CPPGEN_GNET_SKILL1663
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1663:public Skill
    {
      public:
        enum
        { SKILL_ID = 1663 };
          Skill1663 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1663Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1663Stub ():SkillStub (1663)
        {
            occupation = 146;
            name = L"ÍíÀ´Çï£ºÃî";
            nativename = "ÍíÀ´Çï£ºÃî";
            icon = "ÍíÀ´Çï.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 2;
