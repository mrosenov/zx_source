#ifndef __CPPGEN_GNET_SKILL1791
#define __CPPGEN_GNET_SKILL1791
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1791:public Skill
    {
      public:
        enum
        { SKILL_ID = 1791 };
          Skill1791 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1791Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
