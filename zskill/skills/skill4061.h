#ifndef __CPPGEN_GNET_SKILL4061
#define __CPPGEN_GNET_SKILL4061
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4061:public Skill
    {
      public:
        enum
        { SKILL_ID = 4061 };
          Skill4061 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4061Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4061Stub ():SkillStub (4061)
        {
            occupation = 130;
            name = L"Õæ¡¤¾øìå»ª¹â";
            nativename = "Õæ¡¤¾øìå»ª¹â";
            icon = "·ÉÉýÔÖÐÇ²øÈÆ.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
