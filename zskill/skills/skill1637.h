#ifndef __CPPGEN_GNET_SKILL1637
#define __CPPGEN_GNET_SKILL1637
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1637:public Skill
    {
      public:
        enum
        { SKILL_ID = 1637 };
          Skill1637 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1637Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
