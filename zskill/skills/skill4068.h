#ifndef __CPPGEN_GNET_SKILL4068
#define __CPPGEN_GNET_SKILL4068
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4068:public Skill
    {
      public:
        enum
        { SKILL_ID = 4068 };
          Skill4068 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4068Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4068Stub ():SkillStub (4068)
        {
            occupation = 130;
            name = L"Õæ¡¤Ç§ç±Ñ¤Îè";
            nativename = "Õæ¡¤Ç§ç±Ñ¤Îè";
            icon = "·ÉÉıÇ§ç±Ñ¤Îè.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
