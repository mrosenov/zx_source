#ifndef __CPPGEN_GNET_SKILL3455
#define __CPPGEN_GNET_SKILL3455
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3455:public Skill
    {
      public:
        enum
        { SKILL_ID = 3455 };
          Skill3455 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3455Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
