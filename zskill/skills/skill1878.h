...
namespace GNET
{
    ...
    class Skill1878Stub:public SkillStub
    {
      public:
        ...
        {
            skill->GetPlayer ()->SetPasaddsleep (4 * skill->GetLevel () * (1 + skill->GetT0 ()));
            skill->GetPlayer ()->SetPasaddsilent (4 * skill->GetLevel () * (1 + skill->GetT0 ()));
            return true;
        }
#endif
    };
