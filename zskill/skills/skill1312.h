#ifndef __CPPGEN_GNET_SKILL1312
#define __CPPGEN_GNET_SKILL1312
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1312:public Skill
    {
      public:
        enum
        { SKILL_ID = 1312 };
          Skill1312 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1312Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
