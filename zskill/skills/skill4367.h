#ifndef __CPPGEN_GNET_SKILL4367
#define __CPPGEN_GNET_SKILL4367
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4367:public Skill
    {
      public:
        enum
        { SKILL_ID = 4367 };
          Skill4367 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4367Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4367Stub ():SkillStub (4367)
        {
            occupation = 130;
            name = L"Õæ¡¤À×¹ÄÕðÌì";
            nativename = "Õæ¡¤À×¹ÄÕðÌì";
            icon = "¿ñÀ×ÌìÅ­.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
