#ifndef __CPPGEN_GNET_SKILL558
#define __CPPGEN_GNET_SKILL558
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill558:public Skill
    {
      public:
        enum
        { SKILL_ID = 558 };
          Skill558 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill558Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
