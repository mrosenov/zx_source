#ifndef __CPPGEN_GNET_SKILL566
#define __CPPGEN_GNET_SKILL566
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill566:public Skill
    {
      public:
        enum
        { SKILL_ID = 566 };
          Skill566 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill566Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
