#ifndef __CPPGEN_GNET_SKILL1928
#define __CPPGEN_GNET_SKILL1928
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1928:public Skill
    {
      public:
        enum
        { SKILL_ID = 1928 };
          Skill1928 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1928Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
