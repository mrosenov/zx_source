#ifndef __CPPGEN_GNET_SKILL4362
#define __CPPGEN_GNET_SKILL4362
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4362:public Skill
    {
      public:
        enum
        { SKILL_ID = 4362 };
          Skill4362 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4362Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
