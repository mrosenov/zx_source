#ifndef __CPPGEN_GNET_SKILL3317
#define __CPPGEN_GNET_SKILL3317
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3317:public Skill
    {
      public:
        enum
        { SKILL_ID = 3317 };
          Skill3317 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3317Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
