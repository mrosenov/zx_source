#ifndef __CPPGEN_GNET_SKILL3113
#define __CPPGEN_GNET_SKILL3113
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3113:public Skill
    {
      public:
        enum
        { SKILL_ID = 3113 };
          Skill3113 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3113Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               225 * skill->GetLevel (), 12 + skill->GetLevel (), 8, skill->GetLevel (), 2 + 0.5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetIscrit () > 0 ? 100 : 0));
