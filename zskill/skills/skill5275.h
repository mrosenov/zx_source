#ifndef __CPPGEN_GNET_SKILL5275
#define __CPPGEN_GNET_SKILL5275
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5275:public Skill
    {
      public:
        enum
        { SKILL_ID = 5275 };
          Skill5275 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5275Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               3, 5, 50 + skill->GetLevel (), 5 * skill->GetLevel (), 60);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime ((5000 + 1000 * skill->GetPlayer ()->GetSkilllevel (4878)) * (1 + 0.05 * skill->GetLevel ()));
            skill->GetVictim ()->SetRatio (3);
            skill->GetVictim ()->
                SetAmount ((skill->GetPlayer ()->GetMaxatk () * 5 + skill->GetPlayer ()->GetVar1 () * 0.5 +
