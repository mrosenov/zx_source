#ifndef __CPPGEN_GNET_SKILL4832
#define __CPPGEN_GNET_SKILL4832
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4832:public Skill
    {
      public:
        enum
        { SKILL_ID = 4832 };
          Skill4832 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4832Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
