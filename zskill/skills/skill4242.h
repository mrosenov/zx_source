#ifndef __CPPGEN_GNET_SKILL4242
#define __CPPGEN_GNET_SKILL4242
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4242:public Skill
    {
      public:
        enum
        { SKILL_ID = 4242 };
          Skill4242 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4242Stub:public SkillStub
    {
      public:
        Skill4242Stub ():SkillStub (4242)
        {
            occupation = 130;
            name = L"浮光阑影1";
            nativename = "浮光阑影1";
