    ...
    class Skill2757Stub:public SkillStub
    {
      ...
      Skill2757Stub ():SkillStub (2757)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetLevel () == 2 ? 800 : 0));
            skill->GetVictim ()->SetTime (1800000);
            skill->GetVictim ()->SetRatio (0.3);
            skill->GetVictim ()->SetBuffid (2);
            ...
            skill->GetVictim ()->SetAmount (500000);
            skill->GetVictim ()->SetValue (800000);
            skill->GetVictim ()->SetSubhp (1);
            skill->GetVictim ()->SetTime (skill->GetLevel () == 1 ? 4000 : 0);
