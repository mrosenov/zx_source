#ifndef __CPPGEN_GNET_SKILL3083
#define __CPPGEN_GNET_SKILL3083
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3083:public Skill
    {
      public:
        enum
        { SKILL_ID = 3083 };
          Skill3083 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3083Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3083Stub ():SkillStub (3083)
        {
            occupation = 168;
            name = L"Éñ¹íÂÒÎè<É·>";
            nativename = "Éñ¹íÂÒÎè<É·>";
            icon = "Ä§¡¤Éñ¹íÂÒÎè.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
