#ifndef __CPPGEN_GNET_SKILL4594
#define __CPPGEN_GNET_SKILL4594
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4594:public Skill
    {
      public:
        enum
        { SKILL_ID = 4594 };
          Skill4594 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4594Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
