#ifndef __CPPGEN_GNET_SKILL3157
#define __CPPGEN_GNET_SKILL3157
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3157:public Skill
    {
      public:
        enum
        { SKILL_ID = 3157 };
          Skill3157 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3157Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3157Stub ():SkillStub (3157)
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 ((skill->GetPlayer ()->GetTmplid () == 41256 || skill->GetPlayer ()->GetTmplid () == 41258
                                                   || skill->GetPlayer ()->GetTmplid () == 41260
                                                   || skill->GetPlayer ()->GetTmplid () == 41314) ? 100 : 0));
