#ifndef __CPPGEN_GNET_SKILL3636
#define __CPPGEN_GNET_SKILL3636
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3636:public Skill
    {
      public:
        enum
        { SKILL_ID = 3636 };
          Skill3636 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3636Stub:public SkillStub
    {
      public:
        Skill3636Stub ():SkillStub (3636)
        {
            occupation = 64;
            name = L"Óñ²áÑÓ³Ù2";
            nativename = "Óñ²áÑÓ³Ù2";
            icon = "";
            maxlevel = 99;
            maxlearn = 10;
            type = 2;
