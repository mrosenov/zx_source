#ifndef __CPPGEN_GNET_SKILL3084
#define __CPPGEN_GNET_SKILL3084
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3084:public Skill
    {
      public:
        enum
        { SKILL_ID = 3084 };
          Skill3084 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3084Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3084Stub ():SkillStub (3084)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               5 + skill->GetLevel (), 5 * skill->GetLevel (), 3 * skill->GetLevel (), 10 + 2 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (10 + 2 * skill->GetLevel () + norm (skill->GetLevel () / 19.9) * 15));
            skill->GetVictim ()->SetAmount (1 + norm (skill->GetLevel () / 19.9));
