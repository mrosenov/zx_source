#ifndef __CPPGEN_GNET_SKILL4082
#define __CPPGEN_GNET_SKILL4082
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4082:public Skill
    {
      public:
        enum
        { SKILL_ID = 4082 };
          Skill4082 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4082Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
