#ifndef __CPPGEN_GNET_SKILL1774
#define __CPPGEN_GNET_SKILL1774
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1774:public Skill
    {
      public:
        enum
        { SKILL_ID = 1774 };
          Skill1774 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1774Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
