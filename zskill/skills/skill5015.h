...
namespace GNET
{
    ...
    class Skill5015Stub:public SkillStub
    {
      ...
      Skill5015Stub ():SkillStub (5015)
        ...
        {
            return _snwprintf (buffer, length, format, 25 * skill->GetLevel (), 6 * skill->GetLevel (), 355 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (skill->GetPlayer ()->GetHasbuff (4787) == 1 ? (skill->GetPlayer ()->GetHasbuff (4788) == 1 ? 9 : 8) : 7);
            skill->GetVictim ()->SetAmount (355 * skill->GetLevel () * 3 * skill->GetLevel ());
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetHpleak1 (1);
            skill->GetVictim ()->SetProbability (1.0 * (120));
            skill->GetVictim ()->SetTime (3000 * skill->GetLevel ());
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetHasbuff (4787) ==
                                           1 ? (skill->GetPlayer ()->GetHasbuff (4788) == 1 ? 0.7 : 0.35) : 0.15);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetHasbuff (4787) ==
                                           1 ? (skill->GetPlayer ()->GetHasbuff (4788) == 1 ? 0.7 : 0.35) : 0.15);
