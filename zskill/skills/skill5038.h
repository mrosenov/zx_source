#ifndef __CPPGEN_GNET_SKILL5038
#define __CPPGEN_GNET_SKILL5038
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5038:public Skill
    {
      public:
        enum
        { SKILL_ID = 5038 };
          Skill5038 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5038Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5038Stub ():SkillStub (5038)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetDebuffcnt () >= 4 ? 100 : 0));
