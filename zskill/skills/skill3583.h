#ifndef __CPPGEN_GNET_SKILL3583
#define __CPPGEN_GNET_SKILL3583
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3583:public Skill
    {
      public:
        enum
        { SKILL_ID = 3583 };
          Skill3583 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3583Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               skill->GetLevel (),
                               3 * skill->GetLevel (),
                               INT (1 + skill->GetLevel () / 5), 10 + 3 * skill->GetLevel (), 5 + INT (skill->GetLevel () / 4));
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetHasmultbuff (11) ==
                                                  1 ? (skill->GetPlayer ()->GetVar1 () - skill->GetPlayer ()->GetRes3 () >
                                                       0 ? skill->GetPlayer ()->GetVar1 () - skill->GetPlayer ()->GetRes3 () : 0) : 0));
            skill->GetVictim ()->SetTime (100);
            skill->GetVictim ()->SetRatio (skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetValue (3593);
