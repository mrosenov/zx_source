#ifndef __CPPGEN_GNET_SKILL2881
#define __CPPGEN_GNET_SKILL2881
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2881:public Skill
    {
      public:
        enum
        { SKILL_ID = 2881 };
          Skill2881 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2881Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
