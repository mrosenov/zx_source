#ifndef __CPPGEN_GNET_SKILL1650
#define __CPPGEN_GNET_SKILL1650
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1650:public Skill
    {
      public:
        enum
        { SKILL_ID = 1650 };
          Skill1650 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1650Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
