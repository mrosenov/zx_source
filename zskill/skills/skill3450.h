#ifndef __CPPGEN_GNET_SKILL3450
#define __CPPGEN_GNET_SKILL3450
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3450:public Skill
    {
      public:
        enum
        { SKILL_ID = 3450 };
          Skill3450 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3450Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3450Stub ():SkillStub (3450)
        ...
        {
            return 150000 - 15000 * skill->GetT1 () - 150000 * 0.02 * skill->GetT4 ();
        }
        ...
        {
            return _snwprintf (buffer, length, format, 5 + 2 * skill->GetLevel (), skill->GetLevel (), skill->GetLevel (), 1, 10);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->
                SetTime ((5 + 2 * skill->GetLevel () + (skill->GetPlayer ()->GetCyclemembercnt () - 1) * 5 +
                          skill->GetPlayer ()->GetCyclemembercnt () * skill->GetT0 ()) * 1000 + 10000 * int (skill->GetCharging () / 4800) +
                         1000 * skill->GetT4 ());
              skill->GetVictim ()->SetRatio (skill->GetLevel () * 100 + skill->GetLevel () + skill->GetPlayer ()->GetCyclemembercnt () - 1 +
                                             skill->GetT2 () * skill->GetPlayer ()->GetCyclemembercnt ());
              skill->GetVictim ()->SetBuffid (0);
              skill->GetVictim ()->SetAmount (3607);
