#ifndef __CPPGEN_GNET_SKILL5268
#define __CPPGEN_GNET_SKILL5268
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5268:public Skill
    {
      public:
        enum
        { SKILL_ID = 5268 };
          Skill5268 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5268Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill5268Stub ():SkillStub (5268)
        {
            occupation = 167;
            name = L"ÄæÁÛ¶Ï<Ðþ>";
            nativename = "ÄæÁÛ¶Ï<Ðþ>";
            icon = "ÎÊºÅ.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
