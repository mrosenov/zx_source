#ifndef __CPPGEN_GNET_SKILL1329
#define __CPPGEN_GNET_SKILL1329
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1329:public Skill
    {
      public:
        enum
        { SKILL_ID = 1329 };
          Skill1329 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1329Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
