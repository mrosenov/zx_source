#ifndef __CPPGEN_GNET_SKILL4809
#define __CPPGEN_GNET_SKILL4809
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4809:public Skill
    {
      public:
        enum
        { SKILL_ID = 4809 };
          Skill4809 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4809Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->GetPlayer ()->SetVar9 (skill->GetPlayer ()->GetMaxmp ());
                ...
                skill->SetPlus (800 + 100 * skill->GetLevel ());
...
#endif
      Skill4809Stub ():SkillStub (4809)
        {
            occupation = 105;
            name = L"Ä¾¼×Êõ£º°Ù½Ù";
            nativename = "Ä¾¼×Êõ£º°Ù½Ù";
            icon = "¿þÀÜÊõ£º°Ù½Ù.dds";
            maxlevel = 7;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
        ...
        {
            return (float) (skill->GetPlayer ()->GetLevel () * 2 + 20 * skill->GetLevel () + 30);
        }
        ...
        {
            static int array[5] = { 120, 124, 128, 132, 136 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetPlayer ()->GetLevel () * 2 + 20 * skill->GetLevel () + 30,
                               800 + 100 * skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->
                SetValue ((skill->GetLevel () * skill->GetPlayer ()->GetVar2 () +
                           skill->GetPlayer ()->GetBufflevel (4267) * skill->GetLevel () * (skill->GetPlayer ()->GetVar9 () * 0.007 +
                                                                                            skill->GetPlayer ()->GetMaxmp () * 0.003)) *
                          (skill->GetPlayer ()->GetVar4 () == 1 ? 1.1 : 1) * (1 + 0.1 * skill->GetT0 ()));
