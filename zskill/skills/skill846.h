#ifndef __CPPGEN_GNET_SKILL846
#define __CPPGEN_GNET_SKILL846
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill846:public Skill
    {
      public:
        enum
        { SKILL_ID = 846 };
          Skill846 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill846Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
