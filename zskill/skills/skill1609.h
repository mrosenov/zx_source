#ifndef __CPPGEN_GNET_SKILL1609
#define __CPPGEN_GNET_SKILL1609
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1609:public Skill
    {
      public:
        enum
        { SKILL_ID = 1609 };
          Skill1609 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1609Stub:public SkillStub
    {
      public:
        Skill1609Stub ():SkillStub (1609)
        {
            occupation = 149;
            name = L"Ä§Ö®¹Â×¢";
            nativename = "Ä§Ö®¹Â×¢";
