#ifndef __CPPGEN_GNET_SKILL4064
#define __CPPGEN_GNET_SKILL4064
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4064:public Skill
    {
      public:
        enum
        { SKILL_ID = 4064 };
          Skill4064 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4064Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4064Stub ():SkillStub (4064)
        {
            occupation = 130;
            name = L"Õæ¡¤¶áÆÇ·µ»ê";
            nativename = "Õæ¡¤¶áÆÇ·µ»ê";
            icon = "·ÉÉý¶áÆÇ·µ»ê.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
