#ifndef __CPPGEN_GNET_SKILL4050
#define __CPPGEN_GNET_SKILL4050
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4050:public Skill
    {
      public:
        enum
        { SKILL_ID = 4050 };
          Skill4050 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4050Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4050Stub ():SkillStub (4050)
        {
            occupation = 130;
            name = L"Õæ¡¤ËéÓñ»ÃÌì";
            nativename = "Õæ¡¤ËéÓñ»ÃÌì";
            icon = "·ÉÉýÇ§ÓðÀ×¹â.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
