#ifndef __CPPGEN_GNET_SKILL4663
#define __CPPGEN_GNET_SKILL4663
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4663:public Skill
    {
      public:
        enum
        { SKILL_ID = 4663 };
          Skill4663 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4663Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4663Stub ():SkillStub (4663)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetVar1 () * 0.005 * skill->GetLevel () * 5);
