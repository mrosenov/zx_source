#ifndef __CPPGEN_GNET_SKILL1795
#define __CPPGEN_GNET_SKILL1795
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1795:public Skill
    {
      public:
        enum
        { SKILL_ID = 1795 };
          Skill1795 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1795Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
