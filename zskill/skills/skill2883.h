#ifndef __CPPGEN_GNET_SKILL2883
#define __CPPGEN_GNET_SKILL2883
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2883:public Skill
    {
      public:
        enum
        { SKILL_ID = 2883 };
          Skill2883 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2883Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
