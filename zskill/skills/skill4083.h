#ifndef __CPPGEN_GNET_SKILL4083
#define __CPPGEN_GNET_SKILL4083
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4083:public Skill
    {
      public:
        enum
        { SKILL_ID = 4083 };
          Skill4083 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4083Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
