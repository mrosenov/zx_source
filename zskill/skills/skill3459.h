...
namespace GNET
{
    ...
    class Skill3459Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (80 + 5 * skill->GetLevel ());
      ...
      Skill3459Stub ():SkillStub (3459)
        ...
        {
            return _snwprintf (buffer, length, format, 80 + 5 * skill->GetLevel (), 2 * skill->GetLevel (), skill->GetLevel (), skill->GetLevel ());
            ...
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () >
                                                  (skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () +
                                                   ...
                                                   skill->GetPlayer ()->GetRes5 ())? skill->GetPlayer ()->GetVar1 () -
                                                  (skill->GetPlayer ()->GetRes1 () + skill->GetPlayer ()->GetRes2 () +
                                                   skill->GetPlayer ()->GetRes3 () + skill->GetPlayer ()->GetRes4 () +
                                                   skill->GetPlayer ()->GetRes5 ()) + 10 * skill->GetT1 () : 0));
            skill->GetVictim ()->SetTime (5000 * skill->GetT1 ());
            skill->GetVictim ()->SetRatio (1 + 0.3 * skill->GetT1 ());
            skill->GetVictim ()->SetValue (1 + 0.2 * skill->GetT1 ());
