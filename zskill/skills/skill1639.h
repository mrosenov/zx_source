#ifndef __CPPGEN_GNET_SKILL1639
#define __CPPGEN_GNET_SKILL1639
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1639:public Skill
    {
      public:
        enum
        { SKILL_ID = 1639 };
          Skill1639 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1639Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1639Stub ():SkillStub (1639)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (12000 + 100 + zrand (12000));
            skill->GetVictim ()->SetBuffid (0);
