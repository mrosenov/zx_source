#ifndef __CPPGEN_GNET_SKILL3130
#define __CPPGEN_GNET_SKILL3130
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3130:public Skill
    {
      public:
        enum
        { SKILL_ID = 3130 };
          Skill3130 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3130Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               12,
                               10 + skill->GetLevel (),
                               10 + skill->GetLevel (), 10 + skill->GetLevel (), 10 + skill->GetLevel (), 5 + skill->GetLevel ());
