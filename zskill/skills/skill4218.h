#ifndef __CPPGEN_GNET_SKILL4218
#define __CPPGEN_GNET_SKILL4218
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4218:public Skill
    {
      public:
        enum
        { SKILL_ID = 4218 };
          Skill4218 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4218Stub:public SkillStub
    {
      public:
        Skill4218Stub ():SkillStub (4218)
        {
            occupation = 130;
            name = L"殇落流华1";
            nativename = "殇落流华1";
