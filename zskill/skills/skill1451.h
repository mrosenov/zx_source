#ifndef __CPPGEN_GNET_SKILL1451
#define __CPPGEN_GNET_SKILL1451
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1451:public Skill
    {
      public:
        enum
        { SKILL_ID = 1451 };
          Skill1451 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1451Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1451Stub ():SkillStub (1451)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 9 * skill->GetLevel (), 30, 6, 8, 15, 30, 15);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.3 + 0.3 * norm (skill->GetLevel () / 90));
