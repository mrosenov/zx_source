#ifndef __CPPGEN_GNET_SKILL1255
#define __CPPGEN_GNET_SKILL1255
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1255:public Skill
    {
      public:
        enum
        { SKILL_ID = 1255 };
          Skill1255 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1255Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1255Stub ():SkillStub (1255)
        ...
        {
            return _snwprintf (buffer, length, format, 25 * skill->GetLevel (), 10 * skill->GetLevel (), 10 * skill->GetLevel ());
