#ifndef __CPPGEN_GNET_SKILL2343
#define __CPPGEN_GNET_SKILL2343
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2343:public Skill
    {
      public:
        enum
        { SKILL_ID = 2343 };
          Skill2343 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2343Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
