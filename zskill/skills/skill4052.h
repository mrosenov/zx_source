#ifndef __CPPGEN_GNET_SKILL4052
#define __CPPGEN_GNET_SKILL4052
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4052:public Skill
    {
      public:
        enum
        { SKILL_ID = 4052 };
          Skill4052 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4052Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4052Stub ():SkillStub (4052)
        {
            occupation = 130;
            name = L"Õæ¡¤Çý»¢Öð±ª";
            nativename = "Õæ¡¤Çý»¢Öð±ª";
            icon = "·ÉÉýÇý»¢Öð±ª.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
