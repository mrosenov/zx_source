#ifndef __CPPGEN_GNET_SKILL1696
#define __CPPGEN_GNET_SKILL1696
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1696:public Skill
    {
      public:
        enum
        { SKILL_ID = 1696 };
          Skill1696 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1696Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
