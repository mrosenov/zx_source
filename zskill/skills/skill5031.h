...
namespace GNET
{
    ...
    class Skill5031Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->GetPlayer ()->SetVar2 (skill->GetPlayer ()->GetSkilldodge ());
      ...
      Skill5031Stub ():SkillStub (5031)
        ...
        {
            return 90000 - 10000 * (norm (skill->GetLevel () / 30) + norm (skill->GetLevel () / 60) + norm (skill->GetLevel () / 90) +
                                    norm (skill->GetLevel () / 100)) - 1000 * skill->GetLevel () / 5;
        }
        ...
        {
            skill->GetVictim ()->SetRatio (zrand (100) < skill->GetPlayer ()->GetVar2 () / 10 ? 5031 : 0);
            skill->GetVictim ()->SetAmount (0);
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetClearcooldown (1);
            skill->GetVictim ()->SetProbability (1.0 * (zrand (100) < skill->GetPlayer ()->GetVar2 () / 10 ? 111 : 0));
            skill->GetVictim ()->SetTime (1);
            skill->GetVictim ()->SetRatio (0);
            skill->GetVictim ()->SetAmount (0);
            skill->GetVictim ()->SetValue (5031);
