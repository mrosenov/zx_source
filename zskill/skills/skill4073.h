#ifndef __CPPGEN_GNET_SKILL4073
#define __CPPGEN_GNET_SKILL4073
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4073:public Skill
    {
      public:
        enum
        { SKILL_ID = 4073 };
          Skill4073 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4073Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4073Stub ():SkillStub (4073)
        {
            occupation = 130;
            name = L"Õæ¡¤Áè»ğÃ÷Ñô";
            nativename = "Õæ¡¤Áè»ğÃ÷Ñô";
            icon = "·ÉÉıÁè»ğÃ÷Ñô.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
