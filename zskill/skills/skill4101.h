#ifndef __CPPGEN_GNET_SKILL4101
#define __CPPGEN_GNET_SKILL4101
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4101:public Skill
    {
      public:
        enum
        { SKILL_ID = 4101 };
          Skill4101 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4101Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (215 * skill->GetLevel () + 0.02 * skill->GetLevel () * skill->GetPlayer ()->GetMp () +
                                0.03 * skill->GetT1 () * skill->GetPlayer ()->GetDef ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4101Stub ():SkillStub (4101)
        {
            occupation = 130;
            name = L"真・逍遥如梦";
            nativename = "真・逍遥如梦";
