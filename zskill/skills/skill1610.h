#ifndef __CPPGEN_GNET_SKILL1610
#define __CPPGEN_GNET_SKILL1610
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1610:public Skill
    {
      public:
        enum
        { SKILL_ID = 1610 };
          Skill1610 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1610Stub:public SkillStub
    {
      public:
        Skill1610Stub ():SkillStub (1610)
        {
            occupation = 150;
            name = L"佛之苦海";
            nativename = "佛之苦海";
