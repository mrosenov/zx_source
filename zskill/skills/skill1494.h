#ifndef __CPPGEN_GNET_SKILL1494
#define __CPPGEN_GNET_SKILL1494
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1494:public Skill
    {
      public:
        enum
        { SKILL_ID = 1494 };
          Skill1494 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1494Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
