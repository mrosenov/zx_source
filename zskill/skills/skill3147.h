#ifndef __CPPGEN_GNET_SKILL3147
#define __CPPGEN_GNET_SKILL3147
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3147:public Skill
    {
      public:
        enum
        { SKILL_ID = 3147 };
          Skill3147 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3147Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (0.091 * skill->GetLevel () * skill->GetLevel () + 14 * skill->GetLevel () +
                                skill->GetPlayer ()->GetRes4 () * skill->GetJ0 () * (3 + 0.2 * skill->GetLevel ()) + 543 + 90 * skill->GetJ0 ());
...
#endif
      Skill3147Stub ():SkillStub (3147)
        {
            occupation = 169;
            name = L"神引：梅花三弄<禅>";
            nativename = "神引：梅花三弄<禅>";
            icon = "佛・神引：梅花三弄.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
