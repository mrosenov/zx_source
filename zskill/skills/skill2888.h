#ifndef __CPPGEN_GNET_SKILL2888
#define __CPPGEN_GNET_SKILL2888
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2888:public Skill
    {
      public:
        enum
        { SKILL_ID = 2888 };
          Skill2888 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2888Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
