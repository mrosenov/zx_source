      ...
      Skill4035Stub ():SkillStub (4035)
        {
            ...
            action[7] = "0";
            action[8] = "0";
            action[9] = "ÐùÔ¯_Ìì¹âÕó";
            action[10] = "0";
            action[11] = "0";
            action[12] = "0";
            action[13] = "";
            action[14] = "";
            action[15] = "ÐùÔ¯_Æï³Ë_Ìì¹âÕó";
            action[16] = "0";
            action[17] = "0";
            action[18] = "0";
            action[19] = "0";
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (4439);
            skill->GetVictim ()->SetValue (54000);
