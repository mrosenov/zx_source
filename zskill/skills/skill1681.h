#ifndef __CPPGEN_GNET_SKILL1681
#define __CPPGEN_GNET_SKILL1681
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1681:public Skill
    {
      public:
        enum
        { SKILL_ID = 1681 };
          Skill1681 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1681Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
