#ifndef __CPPGEN_GNET_SKILL2824
#define __CPPGEN_GNET_SKILL2824
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2824:public Skill
    {
      public:
        enum
        { SKILL_ID = 2824 };
          Skill2824 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2824Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
