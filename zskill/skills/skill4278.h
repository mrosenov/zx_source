#ifndef __CPPGEN_GNET_SKILL4278
#define __CPPGEN_GNET_SKILL4278
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4278:public Skill
    {
      public:
        enum
        { SKILL_ID = 4278 };
          Skill4278 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4278Stub:public SkillStub
    {
      public:
        Skill4278Stub ():SkillStub (4278)
        {
            occupation = 130;
            name = L"êØ»ÊÉñÍþ1";
            nativename = "êØ»ÊÉñÍþ1";
            icon = "";
            maxlevel = 5;
            maxlearn = 5;
            type = 3;
