#ifndef __CPPGEN_GNET_SKILL3079
#define __CPPGEN_GNET_SKILL3079
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3079:public Skill
    {
      public:
        enum
        { SKILL_ID = 3079 };
          Skill3079 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3079Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               33, 4, 2 + 0.5 * skill->GetLevel (), 5 * skill->GetLevel (), 2 * skill->GetLevel ());
