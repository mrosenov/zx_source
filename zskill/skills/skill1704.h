#ifndef __CPPGEN_GNET_SKILL1704
#define __CPPGEN_GNET_SKILL1704
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1704:public Skill
    {
      public:
        enum
        { SKILL_ID = 1704 };
          Skill1704 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1704Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
