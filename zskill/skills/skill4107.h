#ifndef __CPPGEN_GNET_SKILL4107
#define __CPPGEN_GNET_SKILL4107
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4107:public Skill
    {
      public:
        enum
        { SKILL_ID = 4107 };
          Skill4107 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4107Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4107Stub ():SkillStub (4107)
        {
            occupation = 130;
            name = L"Õæ¡¤°Ù¹ÇÖ®Öä";
            nativename = "Õæ¡¤°Ù¹ÇÖ®Öä";
            icon = "·ÉÉı°Ù¹ÇÖ®Öä.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
