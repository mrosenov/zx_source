...
namespace GNET
{
    ...
    class Skill1856Stub:public SkillStub
    {
      ...
      Skill1856Stub ():SkillStub (1856)
        ...
        {
            return _snwprintf (buffer, length, format, 40, 324 + 21 * skill->GetLevel (), 20, 1 + skill->GetLevel () / 9.0, 4);
