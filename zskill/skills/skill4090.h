#ifndef __CPPGEN_GNET_SKILL4090
#define __CPPGEN_GNET_SKILL4090
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4090:public Skill
    {
      public:
        enum
        { SKILL_ID = 4090 };
          Skill4090 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4090Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (215 * skill->GetLevel () * (skill->GetLevel () + zrand (50 + 249 * skill->GetLevel ())) * 0.01 +
                                0.03 * skill->GetT1 () * skill->GetPlayer ()->GetDef ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4090Stub ():SkillStub (4090)
        {
            occupation = 130;
            name = L"真・否极泰来";
            nativename = "真・否极泰来";
            ...
            talent_size = 2;
            action[0] = "鬼道_法宝_否极泰来";
            action[1] = "青云门_法宝_否极泰来";
            action[2] = "鬼王宗_法宝_否极泰来";
            action[3] = "合欢派_法宝_否极泰来";
            action[4] = "天音寺_法宝_否极泰来";
            action[5] = "鬼道_法宝_否极泰来";
            action[6] = "焚香谷_法宝_否极泰来";
            action[7] = "兽神_法宝_否极泰来";
            action[8] = "狐妖_法宝_否极泰来";
            action[9] = "轩辕_法宝_否极泰来";
            action[10] = "怀光_法宝_否极泰来";
            action[11] = "太昊_法宝_否极泰来";
            action[12] = "天华_法宝_否极泰来";
            action[13] = "灵夙_法宝_否极泰来";
            action[14] = "英招_法宝_否极泰来";
            action[15] = "鬼道_骑乘_法宝_否极泰来";
            action[16] = "青云门_骑乘_法宝_否极泰来";
            action[17] = "鬼王宗_骑乘_法宝_否极泰来";
            action[18] = "合欢派_骑乘_法宝_否极泰来";
            action[19] = "天音寺_骑乘_法宝_否极泰来";
            action[20] = "鬼道_骑乘_法宝_否极泰来";
            action[21] = "焚香谷_骑乘_法宝_否极泰来";
            action[22] = "兽神_骑乘_法宝_否极泰来";
            action[23] = "狐妖_骑乘_法宝_否极泰来";
            action[24] = "轩辕_骑乘_法宝_否极泰来";
            action[25] = "怀光_骑乘_法宝_否极泰来";
            action[26] = "太昊_骑乘_法宝_否极泰来";
            action[27] = "天华_骑乘_法宝_否极泰来";
            action[28] = "灵夙_骑乘_法宝_否极泰来";
            action[29] = "英招_骑乘_法宝_否极泰来";
            action[30] = "0";
            rangetype = 0;
            doenchant = true;
            dobless = true;
