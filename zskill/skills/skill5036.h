#ifndef __CPPGEN_GNET_SKILL5036
#define __CPPGEN_GNET_SKILL5036
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5036:public Skill
    {
      public:
        enum
        { SKILL_ID = 5036 };
          Skill5036 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5036Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
