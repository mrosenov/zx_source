...
namespace GNET
{
    ...
    class Skill2443Stub:public SkillStub
    {
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1.10 + 0.01 * skill->GetLevel () +
                                 (skill->GetPlayer ()->GetHp () * 2 <
                                  skill->GetPlayer ()->GetMaxhp ()? 0.1 * skill->GetT0 () : 0) + 0.08 * skill->GetC0 () * skill->GetT1 ());
      ...
      Skill2443Stub ():SkillStub (2443)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + skill->GetLevel (), 726 + 46 * skill->GetLevel (), 5 * skill->GetLevel ());
