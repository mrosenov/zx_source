#ifndef __CPPGEN_GNET_SKILL1328
#define __CPPGEN_GNET_SKILL1328
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1328:public Skill
    {
      public:
        enum
        { SKILL_ID = 1328 };
          Skill1328 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1328Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
