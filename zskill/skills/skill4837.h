#ifndef __CPPGEN_GNET_SKILL4837
#define __CPPGEN_GNET_SKILL4837
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4837:public Skill
    {
      public:
        enum
        { SKILL_ID = 4837 };
          Skill4837 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4837Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
