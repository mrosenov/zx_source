#ifndef __CPPGEN_GNET_SKILL1804
#define __CPPGEN_GNET_SKILL1804
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1804:public Skill
    {
      public:
        enum
        { SKILL_ID = 1804 };
          Skill1804 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1804Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
