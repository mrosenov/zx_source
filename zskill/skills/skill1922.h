#ifndef __CPPGEN_GNET_SKILL1922
#define __CPPGEN_GNET_SKILL1922
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1922:public Skill
    {
      public:
        enum
        { SKILL_ID = 1922 };
          Skill1922 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1922Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1922Stub ():SkillStub (1922)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (40000 + 20000 * skill->GetT0 ());
