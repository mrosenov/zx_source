#ifndef __CPPGEN_GNET_SKILL2437
#define __CPPGEN_GNET_SKILL2437
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2437:public Skill
    {
      public:
        enum
        { SKILL_ID = 2437 };
          Skill2437 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2437Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
