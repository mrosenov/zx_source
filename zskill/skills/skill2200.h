#ifndef __CPPGEN_GNET_SKILL2200
#define __CPPGEN_GNET_SKILL2200
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2200:public Skill
    {
      public:
        enum
        { SKILL_ID = 2200 };
          Skill2200 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2200Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
