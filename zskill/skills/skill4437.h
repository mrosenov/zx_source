    ...
    class Skill4437Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetVar1 (skill->GetPlayer ()->GetMaxmp () * skill->GetPlayer ()->GetDodge () / 50 +
                                              skill->GetPlayer ()->GetMaxatk () * skill->GetPlayer ()->GetDodge () / 10);
      ...
      Skill4437Stub ():SkillStub (4437)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetVar1 ());
