#ifndef __CPPGEN_GNET_SKILL2040
#define __CPPGEN_GNET_SKILL2040
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2040:public Skill
    {
      public:
        enum
        { SKILL_ID = 2040 };
          Skill2040 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2040Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 40000 };
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((skill->GetPlayer ()->GetCultivation () == 4 ? 2 : 1) * (0.05 + 0.005 * skill->GetLevel ()) *
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetCultivation () == 4 ? 120 : 0));
