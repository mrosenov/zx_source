#ifndef __CPPGEN_GNET_SKILL1205
#define __CPPGEN_GNET_SKILL1205
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1205:public Skill
    {
      public:
        enum
        { SKILL_ID = 1205 };
          Skill1205 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1205Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
