#ifndef __CPPGEN_GNET_SKILL2371
#define __CPPGEN_GNET_SKILL2371
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2371:public Skill
    {
      public:
        enum
        { SKILL_ID = 2371 };
          Skill2371 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2371Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
