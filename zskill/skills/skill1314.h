#ifndef __CPPGEN_GNET_SKILL1314
#define __CPPGEN_GNET_SKILL1314
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1314:public Skill
    {
      public:
        enum
        { SKILL_ID = 1314 };
          Skill1314 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1314Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
