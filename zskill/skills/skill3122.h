#ifndef __CPPGEN_GNET_SKILL3122
#define __CPPGEN_GNET_SKILL3122
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3122:public Skill
    {
      public:
        enum
        { SKILL_ID = 3122 };
          Skill3122 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3122Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               2 + 0.5 * skill->GetLevel (), 15, 50 + skill->GetLevel (), 3, 10 + skill->GetLevel (), 10, skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (220 + INT (zrand (100 + 0.5 * skill->GetLevel ()) / 100) * 2902);
            skill->GetVictim ()->SetAmount (220);
            skill->GetVictim ()->SetValue (220);
