#ifndef __CPPGEN_GNET_SKILL3167
#define __CPPGEN_GNET_SKILL3167
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3167:public Skill
    {
      public:
        enum
        { SKILL_ID = 3167 };
          Skill3167 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3167Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
