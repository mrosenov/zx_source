#ifndef __CPPGEN_GNET_SKILL2431
#define __CPPGEN_GNET_SKILL2431
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2431:public Skill
    {
      public:
        enum
        { SKILL_ID = 2431 };
          Skill2431 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2431Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2431Stub ():SkillStub (2431)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetSharelifewithclone (1);
