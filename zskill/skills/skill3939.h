#ifndef __CPPGEN_GNET_SKILL3939
#define __CPPGEN_GNET_SKILL3939
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3939:public Skill
    {
      public:
        enum
        { SKILL_ID = 3939 };
          Skill3939 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3939Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3939Stub ():SkillStub (3939)
        {
            occupation = 128;
            name = L"爬塔-随机进入不利状态";
            nativename = "爬塔-随机进入不利状态";
            icon = "";
            maxlevel = 99;
            maxlearn = 99;
            type = 1;
