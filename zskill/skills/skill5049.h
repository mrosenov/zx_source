#ifndef __CPPGEN_GNET_SKILL5049
#define __CPPGEN_GNET_SKILL5049
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5049:public Skill
    {
      public:
        enum
        { SKILL_ID = 5049 };
          Skill5049 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5049Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (3 + 0.05 * 2 + 0.16 * INT (skill->GetPlayer ()->GetMp () / (0.95 - 0.1 * 2) / skill->GetPlayer ()->GetMaxmp ()) +
