#ifndef __CPPGEN_GNET_SKILL3265
#define __CPPGEN_GNET_SKILL3265
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3265:public Skill
    {
      public:
        enum
        { SKILL_ID = 3265 };
          Skill3265 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3265Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1 + 4 * norm (zrand (118) / 100.0));
      ...
      Skill3265Stub ():SkillStub (3265)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (zrand (300) + 200));
