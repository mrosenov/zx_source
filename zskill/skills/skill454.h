#ifndef __CPPGEN_GNET_SKILL454
#define __CPPGEN_GNET_SKILL454
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill454:public Skill
    {
      public:
        enum
        { SKILL_ID = 454 };
          Skill454 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill454Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
