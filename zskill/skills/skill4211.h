#ifndef __CPPGEN_GNET_SKILL4211
#define __CPPGEN_GNET_SKILL4211
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4211:public Skill
    {
      public:
        enum
        { SKILL_ID = 4211 };
          Skill4211 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4211Stub:public SkillStub
    {
      public:
        Skill4211Stub ():SkillStub (4211)
        {
            occupation = 130;
            name = L"¶áÆÇ·µ»ê2";
            nativename = "¶áÆÇ·µ»ê2";
