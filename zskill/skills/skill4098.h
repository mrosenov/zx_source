#ifndef __CPPGEN_GNET_SKILL4098
#define __CPPGEN_GNET_SKILL4098
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4098:public Skill
    {
      public:
        enum
        { SKILL_ID = 4098 };
          Skill4098 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4098Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
