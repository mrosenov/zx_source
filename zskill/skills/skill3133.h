#ifndef __CPPGEN_GNET_SKILL3133
#define __CPPGEN_GNET_SKILL3133
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3133:public Skill
    {
      public:
        enum
        { SKILL_ID = 3133 };
          Skill3133 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3133Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
