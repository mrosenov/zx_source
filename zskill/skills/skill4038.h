#ifndef __CPPGEN_GNET_SKILL4038
#define __CPPGEN_GNET_SKILL4038
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4038:public Skill
    {
      public:
        enum
        { SKILL_ID = 4038 };
          Skill4038 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4038Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () ==
                                                  1 ? (skill->GetPlayer ()->GetVar2 () + 10 * skill->GetLevel () + 10 * skill->GetT0 ()) : 0));
            ...
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetVar1 () ==
                                                  1 ? (skill->GetPlayer ()->GetVar3 () + 10 * skill->GetLevel () + 10 * skill->GetT0 ()) : 0));
            skill->GetVictim ()->SetTime (4000);
