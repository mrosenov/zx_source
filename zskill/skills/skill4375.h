      ...
      public:
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               10 + 3 * skill->GetLevel (), 5 + skill->GetLevel () * 3, 5 + skill->GetLevel () * 3, 10 + 2 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (1000 * (10 + 3 * skill->GetLevel ()));
            skill->GetVictim ()->SetRatio (0.01 * (5 + skill->GetLevel () * 3));
