#ifndef __CPPGEN_GNET_SKILL4056
#define __CPPGEN_GNET_SKILL4056
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4056:public Skill
    {
      public:
        enum
        { SKILL_ID = 4056 };
          Skill4056 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4056Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4056Stub ():SkillStub (4056)
        {
            occupation = 130;
            name = L"Õæ¡¤ÐÌÌìÅ­À×";
            nativename = "Õæ¡¤ÐÌÌìÅ­À×";
            icon = "·ÉÉýÐÌÌìÅ­À×.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
