#ifndef __CPPGEN_GNET_SKILL2789
#define __CPPGEN_GNET_SKILL2789
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2789:public Skill
    {
      public:
        enum
        { SKILL_ID = 2789 };
          Skill2789 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2789Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2789Stub ():SkillStub (2789)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (zrand (100) < 60 ? 300 : 0));
