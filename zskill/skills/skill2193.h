#ifndef __CPPGEN_GNET_SKILL2193
#define __CPPGEN_GNET_SKILL2193
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2193:public Skill
    {
      public:
        enum
        { SKILL_ID = 2193 };
          Skill2193 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2193Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
