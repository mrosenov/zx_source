#ifndef __CPPGEN_GNET_SKILL2825
#define __CPPGEN_GNET_SKILL2825
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2825:public Skill
    {
      public:
        enum
        { SKILL_ID = 2825 };
          Skill2825 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2825Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
