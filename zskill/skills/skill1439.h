#ifndef __CPPGEN_GNET_SKILL1439
#define __CPPGEN_GNET_SKILL1439
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1439:public Skill
    {
      public:
        enum
        { SKILL_ID = 1439 };
          Skill1439 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1439Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (9 * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill1439Stub ():SkillStub (1439)
        {
            occupation = 145;
            name = L"³ÁÂÙ<ÍÁê×>";
            nativename = "³ÁÂÙ<ÍÁê×>";
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 9 * skill->GetLevel (), 2, 6, 8, 15, 30, 15, 6);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.02 + 0.06 * norm (skill->GetLevel () / 90));
