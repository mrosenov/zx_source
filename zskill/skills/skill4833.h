#ifndef __CPPGEN_GNET_SKILL4833
#define __CPPGEN_GNET_SKILL4833
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4833:public Skill
    {
      public:
        enum
        { SKILL_ID = 4833 };
          Skill4833 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4833Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4833Stub ():SkillStub (4833)
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.01 * 2 * skill->GetLevel () + 0.0001);
