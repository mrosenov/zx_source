#ifndef __CPPGEN_GNET_SKILL1601
#define __CPPGEN_GNET_SKILL1601
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1601:public Skill
    {
      public:
        enum
        { SKILL_ID = 1601 };
          Skill1601 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1601Stub:public SkillStub
    {
      public:
        Skill1601Stub ():SkillStub (1601)
        {
            occupation = 148;
            name = L"道之风骨";
            nativename = "道之风骨";
 ...
 80000 };
        ...
        {
            skill->GetPlayer ()->SetPasdechurt3 (0.01005 * skill->GetLevel ());
            return true;
        }
#endif
    };
