#ifndef __CPPGEN_GNET_SKILL2036
#define __CPPGEN_GNET_SKILL2036
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2036:public Skill
    {
      public:
        enum
        { SKILL_ID = 2036 };
          Skill2036 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2036Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 40000 };
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((skill->GetPlayer ()->GetCultivation () == 1 ? 2 : 1) * (0.05 + 0.005 * skill->GetLevel ()) *
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetCultivation () == 1 ? 120 : 0));
