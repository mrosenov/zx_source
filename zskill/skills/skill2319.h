#ifndef __CPPGEN_GNET_SKILL2319
#define __CPPGEN_GNET_SKILL2319
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2319:public Skill
    {
      public:
        enum
        { SKILL_ID = 2319 };
          Skill2319 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2319Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
