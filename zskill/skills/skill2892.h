#ifndef __CPPGEN_GNET_SKILL2892
#define __CPPGEN_GNET_SKILL2892
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2892:public Skill
    {
      public:
        enum
        { SKILL_ID = 2892 };
          Skill2892 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2892Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2892Stub ():SkillStub (2892)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (2.6);
            skill->GetVictim ()->SetAddspeed (1);
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetType () == 0 ? 80 : 0));
