#ifndef __CPPGEN_GNET_SKILL3025
#define __CPPGEN_GNET_SKILL3025
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3025:public Skill
    {
      public:
        enum
        { SKILL_ID = 3025 };
          Skill3025 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3025Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3025Stub ():SkillStub (3025)
        {
            occupation = 167;
            name = L"À×Òô·¨ÚÍ<Ğş>";
            nativename = "À×Òô·¨ÚÍ<Ğş>";
            icon = "ÏÉ¡¤À×Òô·¨ÚÍ.dds";
            maxlevel = 20;
            maxlearn = 20;
            type = 1;
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               60 + 0.5 * skill->GetLevel (), 6, 32 * skill->GetLevel (), 0.6 * skill->GetLevel ());
