#ifndef __CPPGEN_GNET_SKILL4078
#define __CPPGEN_GNET_SKILL4078
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4078:public Skill
    {
      public:
        enum
        { SKILL_ID = 4078 };
          Skill4078 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4078Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4078Stub ():SkillStub (4078)
        {
            occupation = 130;
            name = L"Õæ¡¤×ÓÎçÐÄ»ê";
            nativename = "Õæ¡¤×ÓÎçÐÄ»ê";
            icon = "·ÉÉý×ÓÎçÐÄ»ê.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
            eventflag = 0;
