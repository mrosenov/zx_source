#ifndef __CPPGEN_GNET_SKILL2887
#define __CPPGEN_GNET_SKILL2887
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2887:public Skill
    {
      public:
        enum
        { SKILL_ID = 2887 };
          Skill2887 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2887Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
