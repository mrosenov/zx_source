#ifndef __CPPGEN_GNET_SKILL1638
#define __CPPGEN_GNET_SKILL1638
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1638:public Skill
    {
      public:
        enum
        { SKILL_ID = 1638 };
          Skill1638 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1638Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1638Stub ():SkillStub (1638)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (15000 + 15000 + 100);
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetAmount (30 * skill->GetPlayer ()->GetLevel () - 15 * skill->GetPlayer ()->GetLevel () * norm (zrand (100) / 90));
