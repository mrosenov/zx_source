#ifndef __CPPGEN_GNET_SKILL3037
#define __CPPGEN_GNET_SKILL3037
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3037:public Skill
    {
      public:
        enum
        { SKILL_ID = 3037 };
          Skill3037 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3037Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1237600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               354, 2 + 0.5 * skill->GetLevel (), 5 * skill->GetLevel (), skill->GetLevel (), 10 + 2 * skill->GetLevel ());
