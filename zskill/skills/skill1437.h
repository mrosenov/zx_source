#ifndef __CPPGEN_GNET_SKILL1437
#define __CPPGEN_GNET_SKILL1437
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1437:public Skill
    {
      public:
        enum
        { SKILL_ID = 1437 };
          Skill1437 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1437Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (12 * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill1437Stub ():SkillStub (1437)
        {
            occupation = 145;
            name = L"ÉËºÛ<ÍÁê×>";
            nativename = "ÉËºÛ<ÍÁê×>";
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 12 * skill->GetLevel (), 4, 15, 30, 15);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (norm (zrand (100) / 95) * 600 * norm (skill->GetLevel () / 90)));
