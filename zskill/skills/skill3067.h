#ifndef __CPPGEN_GNET_SKILL3067
#define __CPPGEN_GNET_SKILL3067
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3067:public Skill
    {
      public:
        enum
        { SKILL_ID = 3067 };
          Skill3067 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3067Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1 + 0.05 * skill->GetLevel () + norm (skill->GetLevel () / 14.9) * 0.03 * (skill->GetLevel () - 15) +
                                 (0.05 + 0.05 * int (skill->GetPlayer ()->GetSkilllevel (234) / 9) +
                                  ...
                                  0.05 * int (skill->GetPlayer ()->GetSkilllevel (786) / 1.9)) *skill->GetT3 () +
