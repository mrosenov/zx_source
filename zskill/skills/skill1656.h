#ifndef __CPPGEN_GNET_SKILL1656
#define __CPPGEN_GNET_SKILL1656
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1656:public Skill
    {
      public:
        enum
        { SKILL_ID = 1656 };
          Skill1656 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1656Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
