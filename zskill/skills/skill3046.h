#ifndef __CPPGEN_GNET_SKILL3046
#define __CPPGEN_GNET_SKILL3046
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3046:public Skill
    {
      public:
        enum
        { SKILL_ID = 3046 };
          Skill3046 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3046Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (244 + 10 * skill->GetLevel () + skill->GetPlayer ()->GetHp () * 0.05 * skill->GetT0 () +
                                skill->GetPlayer ()->GetRes2 () * (2 + skill->GetLevel ()));
                skill->GetPlayer ()->SetHp (skill->GetPlayer ()->GetHp () * (1 - 0.05 * skill->GetT0 ()));
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill3046Stub ():SkillStub (3046)
        {
            occupation = 167;
            name = L"ÌìÖï<Ðþ>";
            nativename = "ÌìÖï<Ðþ>";
