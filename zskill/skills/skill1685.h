#ifndef __CPPGEN_GNET_SKILL1685
#define __CPPGEN_GNET_SKILL1685
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1685:public Skill
    {
      public:
        enum
        { SKILL_ID = 1685 };
          Skill1685 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1685Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1685Stub ():SkillStub (1685)
        {
            occupation = 146;
            name = L"Ôø¼Ç·ñ£ºèó";
            nativename = "Ôø¼Ç·ñ£ºèó";
            icon = "Ôø¼Ç·ñ.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 1;
