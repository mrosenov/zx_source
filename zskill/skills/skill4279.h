...
namespace GNET
{
    ...
    class Skill4279Stub:public SkillStub
    {
      public:
        ...
        {
            return _snwprintf (buffer, length, format, 8 + 4 * skill->GetLevel () + (skill->GetLevel () == 5 ? 10 : 0), 2 + skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetOccupation () ==
                                                  43 ? (8 + 4 * skill->GetLevel () + (skill->GetLevel () == 5 ? 10 : 0)) : (5 + skill->GetLevel () +
                                                                                                                            (skill->GetLevel () ==
                                                                                                                             5 ? 5 : 0))));
