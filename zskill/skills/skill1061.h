#ifndef __CPPGEN_GNET_SKILL1061
#define __CPPGEN_GNET_SKILL1061
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1061:public Skill
    {
      public:
        enum
        { SKILL_ID = 1061 };
          Skill1061 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1061Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
