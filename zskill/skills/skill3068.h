#ifndef __CPPGEN_GNET_SKILL3068
#define __CPPGEN_GNET_SKILL3068
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3068:public Skill
    {
      public:
        enum
        { SKILL_ID = 3068 };
          Skill3068 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3068Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.05 * skill->GetLevel () + norm (skill->GetLevel () / 14.9) * 0.03 * (skill->GetLevel () - 15) +
                                 (0.05 + 0.05 * int (skill->GetPlayer ()->GetSkilllevel (234) / 9) +
                                  ...
                                  0.05 * norm (skill->GetPlayer ()->GetSkilllevel (3067) / 0.9)) *skill->GetT2 ());
      ...
      Skill3068Stub ():SkillStub (3068)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               4 * skill->GetLevel (),
                               2 * skill->GetLevel (),
                               6, 550 + 10 * skill->GetLevel (), 6, skill->GetLevel (), 12 + 4 * skill->GetLevel (), 0.5 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetRatio (220 + INT (zrand (100 + 2 * skill->GetLevel ()) / 100) * 2848);
            ...
            skill->GetVictim ()->SetRatio (0.005 * skill->GetLevel ());
