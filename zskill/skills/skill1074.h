#ifndef __CPPGEN_GNET_SKILL1074
#define __CPPGEN_GNET_SKILL1074
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1074:public Skill
    {
      public:
        enum
        { SKILL_ID = 1074 };
          Skill1074 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1074Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1074Stub ():SkillStub (1074)
        {
            occupation = 128;
            name = L"BossÆÕÖÇD";
            nativename = "BossÆÕÖÇD";
            icon = "";
            maxlevel = 500;
            maxlearn = 10;
            type = 1;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (1800 * skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (0);
            skill->GetVictim ()->SetAmount (0.5 * skill->GetPlayer ()->GetMaxhp () + 1);
