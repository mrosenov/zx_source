#ifndef __CPPGEN_GNET_SKILL1665
#define __CPPGEN_GNET_SKILL1665
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1665:public Skill
    {
      public:
        enum
        { SKILL_ID = 1665 };
          Skill1665 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1665Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1665Stub ():SkillStub (1665)
        {
            occupation = 146;
            name = L"Ôø¼Ç·ñ£ºÃî";
            nativename = "Ôø¼Ç·ñ£ºÃî";
            icon = "Ôø¼Ç·ñ.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 1;
