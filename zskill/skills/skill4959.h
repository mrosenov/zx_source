#ifndef __CPPGEN_GNET_SKILL4959
#define __CPPGEN_GNET_SKILL4959
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4959:public Skill
    {
      public:
        enum
        { SKILL_ID = 4959 };
          Skill4959 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4959Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4959Stub ():SkillStub (4959)
        {
            occupation = 130;
            name = L"Õæ¡¤½Ù×ªÁúÒ÷";
            nativename = "Õæ¡¤½Ù×ªÁúÒ÷";
            icon = "½Ù×ªÒ÷.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
