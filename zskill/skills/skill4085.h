#ifndef __CPPGEN_GNET_SKILL4085
#define __CPPGEN_GNET_SKILL4085
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4085:public Skill
    {
      public:
        enum
        { SKILL_ID = 4085 };
          Skill4085 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4085Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.06 * skill->GetLevel () + 0.02 * INT (skill->GetPlayer ()->GetLevel () / (9 - skill->GetLevel ())));
                skill->SetPlus (500 * skill->GetLevel ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4085Stub ():SkillStub (4085)
        {
            occupation = 130;
            name = L"Õæ¡¤Íö»êÉ¥ÆÇ";
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               6 * skill->GetLevel (),
                               9 - skill->GetLevel (),
                               745 - 35 * skill->GetLevel () - skill->GetLevel () * skill->GetLevel (), 6.3 - 0.3 * skill->GetLevel ());
