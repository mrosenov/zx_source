#ifndef __CPPGEN_GNET_SKILL5272
#define __CPPGEN_GNET_SKILL5272
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5272:public Skill
    {
      public:
        enum
        { SKILL_ID = 5272 };
          Skill5272 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5272Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetCrit (0.05 * skill->GetT0 () +
                                0.01 * skill->GetLevel () * skill->GetPlayer ()->GetRage () / skill->GetPlayer ()->GetMaxhp ());
                skill->SetRatio (2);
      ...
      Skill5272Stub ():SkillStub (5272)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               100, 50 + skill->GetLevel (), skill->GetLevel (), 90);
