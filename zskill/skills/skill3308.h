#ifndef __CPPGEN_GNET_SKILL3308
#define __CPPGEN_GNET_SKILL3308
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3308:public Skill
    {
      public:
        enum
        { SKILL_ID = 3308 };
          Skill3308 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3308Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
