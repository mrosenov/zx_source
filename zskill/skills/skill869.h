#ifndef __CPPGEN_GNET_SKILL869
#define __CPPGEN_GNET_SKILL869
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill869:public Skill
    {
      public:
        enum
        { SKILL_ID = 869 };
          Skill869 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill869Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
