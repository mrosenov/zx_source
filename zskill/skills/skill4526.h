#ifndef __CPPGEN_GNET_SKILL4526
#define __CPPGEN_GNET_SKILL4526
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4526:public Skill
    {
      public:
        enum
        { SKILL_ID = 4526 };
          Skill4526 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4526Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
