#ifndef __CPPGEN_GNET_SKILL2452
#define __CPPGEN_GNET_SKILL2452
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2452:public Skill
    {
      public:
        enum
        { SKILL_ID = 2452 };
          Skill2452 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2452Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2452Stub ():SkillStub (2452)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 4 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetT0 () > 0 ? (10000 + 4000 * skill->GetLevel ()) : 100);
