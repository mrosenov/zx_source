#ifndef __CPPGEN_GNET_SKILL4192
#define __CPPGEN_GNET_SKILL4192
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4192:public Skill
    {
      public:
        enum
        { SKILL_ID = 4192 };
          Skill4192 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4192Stub:public SkillStub
    {
      public:
        Skill4192Stub ():SkillStub (4192)
        {
            occupation = 130;
            name = L"ÐÌÌìÅ­À×2";
            nativename = "ÐÌÌìÅ­À×2";
            icon = "";
            maxlevel = 5;
            maxlearn = 5;
            type = 3;
