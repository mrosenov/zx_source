...
namespace GNET
{
    ...
    class Skill1285Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1 + 0.16 * norm (skill->GetLevel () / 30) + 0.16 * norm (skill->GetLevel () / 60));
      ...
      Skill1285Stub ():SkillStub (1285)
        ...
        {
            return _snwprintf (buffer, length, format, 14 + 3 * skill->GetLevel (), 15 * skill->GetLevel (), 6, 16, 32);
