#ifndef __CPPGEN_GNET_SKILL3175
#define __CPPGEN_GNET_SKILL3175
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3175:public Skill
    {
      public:
        enum
        { SKILL_ID = 3175 };
          Skill3175 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3175Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3175Stub ():SkillStub (3175)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetTmplid () == 41994 ? 100 : 0));
            skill->GetVictim ()->SetValue (140000 + zrand (10000));
