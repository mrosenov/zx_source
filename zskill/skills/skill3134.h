#ifndef __CPPGEN_GNET_SKILL3134
#define __CPPGEN_GNET_SKILL3134
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3134:public Skill
    {
      public:
        enum
        { SKILL_ID = 3134 };
          Skill3134 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3134Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
 ...
 1344300 };
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (0.01 * skill->GetLevel () * skill->GetPlayer ()->GetRes4 ());
