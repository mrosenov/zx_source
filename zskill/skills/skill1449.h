#ifndef __CPPGEN_GNET_SKILL1449
#define __CPPGEN_GNET_SKILL1449
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1449:public Skill
    {
      public:
        enum
        { SKILL_ID = 1449 };
          Skill1449 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1449Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1449Stub ():SkillStub (1449)
        ...
        {
            return _snwprintf (buffer, length, format, 10 + 5 * skill->GetLevel (), 13 * skill->GetLevel (), 4, 15, 30, 15, 30, 12);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (12000 * norm (skill->GetLevel () / 90) + 100);
