#ifndef __CPPGEN_GNET_SKILL3791
#define __CPPGEN_GNET_SKILL3791
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3791:public Skill
    {
      public:
        enum
        { SKILL_ID = 3791 };
          Skill3791 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3791Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
