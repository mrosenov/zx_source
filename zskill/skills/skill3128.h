...
namespace GNET
{
    ...
    class Skill3128Stub:public SkillStub
    {
      ...
      Skill3128Stub ():SkillStub (3128)
        ...
        {
            return (int) (100 + 5 * skill->GetLevel ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               2,
                               skill->GetLevel (),
                               4, 60 + 2 * skill->GetLevel (), 12, 33, 25, 25, 5, 1 + 0.2 * skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetPlayer ()->GetHp () <
                                          0.6 * skill->GetPlayer ()->GetMaxhp ()? 1000 + 200 * skill->GetLevel () : 0);
