#ifndef __CPPGEN_GNET_SKILL2776
#define __CPPGEN_GNET_SKILL2776
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2776:public Skill
    {
      public:
        enum
        { SKILL_ID = 2776 };
          Skill2776 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2776Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2776Stub ():SkillStub (2776)
        {
            occupation = 128;
            name = L"ÊÞÉñ¹éÀ´-ÑªÊ¨4";
            nativename = "ÊÞÉñ¹éÀ´-ÑªÊ¨4";
            icon = "";
            maxlevel = 500;
            maxlearn = 500;
            type = 1;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (20000);
            skill->GetVictim ()->SetAmount (5000 * skill->GetLevel ());
