#ifndef __CPPGEN_GNET_SKILL3138
#define __CPPGEN_GNET_SKILL3138
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3138:public Skill
    {
      public:
        enum
        { SKILL_ID = 3138 };
          Skill3138 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3138Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
