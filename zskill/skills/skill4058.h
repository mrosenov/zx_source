#ifndef __CPPGEN_GNET_SKILL4058
#define __CPPGEN_GNET_SKILL4058
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4058:public Skill
    {
      public:
        enum
        { SKILL_ID = 4058 };
          Skill4058 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4058Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (1 + 0.08 * skill->GetLevel () + 0.1 * skill->GetT0 () +
                                 0.02 * INT (skill->GetPlayer ()->GetLevel () / (9 - skill->GetLevel ())));
                skill->SetPlus (300 * skill->GetLevel () + 0.03 * skill->GetT1 () * skill->GetPlayer ()->GetDef ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4058Stub ():SkillStub (4058)
        {
            occupation = 130;
            name = L"真・四灵血咒";
            nativename = "真・四灵血咒";
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "鬼王宗_骑乘_法宝_四灵幡";
            action[16] = "鬼王宗_骑乘_法宝_四灵幡";
            action[17] = "鬼王宗_骑乘_法宝_四灵幡";
            action[18] = "鬼王宗_骑乘_法宝_四灵幡";
            action[19] = "鬼王宗_骑乘_法宝_四灵幡";
            action[20] = "鬼王宗_骑乘_法宝_四灵幡";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
