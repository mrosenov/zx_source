#ifndef __CPPGEN_GNET_SKILL1786
#define __CPPGEN_GNET_SKILL1786
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1786:public Skill
    {
      public:
        enum
        { SKILL_ID = 1786 };
          Skill1786 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1786Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
