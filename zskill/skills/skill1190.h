#ifndef __CPPGEN_GNET_SKILL1190
#define __CPPGEN_GNET_SKILL1190
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1190:public Skill
    {
      public:
        enum
        { SKILL_ID = 1190 };
          Skill1190 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1190Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1190Stub ():SkillStub (1190)
        {
            occupation = 128;
            name = L"Ð¡Ãî³áÄñdebuff";
            nativename = "Ð¡Ãî³áÄñdebuff";
            icon = "";
            maxlevel = 500;
            maxlearn = 10;
            type = 3;
