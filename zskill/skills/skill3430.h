#ifndef __CPPGEN_GNET_SKILL3430
#define __CPPGEN_GNET_SKILL3430
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3430:public Skill
    {
      public:
        enum
        { SKILL_ID = 3430 };
          Skill3430 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3430Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3430Stub ():SkillStub (3430)
        ...
        {
            return _snwprintf (buffer, length, format, 240 - 40 * skill->GetLevel (), 15 * skill->GetLevel (), 0.5 * skill->GetLevel (), 6);
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (15 * skill->GetLevel () + 5 * skill->GetT0 ()));
