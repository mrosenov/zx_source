#ifndef __CPPGEN_GNET_SKILL1659
#define __CPPGEN_GNET_SKILL1659
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1659:public Skill
    {
      public:
        enum
        { SKILL_ID = 1659 };
          Skill1659 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1659Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
