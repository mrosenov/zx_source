...
namespace GNET
{
    ...
    class Skill5088Stub:public SkillStub
    {
      ...
      Skill5088Stub ():SkillStub (5088)
        ...
        {
            return _snwprintf (buffer, length, format, 900 + 45 * 5, 15 * 5, 13 * 5, 15 + 5);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (15000 + 5 * 1000 + 1000 * 2);
            skill->GetVictim ()->SetRatio (0.15 * 5);
            skill->GetVictim ()->SetDecdamage (1);
            skill->GetVictim ()->SetProbability (1.0 * (13 * 5 + 2 * 2 + 2));
            skill->GetVictim ()->SetTime (15000 + 5 * 1000 + 1000 * 2 + 2000 * norm (2));
