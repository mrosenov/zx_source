#ifndef __CPPGEN_GNET_SKILL4076
#define __CPPGEN_GNET_SKILL4076
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4076:public Skill
    {
      public:
        enum
        { SKILL_ID = 4076 };
          Skill4076 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4076Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4076Stub ():SkillStub (4076)
        {
            occupation = 130;
            name = L"Õæ¡¤ÆÆ»êÇ§½Ù";
            nativename = "Õæ¡¤ÆÆ»êÇ§½Ù";
            icon = "·ÉÉýÆÆ»êÇ§½Ù.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
