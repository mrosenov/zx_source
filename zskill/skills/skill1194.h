#ifndef __CPPGEN_GNET_SKILL1194
#define __CPPGEN_GNET_SKILL1194
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1194:public Skill
    {
      public:
        enum
        { SKILL_ID = 1194 };
          Skill1194 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1194Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
