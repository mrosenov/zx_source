#ifndef __CPPGEN_GNET_SKILL1493
#define __CPPGEN_GNET_SKILL1493
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1493:public Skill
    {
      public:
        enum
        { SKILL_ID = 1493 };
          Skill1493 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1493Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
