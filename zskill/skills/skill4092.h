#ifndef __CPPGEN_GNET_SKILL4092
#define __CPPGEN_GNET_SKILL4092
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4092:public Skill
    {
      public:
        enum
        { SKILL_ID = 4092 };
          Skill4092 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4092Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
