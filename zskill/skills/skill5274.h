#ifndef __CPPGEN_GNET_SKILL5274
#define __CPPGEN_GNET_SKILL5274
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5274:public Skill
    {
      public:
        enum
        { SKILL_ID = 5274 };
          Skill5274 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5274Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetVar3 (skill->GetPlayer ()->GetSkilllevel (5197));
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 ((skill->GetPlayer ()->GetType () == 0
                                                   && skill->GetPlayer ()->GetVar3 () > 0) ? skill->GetPlayer ()->GetVar1 () : 0));
