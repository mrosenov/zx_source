#ifndef __CPPGEN_GNET_SKILL1892
#define __CPPGEN_GNET_SKILL1892
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1892:public Skill
    {
      public:
        enum
        { SKILL_ID = 1892 };
          Skill1892 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1892Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1892Stub ():SkillStub (1892)
        ...
        {
            return _snwprintf (buffer, length, format, 133 + 10 * skill->GetLevel (), 15 + 5 * skill->GetLevel (), 4, 50 + 5 * skill->GetLevel ());
