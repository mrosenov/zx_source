#ifndef __CPPGEN_GNET_SKILL2983
#define __CPPGEN_GNET_SKILL2983
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2983:public Skill
    {
      public:
        enum
        { SKILL_ID = 2983 };
          Skill2983 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2983Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2983Stub ():SkillStub (2983)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (40885);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (2979);
            skill->GetVictim ()->SetAmount (2981);
