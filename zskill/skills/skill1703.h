#ifndef __CPPGEN_GNET_SKILL1703
#define __CPPGEN_GNET_SKILL1703
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1703:public Skill
    {
      public:
        enum
        { SKILL_ID = 1703 };
          Skill1703 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1703Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1703Stub ():SkillStub (1703)
        {
            occupation = 146;
            name = L"ÍíÀ´Çï£º°µ";
            nativename = "ÍíÀ´Çï£º°µ";
            icon = "ÍíÀ´Çï.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 2;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (300000 + 100);
