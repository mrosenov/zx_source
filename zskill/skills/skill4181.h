...
namespace GNET
{
    ...
    class Skill4181Stub:public SkillStub
    {
      public:
        ...
        {
            return _snwprintf (buffer, length, format, 54 + 6 * skill->GetLevel (), 2 + skill->GetLevel (), 6 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 *
                                                 (skill->GetPlayer ()->GetHasmultbuff (113) == 1
                                                  && zrand (100) <
                                                  (54 + 6 * skill->GetLevel ())? (skill->GetPlayer ()->GetVar8 () + 6 * skill->GetLevel ()) : 0));
