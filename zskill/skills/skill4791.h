#ifndef __CPPGEN_GNET_SKILL4791
#define __CPPGEN_GNET_SKILL4791
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4791:public Skill
    {
      public:
        enum
        { SKILL_ID = 4791 };
          Skill4791 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4791Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->GetPlayer ()->SetVar9 (skill->GetPlayer ()->GetDef ());
                ...
                skill->SetPlus (200 + 35 * skill->GetLevel ());
      ...
      Skill4791Stub ():SkillStub (4791)
        ...
        {
            return (float) (skill->GetPlayer ()->GetLevel () + 5 * skill->GetLevel ());
        }
        ...
        {
            static int array[5] = { 60, 64, 68, 72, 76 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetPlayer ()->GetLevel () + 5 * skill->GetLevel (), 200 + 35 * skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->
                SetValue ((skill->GetLevel () * skill->GetPlayer ()->GetVar2 () +
                           skill->GetPlayer ()->GetBufflevel (4267) * skill->GetLevel () * skill->GetPlayer ()->GetVar9 () * 0.05) *
