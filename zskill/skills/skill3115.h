#ifndef __CPPGEN_GNET_SKILL3115
#define __CPPGEN_GNET_SKILL3115
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3115:public Skill
    {
      public:
        enum
        { SKILL_ID = 3115 };
          Skill3115 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3115Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio (1 + 0.05 * skill->GetLevel () + norm (skill->GetLevel () / 14.9) * 0.03 * (skill->GetLevel () - 15) +
                                 (0.05 + 0.05 * int (skill->GetPlayer ()->GetSkilllevel (234) / 9) +
                                  ...
                                  0.05 * int (skill->GetPlayer ()->GetSkilllevel (786) / 1.9)) *skill->GetT3 () + (0.05 +
                                                                                                                   0.03 * skill->GetLevel ()) *
 ...
 1450600 };
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               15 + 4 * skill->GetLevel (), 2 + 0.5 * skill->GetLevel (), 3, 5 + 3 * skill->GetLevel ());
