...
namespace GNET
{
    ...
    class Skill2691Stub:public SkillStub
    {
      ...
      Skill2691Stub ():SkillStub (2691)
        ...
        {
            return _snwprintf (buffer, length, format, 2 * skill->GetLevel (), skill->GetLevel (), skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.00001 + 0.01 * skill->GetT2 ());
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetIncfatalratio (1);
            skill->GetVictim ()->SetProbability (1.0 * (120));
            skill->GetVictim ()->SetTime (5000);
            skill->GetVictim ()->SetRatio (0.00001 + 0.01 * skill->GetLevel ());
            skill->GetVictim ()->SetBuffid (1);
