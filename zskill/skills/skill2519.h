#ifndef __CPPGEN_GNET_SKILL2519
#define __CPPGEN_GNET_SKILL2519
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2519:public Skill
    {
      public:
        enum
        { SKILL_ID = 2519 };
          Skill2519 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2519Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2519Stub ():SkillStub (2519)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (2 * skill->GetLevel () * skill->GetPlayer ()->GetMaxhp ());
