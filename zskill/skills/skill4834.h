#ifndef __CPPGEN_GNET_SKILL4834
#define __CPPGEN_GNET_SKILL4834
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4834:public Skill
    {
      public:
        enum
        { SKILL_ID = 4834 };
          Skill4834 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4834Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
