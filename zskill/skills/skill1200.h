#ifndef __CPPGEN_GNET_SKILL1200
#define __CPPGEN_GNET_SKILL1200
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1200:public Skill
    {
      public:
        enum
        { SKILL_ID = 1200 };
          Skill1200 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1200Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
