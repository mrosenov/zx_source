#ifndef __CPPGEN_GNET_SKILL1309
#define __CPPGEN_GNET_SKILL1309
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1309:public Skill
    {
      public:
        enum
        { SKILL_ID = 1309 };
          Skill1309 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1309Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
