#ifndef __CPPGEN_GNET_SKILL5065
#define __CPPGEN_GNET_SKILL5065
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5065:public Skill
    {
      public:
        enum
        { SKILL_ID = 5065 };
          Skill5065 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5065Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill5065Stub ():SkillStub (5065)
        ...
        {
            return _snwprintf (buffer, length, format, 500, 20, 2, 3 * 5, 3 * 5, 20);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (20000 + 2000 * 3 + 100);
            skill->GetVictim ()->SetRatio (0.03 * 5 + 0.02 * 3);
            skill->GetVictim ()->SetBuffid (1);
            skill->GetVictim ()->SetAmount (0);
            skill->GetVictim ()->SetValue (0.03 * 5 * skill->GetPlayer ()->GetMaxhp () * 10 * (1 + 0.2 * 3) * (1 + 0.1 * 3));
            skill->GetVictim ()->SetBanruo (1);
            skill->GetVictim ()->SetTime (2000 + 100 + 2000 * 3);
