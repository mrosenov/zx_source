#ifndef __CPPGEN_GNET_SKILL857
#define __CPPGEN_GNET_SKILL857
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill857:public Skill
    {
      public:
        enum
        { SKILL_ID = 857 };
          Skill857 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill857Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
