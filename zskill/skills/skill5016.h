...
namespace GNET
{
    ...
    class Skill5016Stub:public SkillStub
    {
      ...
      Skill5016Stub ():SkillStub (5016)
        ...
        {
            return _snwprintf (buffer, length, format, 7 + 2 * skill->GetLevel (), 7 + 2 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetHasbuff (4123) == 1 ? 0 : 100));
            skill->GetVictim ()->SetTime (1000 * (7 + 2 * skill->GetLevel ()));
            skill->GetVictim ()->SetRatio (0.04 + skill->GetPlayer ()->GetVar1 () * 0.02 / 100);
        ...
        {
            skill->GetVictim ()->SetTime (1000 * (7 + 2 * skill->GetLevel ()));
            skill->GetVictim ()->SetRatio (0.01 * (7 + 2 * skill->GetLevel ()));
