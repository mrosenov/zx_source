#ifndef __CPPGEN_GNET_SKILL2205
#define __CPPGEN_GNET_SKILL2205
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2205:public Skill
    {
      public:
        enum
        { SKILL_ID = 2205 };
          Skill2205 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2205Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2205Stub ():SkillStub (2205)
        {
            occupation = 129;
            name = L"»½Áé¾÷";
            nativename = "»½Áé¾÷";
            icon = "ÕæÎä½£¸óÕÕÑı¾µ.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
            eventflag = 0;
