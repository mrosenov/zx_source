#ifndef __CPPGEN_GNET_SKILL2787
#define __CPPGEN_GNET_SKILL2787
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2787:public Skill
    {
      public:
        enum
        { SKILL_ID = 2787 };
          Skill2787 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2787Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2787Stub ():SkillStub (2787)
        {
            occupation = 128;
            name = L"ÊÞÉñ¹éÀ´-¹ÅÔ³1";
            nativename = "ÊÞÉñ¹éÀ´-¹ÅÔ³1";
            icon = "";
            maxlevel = 500;
            maxlearn = 500;
            type = 1;
