#ifndef __CPPGEN_GNET_SKILL3040
#define __CPPGEN_GNET_SKILL3040
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3040:public Skill
    {
      public:
        enum
        { SKILL_ID = 3040 };
          Skill3040 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3040Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill3040Stub ():SkillStub (3040)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               4, 8, 4 * skill->GetLevel (), 1 + 0.2 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (2050 + 200 * skill->GetLevel ());
