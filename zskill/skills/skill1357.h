    ...
    class Skill1357Stub:public SkillStub
    {
      ...
      Skill1357Stub ():SkillStub (1357)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (5300 + 3000 * norm (skill->GetLevel () / 30));
            skill->GetVictim ()->SetBuffid (7);
            skill->GetVictim ()->SetValue ((0.01 * skill->GetLevel () * skill->GetPlayer ()->GetLevel () + 1) * (1 + norm (skill->GetLevel () / 60)));
