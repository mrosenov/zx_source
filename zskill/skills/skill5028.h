#ifndef __CPPGEN_GNET_SKILL5028
#define __CPPGEN_GNET_SKILL5028
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill5028:public Skill
    {
      public:
        enum
        { SKILL_ID = 5028 };
          Skill5028 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill5028Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
