#ifndef __CPPGEN_GNET_SKILL2003
#define __CPPGEN_GNET_SKILL2003
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2003:public Skill
    {
      public:
        enum
        { SKILL_ID = 2003 };
          Skill2003 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2003Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2003Stub ():SkillStub (2003)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetBuffid (2);
            skill->GetVictim ()->SetAmount (2 * skill->GetPlayer ()->GetMaxmp ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (200000);
