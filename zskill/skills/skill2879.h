#ifndef __CPPGEN_GNET_SKILL2879
#define __CPPGEN_GNET_SKILL2879
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2879:public Skill
    {
      public:
        enum
        { SKILL_ID = 2879 };
          Skill2879 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2879Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2879Stub ():SkillStub (2879)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetRes2 () + 90));
            skill->GetVictim ()->SetTime (45000);
            skill->GetVictim ()->SetRatio (0.06);
