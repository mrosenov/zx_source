#ifndef __CPPGEN_GNET_SKILL4586
#define __CPPGEN_GNET_SKILL4586
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4586:public Skill
    {
      public:
        enum
        { SKILL_ID = 4586 };
          Skill4586 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4586Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
