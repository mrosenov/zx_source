#ifndef __CPPGEN_GNET_SKILL3910
#define __CPPGEN_GNET_SKILL3910
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3910:public Skill
    {
      public:
        enum
        { SKILL_ID = 3910 };
          Skill3910 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3910Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill3910Stub ():SkillStub (3910)
        {
            occupation = 151;
            name = L"ĞÇÓï¡¤±ùÇåÓñ½à";
            nativename = "ĞÇÓï¡¤±ùÇåÓñ½à";
