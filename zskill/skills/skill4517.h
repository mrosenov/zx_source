#ifndef __CPPGEN_GNET_SKILL4517
#define __CPPGEN_GNET_SKILL4517
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4517:public Skill
    {
      public:
        enum
        { SKILL_ID = 4517 };
          Skill4517 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4517Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill4517Stub ():SkillStub (4517)
        {
            occupation = 130;
            name = L"³Ğ¡¤ÒõÑôÏàÉú";
            nativename = "³Ğ¡¤ÒõÑôÏàÉú";
            icon = "ÒõÑôÏàÉú.dds";
            maxlevel = 5;
            maxlearn = 5;
            type = 1;
