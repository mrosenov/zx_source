#ifndef __CPPGEN_GNET_SKILL4733
#define __CPPGEN_GNET_SKILL4733
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4733:public Skill
    {
      public:
        enum
        { SKILL_ID = 4733 };
          Skill4733 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4733Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill4733Stub ():SkillStub (4733)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (55774);
