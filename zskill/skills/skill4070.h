#ifndef __CPPGEN_GNET_SKILL4070
#define __CPPGEN_GNET_SKILL4070
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4070:public Skill
    {
      public:
        enum
        { SKILL_ID = 4070 };
          Skill4070 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4070Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
