...
namespace GNET
{
    ...
    class Skill3497Stub:public SkillStub
    {
      ...
      Skill3497Stub ():SkillStub (3497)
        ...
        {
            return (float) (375 + 15 * skill->GetLevel () + 3 * skill->GetLevel () * skill->GetLevel ());
        }
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               375 + 15 * skill->GetLevel () + 3 * skill->GetLevel () * skill->GetLevel (),
                               skill->GetLevel (), 2 + skill->GetLevel (), 25);
