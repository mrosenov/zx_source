#ifndef __CPPGEN_GNET_SKILL2796
#define __CPPGEN_GNET_SKILL2796
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2796:public Skill
    {
      public:
        enum
        { SKILL_ID = 2796 };
          Skill2796 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2796Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
