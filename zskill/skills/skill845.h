#ifndef __CPPGEN_GNET_SKILL845
#define __CPPGEN_GNET_SKILL845
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill845:public Skill
    {
      public:
        enum
        { SKILL_ID = 845 };
          Skill845 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill845Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
