...
namespace GNET
{
    ...
    class Skill313Stub:public SkillStub
    {
      public:
        ...
        {
            static int array[6] = { 76, 78, 81, 84, 87, 90 };
            return array[level - 1];
        }
#ifdef _SKILL_CLIENT
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format, 11 * skill->GetLevel ());
        ...
        {
            skill->GetPlayer ()->SetPasaddattack (11 * skill->GetLevel () + 12 * skill->GetT0 ());
