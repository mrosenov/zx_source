#ifndef __CPPGEN_GNET_SKILL1403
#define __CPPGEN_GNET_SKILL1403
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1403:public Skill
    {
      public:
        enum
        { SKILL_ID = 1403 };
          Skill1403 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1403Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill1403Stub ():SkillStub (1403)
        ...
        int GetDescription (Skill * skill, wchar_t * buffer, int length, wchar_t * format, const SkillStr & table) const
        {
            return _snwprintf (buffer, length, format,
                               10 + 5 * skill->GetLevel (), 5 * skill->GetLevel (), skill->GetLevel (), 6, 8, 15, 30, 15, 2 * skill->GetLevel ());
