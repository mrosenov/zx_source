#ifndef __CPPGEN_GNET_SKILL1683
#define __CPPGEN_GNET_SKILL1683
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill1683:public Skill
    {
      public:
        enum
        { SKILL_ID = 1683 };
          Skill1683 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill1683Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill1683Stub ():SkillStub (1683)
        {
            occupation = 146;
            name = L"ÍíÀ´Çï£ºèó";
            nativename = "ÍíÀ´Çï£ºèó";
            icon = "ÍíÀ´Çï.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 2;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (302);
            skill->GetVictim ()->SetValue (780);
