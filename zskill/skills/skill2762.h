#ifndef __CPPGEN_GNET_SKILL2762
#define __CPPGEN_GNET_SKILL2762
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2762:public Skill
    {
      public:
        enum
        { SKILL_ID = 2762 };
          Skill2762 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2762Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2762Stub ():SkillStub (2762)
        {
            occupation = 128;
            name = L"ÁìÍÁÕ½ËşÓÃ³°·í";
            nativename = "ÁìÍÁÕ½ËşÓÃ³°·í";
            icon = "Àä³°ÈÈ·í.dds";
            maxlevel = 1;
            maxlearn = 1;
            type = 3;
