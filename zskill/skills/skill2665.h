#ifndef __CPPGEN_GNET_SKILL2665
#define __CPPGEN_GNET_SKILL2665
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2665:public Skill
    {
      public:
        enum
        { SKILL_ID = 2665 };
          Skill2665 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2665Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill2665Stub ():SkillStub (2665)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (54);
            skill->GetVictim ()->SetAmount (4);
            skill->GetVictim ()->SetValue (42);
