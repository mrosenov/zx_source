#ifndef __CPPGEN_GNET_SKILL4668
#define __CPPGEN_GNET_SKILL4668
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill4668:public Skill
    {
      public:
        enum
        { SKILL_ID = 4668 };
          Skill4668 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill4668Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetCrit (0.005 * skill->GetLevel () * 5);
                skill->SetCrithurt (0.25 * skill->GetT1 ());
                skill->GetPlayer ()->SetPerform (1);
            }
        };
#endif
      Skill4668Stub ():SkillStub (4668)
        {
            occupation = 168;
            name = L"界・天演式・六道<煞>";
