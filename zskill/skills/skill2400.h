#ifndef __CPPGEN_GNET_SKILL2400
#define __CPPGEN_GNET_SKILL2400
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill2400:public Skill
    {
      public:
        enum
        { SKILL_ID = 2400 };
          Skill2400 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill2400Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill2400Stub ():SkillStub (2400)
        {
            occupation = 151;
            name = L"ÕÕÑı¾µ-ÄêÊŞ";
            nativename = "ÕÕÑı¾µ-ÄêÊŞ";
            icon = "";
            maxlevel = 99;
            maxlearn = 0;
            type = 3;
